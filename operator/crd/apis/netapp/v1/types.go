...
type TridentOrchestratorSpec struct {
	...
	CSISidecarProvisionerImage         string            `json:"csiSidecarProvisionerImage,omitempty"`
	CSISidecarAttacherImage            string            `json:"csiSidecarAttacherImage,omitempty"`
	CSISidecarResizerImage             string            `json:"csiSidecarResizerImage,omitempty"`
	CSISidecarSnapshotterImage         string            `json:"csiSidecarSnapshotterImage,omitempty"`
	CSISidecarNodeDriverRegistrarImage string            `json:"csiSidecarNodeDriverRegistrarImage,omitempty"`
	CSISidecarLivenessProbeImage       string            `json:"csiSidecarLivenessProbeImage,omitempty"`
