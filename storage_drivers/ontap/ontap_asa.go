...
func (d *ASAStorageDriver) CreateClone(
	...
	if err = cloneASAvol(ctx, cloneVolConfig, split, &d.Config, d.API, ASATypeLun); err != nil {
		return err
	}
...
func (d *ASAStorageDriver) Destroy(ctx context.Context, volConfig *storage.VolumeConfig) error {
	...
	defer func() {
		deleteAutomaticASASnapshot(ctx, &d.Config, d.API, volConfig, ASATypeLun)
	}()
...
func (d *ASAStorageDriver) GetSnapshot(
	...
	return getASASnapshot(ctx, snapConfig, &d.Config, d.API, ASATypeLun)
}
...
func (d *ASAStorageDriver) GetSnapshots(
	...
	return getASASnapshotList(ctx, volConfig, &d.Config, d.API, ASATypeLun)
}
...
func (d *ASAStorageDriver) CreateSnapshot(
	...
	snapshot, err := createASASnapshot(ctx, snapConfig, &d.Config, d.API, ASATypeLun)
...
func (d *ASAStorageDriver) RestoreSnapshot(
	...
	return restoreASASnapshot(ctx, snapConfig, &d.Config, d.API, ASATypeLun)
}
...
func (d *ASAStorageDriver) DeleteSnapshot(
	...
	err := deleteASASnapshot(ctx, snapConfig, &d.Config, d.API, d.cloneSplitTimers, ASATypeLun)
	if err != nil {
