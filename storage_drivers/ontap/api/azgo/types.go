...
// ToXML converts this object into an xml string representation
func (o *IscsiInterfaceGetIterKeyTdType) ToXML() (string, error) {
	output, err := xml.MarshalIndent(o, " ", "    ")
	if err != nil {
		log.Errorf("error: %v", err)
	}
...
func NewIscsiInterfaceGetIterKeyTdType() *IscsiInterfaceGetIterKeyTdType {
	return &IscsiInterfaceGetIterKeyTdType{}
}

// String returns a string representation of this object's fields and implements the Stringer interface
func (o IscsiInterfaceGetIterKeyTdType) String() string {
	var buffer bytes.Buffer
	if o.Key0Ptr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "key-0", *o.Key0Ptr))
	} else {
...
// Key0 is a fluent style 'getter' method that can be chained
func (o *IscsiInterfaceGetIterKeyTdType) Key0() string {
	r := *o.Key0Ptr
	return r
}

// SetKey0 is a fluent style 'setter' method that can be chained
func (o *IscsiInterfaceGetIterKeyTdType) SetKey0(newValue string) *IscsiInterfaceGetIterKeyTdType {
	o.Key0Ptr = &newValue
	return o
}

// Key1 is a fluent style 'getter' method that can be chained
func (o *IscsiInterfaceGetIterKeyTdType) Key1() string {
	r := *o.Key1Ptr
	return r
}

// SetKey1 is a fluent style 'setter' method that can be chained
func (o *IscsiInterfaceGetIterKeyTdType) SetKey1(newValue string) *IscsiInterfaceGetIterKeyTdType {
	o.Key1Ptr = &newValue
	return o
}
...
func (o IscsiInterfaceListEntryInfoType) String() string {
	...
	if o.IpAddressPtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "ip-address", *o.IpAddressPtr))
	} else {
		buffer.WriteString(fmt.Sprintf("ip-address: nil\n"))
	}
	if o.IpPortPtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "ip-port", *o.IpPortPtr))
	} else {
		buffer.WriteString(fmt.Sprintf("ip-port: nil\n"))
	}
	if o.IsInterfaceEnabledPtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "is-interface-enabled", *o.IsInterfaceEnabledPtr))
	} else {
		buffer.WriteString(fmt.Sprintf("is-interface-enabled: nil\n"))
	}
	if o.RelativePortIdPtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "relative-port-id", *o.RelativePortIdPtr))
	} else {
		buffer.WriteString(fmt.Sprintf("relative-port-id: nil\n"))
	}
	if o.SendtargetsFqdnPtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "sendtargets-fqdn", *o.SendtargetsFqdnPtr))
	} else {
		buffer.WriteString(fmt.Sprintf("sendtargets-fqdn: nil\n"))
	}
	if o.TpgroupNamePtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "tpgroup-name", *o.TpgroupNamePtr))
	} else {
		buffer.WriteString(fmt.Sprintf("tpgroup-name: nil\n"))
	}
	if o.TpgroupTagPtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "tpgroup-tag", *o.TpgroupTagPtr))
	} else {
		buffer.WriteString(fmt.Sprintf("tpgroup-tag: nil\n"))
	}
	if o.VserverPtr != nil {
		buffer.WriteString(fmt.Sprintf("%s: %v\n", "vserver", *o.VserverPtr))
	} else {
