...
func NewAggrSpaceGetIterRequest() *AggrSpaceGetIterRequest { return &AggrSpaceGetIterRequest{} }

// ExecuteUsing converts this object to a ZAPI XML representation and uses the supplied ZapiRunner to send to a filer
func (o *AggrSpaceGetIterRequest) ExecuteUsing(zr *ZapiRunner) (AggrSpaceGetIterResponse, error) {

	if zr.DebugTraceFlags["method"] {
		fields := log.Fields{"Method": "ExecuteUsing", "Type": "AggrSpaceGetIterRequest"}
	...
	for done != true {
		...
		var n AggrSpaceGetIterResponse
		...
		if zr.DebugTraceFlags["api"] {
			log.Debugf("aggr-space-get-iter result:\n%s", n.Result)
		}
...
func (o *AggrSpaceGetIterRequest) Query() SpaceInformationType {
	r := *o.QueryPtr
	return r
}

// SetQuery is a fluent style 'setter' method that can be chained
func (o *AggrSpaceGetIterRequest) SetQuery(newValue SpaceInformationType) *AggrSpaceGetIterRequest {
	o.QueryPtr = &newValue
	return o
}
...
func NewAggrSpaceGetIterResponse() *AggrSpaceGetIterResponse { return &AggrSpaceGetIterResponse{} }
...
func (o *AggrSpaceGetIterResponseResult) AttributesList() []SpaceInformationType {
	r := o.AttributesListPtr
	return r
}

// SetAttributesList is a fluent style 'setter' method that can be chained
func (o *AggrSpaceGetIterResponseResult) SetAttributesList(newValue []SpaceInformationType) *AggrSpaceGetIterResponseResult {
