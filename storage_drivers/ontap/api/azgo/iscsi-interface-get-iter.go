...
func (o *IscsiInterfaceGetIterRequest) ExecuteUsing(zr *ZapiRunner) (IscsiInterfaceGetIterResponse, error) {
	...
	if zr.DebugTraceFlags["method"] {
		fields := log.Fields{"Method": "ExecuteUsing", "Type": "IscsiInterfaceGetIterRequest"}
	...
	for done != true {
		...
		var n IscsiInterfaceGetIterResponse
		...
		if zr.DebugTraceFlags["api"] {
			log.Debugf("iscsi-interface-get-iter result:\n%s", n.Result)
		}
...
func (o *IscsiInterfaceGetIterRequest) DesiredAttributes() IscsiInterfaceListEntryInfoType {
	r := *o.DesiredAttributesPtr
	return r
}

// SetDesiredAttributes is a fluent style 'setter' method that can be chained
func (o *IscsiInterfaceGetIterRequest) SetDesiredAttributes(newValue IscsiInterfaceListEntryInfoType) *IscsiInterfaceGetIterRequest {
...
func (o *IscsiInterfaceGetIterRequest) Query() IscsiInterfaceListEntryInfoType {
	r := *o.QueryPtr
	return r
}

// SetQuery is a fluent style 'setter' method that can be chained
func (o *IscsiInterfaceGetIterRequest) SetQuery(newValue IscsiInterfaceListEntryInfoType) *IscsiInterfaceGetIterRequest {
	o.QueryPtr = &newValue
	return o
}
...
func (o *IscsiInterfaceGetIterResponseResult) AttributesList() []IscsiInterfaceListEntryInfoType {
	r := o.AttributesListPtr
	return r
}

// SetAttributesList is a fluent style 'setter' method that can be chained
func (o *IscsiInterfaceGetIterResponseResult) SetAttributesList(newValue []IscsiInterfaceListEntryInfoType) *IscsiInterfaceGetIterResponseResult {
