...
// ifacemaker -f storage_drivers/ontap/api/ontap_rest.go -s RestClient -i RestClientInterface -p api > storage_drivers/ontap/api/ontap_rest_interface.go
...
type RestClientInterface interface {
	...
	ConsistencyGroupCreate(ctx context.Context, cgName string, flexVols []string) (*application.ConsistencyGroupCreateAccepted, error)
	...
	ConsistencyGroupSnapshot(ctx context.Context, cgName, snapName string) (*application.ConsistencyGroupSnapshotCreateCreated, *application.ConsistencyGroupSnapshotCreateAccepted, error)
	...
	SetOntapVersion(version string)
	GetOntapVersion() string
	...
	TieringPolicyValue(ctx context.Context) (tieringPolicy string)
