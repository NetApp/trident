...
// SnaplockFileFingerprintResponse snaplock file fingerprint response
//
// swagger:model snaplock_file_fingerprint_response
...
func (m *SnaplockFileFingerprintResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SnaplockFileFingerprintResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this snaplock file fingerprint response based on the context it is used
func (m *SnaplockFileFingerprintResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SnaplockFileFingerprintResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnaplockFileFingerprintResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SnaplockFileFingerprintResponse) UnmarshalBinary(b []byte) error {
	var res SnaplockFileFingerprintResponse
