...
type FcPort struct {
	...
	// topology
	Topology *FcPortInlineTopology `json:"topology,omitempty"`
...
func (m *FcPort) validateTopology(formats strfmt.Registry) error {
...
func (m *FcPort) contextValidateTopology(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FcPortInlineTopology) Validate(formats strfmt.Registry) error {
	var res []error
...
// prop value enum
func (m *FcPortInlineTopology) validateConfiguredEnum(path, location string, value string) error {
...
func (m *FcPortInlineTopology) validateConfigured(formats strfmt.Registry) error {
	if swag.IsZero(m.Configured) { // not required
		return nil
	}

	// value enum
	if err := m.validateConfiguredEnum("topology"+"."+"configured", "body", *m.Configured); err != nil {
		return err
	}
...
func (m *FcPortInlineTopology) validateSupportedItemsEnum(path, location string, value string) error {
...
func (m *FcPortInlineTopology) validateSupported(formats strfmt.Registry) error {
	if swag.IsZero(m.Supported) { // not required
		return nil
	}

	for i := 0; i < len(m.Supported); i++ {
		if swag.IsZero(m.Supported[i]) { // not required
			continue
		}

		// value enum
		if err := m.validateSupportedItemsEnum("topology"+"."+"supported"+"."+strconv.Itoa(i), "body", *m.Supported[i]); err != nil {
			return err
		}
...
func (m *FcPortInlineTopology) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FcPortInlineTopology) contextValidateSupported(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "topology"+"."+"supported", "body", []*string(m.Supported)); err != nil {
		return err
	}

	for i := 0; i < len(m.Supported); i++ {

		if err := validate.ReadOnly(ctx, "topology"+"."+"supported"+"."+strconv.Itoa(i), "body", m.Supported[i]); err != nil {
			return err
		}
...
// MarshalBinary interface implementation
func (m *FcPortInlineTopology) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *FcPortInlineTopology) UnmarshalBinary(b []byte) error {
