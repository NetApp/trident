...
var storageUnitTypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		storageUnitTypeAccessModePropEnum = append(storageUnitTypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// StorageUnitAccessModeGlobal captures enum value "global"
	StorageUnitAccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// StorageUnitAccessModeLocal captures enum value "local"
	StorageUnitAccessModeLocal string = "local"
)

// prop value enum
func (m *StorageUnit) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, storageUnitTypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *StorageUnit) validateAccessMode(formats strfmt.Registry) error {
...
func (m *StorageUnit) contextValidateAccessMode(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "access_mode", "body", m.AccessMode); err != nil {
		return err
	}
