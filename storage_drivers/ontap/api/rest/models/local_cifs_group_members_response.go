...
// LocalCifsGroupMembersResponse local cifs group members response
//
// swagger:model local_cifs_group_members_response
...
func (m *LocalCifsGroupMembersResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LocalCifsGroupMembersResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this local cifs group members response based on the context it is used
func (m *LocalCifsGroupMembersResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LocalCifsGroupMembersResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LocalCifsGroupMembersResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LocalCifsGroupMembersResponse) UnmarshalBinary(b []byte) error {
	var res LocalCifsGroupMembersResponse
