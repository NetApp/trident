...
type S3Bucket struct {
	...
	// snapshot restore
	SnapshotRestore *S3BucketInlineSnapshotRestore `json:"snapshot_restore,omitempty"`
...
func (m *S3Bucket) validateSnapshotRestore(formats strfmt.Registry) error {
...
func (m *S3Bucket) contextValidateSnapshotRestore(ctx context.Context, formats strfmt.Registry) error {
...
func (m *S3BucketInlineSnapshotRestore) Validate(formats strfmt.Registry) error {
	var res []error
...
// prop value enum
func (m *S3BucketInlineSnapshotRestore) validateStateEnum(path, location string, value string) error {
...
func (m *S3BucketInlineSnapshotRestore) validateState(formats strfmt.Registry) error {
...
func (m *S3BucketInlineSnapshotRestore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *S3BucketInlineSnapshotRestore) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *S3BucketInlineSnapshotRestore) UnmarshalBinary(b []byte) error {
