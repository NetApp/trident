...
func (m *Volume) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSvmDrProtection(formats); err != nil {
		res = append(res, err)
	}
...
var volumeTypeSmasProtectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		volumeTypeSmasProtectionPropEnum = append(volumeTypeSmasProtectionPropEnum, v)
	}
}
...
const (
	...
	// protected
	// END DEBUGGING
	// VolumeSmasProtectionProtected captures enum value "protected"
	VolumeSmasProtectionProtected string = "protected"
	...
	// unprotected
	// END DEBUGGING
	// VolumeSmasProtectionUnprotected captures enum value "unprotected"
	VolumeSmasProtectionUnprotected string = "unprotected"
)

// prop value enum
func (m *Volume) validateSmasProtectionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, volumeTypeSmasProtectionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Volume) validateSmasProtection(formats strfmt.Registry) error {
...
var volumeTypeSvmDrProtectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		volumeTypeSvmDrProtectionPropEnum = append(volumeTypeSvmDrProtectionPropEnum, v)
	}
}
...
const (
	...
	// protected
	// END DEBUGGING
	// VolumeSvmDrProtectionProtected captures enum value "protected"
	VolumeSvmDrProtectionProtected string = "protected"
	...
	// unprotected
	// END DEBUGGING
	// VolumeSvmDrProtectionUnprotected captures enum value "unprotected"
	VolumeSvmDrProtectionUnprotected string = "unprotected"
)

// prop value enum
func (m *Volume) validateSvmDrProtectionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, volumeTypeSvmDrProtectionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Volume) validateSvmDrProtection(formats strfmt.Registry) error {
	if swag.IsZero(m.SvmDrProtection) { // not required
		return nil
	}

	// value enum
	if err := m.validateSvmDrProtectionEnum("svm_dr_protection", "body", *m.SvmDrProtection); err != nil {
		return err
	}
