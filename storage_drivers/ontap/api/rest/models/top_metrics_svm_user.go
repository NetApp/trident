...
// Example: {"iops":{"error":{"lower_bound":10,"upper_bound":11},"read":10,"write":5},"svm":{"name":"vserver_3","uuid":"42ee3002-67dd-11ea-8508-005056a7b8ac"},"throughput":{"error":{"lower_bound":2,"upper_bound":3},"read":2,"write":1},"total_ops":{"error":{"lower_bound":1400,"upper_bound":1450},"read":1400,"write":400},"total_throughput":{"error":{"lower_bound":2800,"upper_bound":2950},"read":2800,"write":600},"user_id":1876,"user_name":"Ryan","volumes":[{"name":"vol_6","uuid":"02178914-5f67-11eb-b987-005056ac5da5"},{"name":"vol_8","uuid":"c05eb66a-685f-11ea-8508-005056a7b8ac"}]}
//
...
type TopMetricsSvmUser struct {
	...
	// total ops
	TotalOps *TopMetricsSvmUserInlineTotalOps `json:"total_ops,omitempty"`

	// total throughput
	TotalThroughput *TopMetricsSvmUserInlineTotalThroughput `json:"total_throughput,omitempty"`
...
func (m *TopMetricsSvmUser) validateTotalOps(formats strfmt.Registry) error {
...
func (m *TopMetricsSvmUser) validateTotalThroughput(formats strfmt.Registry) error {
...
func (m *TopMetricsSvmUser) contextValidateTotalOps(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmUser) contextValidateTotalThroughput(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsSvmUserInlineTotalOps top metrics svm user inline total ops
//
// swagger:model top_metrics_svm_user_inline_total_ops
type TopMetricsSvmUserInlineTotalOps struct {
...
// Validate validates this top metrics svm user inline total ops
func (m *TopMetricsSvmUserInlineTotalOps) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmUserInlineTotalOps) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics svm user inline total ops based on the context it is used
func (m *TopMetricsSvmUserInlineTotalOps) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmUserInlineTotalOps) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmUserInlineTotalOps) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmUserInlineTotalOps) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsSvmUserInlineTotalOps) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsSvmUserInlineTotalOps) UnmarshalBinary(b []byte) error {
	var res TopMetricsSvmUserInlineTotalOps
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// TopMetricsSvmUserInlineTotalThroughput top metrics svm user inline total throughput
//
// swagger:model top_metrics_svm_user_inline_total_throughput
type TopMetricsSvmUserInlineTotalThroughput struct {
...
// Validate validates this top metrics svm user inline total throughput
func (m *TopMetricsSvmUserInlineTotalThroughput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmUserInlineTotalThroughput) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics svm user inline total throughput based on the context it is used
func (m *TopMetricsSvmUserInlineTotalThroughput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmUserInlineTotalThroughput) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmUserInlineTotalThroughput) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmUserInlineTotalThroughput) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsSvmUserInlineTotalThroughput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsSvmUserInlineTotalThroughput) UnmarshalBinary(b []byte) error {
	var res TopMetricsSvmUserInlineTotalThroughput
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
