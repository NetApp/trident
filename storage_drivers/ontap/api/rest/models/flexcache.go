...
type Flexcache struct {
	...
	// mtime scrubber
	MtimeScrubber *FlexcacheInlineMtimeScrubber `json:"mtime_scrubber,omitempty"`
	...
	// write absorption
	WriteAbsorption *FlexcacheInlineWriteAbsorption `json:"write_absorption,omitempty"`
...
func (m *Flexcache) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateMtimeScrubber(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateWriteAbsorption(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Flexcache) validateMtimeScrubber(formats strfmt.Registry) error {
	if swag.IsZero(m.MtimeScrubber) { // not required
		return nil
	}

	if m.MtimeScrubber != nil {
		if err := m.MtimeScrubber.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("mtime_scrubber")
			}
			return err
		}
	}
...
func (m *Flexcache) validateWriteAbsorption(formats strfmt.Registry) error {
	if swag.IsZero(m.WriteAbsorption) { // not required
		return nil
	}

	if m.WriteAbsorption != nil {
		if err := m.WriteAbsorption.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("write_absorption")
			}
			return err
		}
	}
...
func (m *Flexcache) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateMtimeScrubber(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateWriteAbsorption(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Flexcache) contextValidateMtimeScrubber(ctx context.Context, formats strfmt.Registry) error {

	if m.MtimeScrubber != nil {
		if err := m.MtimeScrubber.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("mtime_scrubber")
			}
			return err
...
func (m *Flexcache) contextValidateWriteAbsorption(ctx context.Context, formats strfmt.Registry) error {

	if m.WriteAbsorption != nil {
		if err := m.WriteAbsorption.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("write_absorption")
			}
			return err
...
func (m *FlexcacheInlineMtimeScrubber) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FlexcacheInlineMtimeScrubber) validateThreshold(formats strfmt.Registry) error {
	if swag.IsZero(m.Threshold) { // not required
		return nil
	}

	if err := validate.MinimumInt("mtime_scrubber"+"."+"threshold", "body", *m.Threshold, 5, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("mtime_scrubber"+"."+"threshold", "body", *m.Threshold, 2.592e+06, false); err != nil {
		return err
	}
...
func (m *FlexcacheInlineMtimeScrubber) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *FlexcacheInlineMtimeScrubber) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *FlexcacheInlineMtimeScrubber) UnmarshalBinary(b []byte) error {
...
func (m *FlexcacheInlineWriteAbsorption) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this flexcache inline write absorption based on context it is used
func (m *FlexcacheInlineWriteAbsorption) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *FlexcacheInlineWriteAbsorption) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *FlexcacheInlineWriteAbsorption) UnmarshalBinary(b []byte) error {
