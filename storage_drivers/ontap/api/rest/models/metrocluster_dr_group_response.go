...
// MetroclusterDrGroupResponse metrocluster dr group response
//
// swagger:model metrocluster_dr_group_response
...
func (m *MetroclusterDrGroupResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MetroclusterDrGroupResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this metrocluster dr group response based on the context it is used
func (m *MetroclusterDrGroupResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MetroclusterDrGroupResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetroclusterDrGroupResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MetroclusterDrGroupResponse) UnmarshalBinary(b []byte) error {
	var res MetroclusterDrGroupResponse
