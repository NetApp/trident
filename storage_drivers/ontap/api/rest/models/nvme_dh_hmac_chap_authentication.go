...
func (m *NvmeDhHmacChapAuthentication) validateControllerSecretKey(formats strfmt.Registry) error {
...
func (m *NvmeDhHmacChapAuthentication) validateHostSecretKey(formats strfmt.Registry) error {
