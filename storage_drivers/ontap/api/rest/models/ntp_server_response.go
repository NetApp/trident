...
// NtpServerResponse ntp server response
//
// swagger:model ntp_server_response
...
func (m *NtpServerResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NtpServerResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this ntp server response based on the context it is used
func (m *NtpServerResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NtpServerResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NtpServerResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NtpServerResponse) UnmarshalBinary(b []byte) error {
	var res NtpServerResponse
