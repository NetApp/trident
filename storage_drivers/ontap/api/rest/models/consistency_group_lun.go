...
var consistencyGroupLunTypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		consistencyGroupLunTypeAccessModePropEnum = append(consistencyGroupLunTypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// ConsistencyGroupLunAccessModeGlobal captures enum value "global"
	ConsistencyGroupLunAccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// ConsistencyGroupLunAccessModeLocal captures enum value "local"
	ConsistencyGroupLunAccessModeLocal string = "local"
)

// prop value enum
func (m *ConsistencyGroupLun) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, consistencyGroupLunTypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ConsistencyGroupLun) validateAccessMode(formats strfmt.Registry) error {
...
func (m *ConsistencyGroupLunInlineClone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {
