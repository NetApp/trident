...
// FabricResponse fabric response
//
// swagger:model fabric_response
...
func (m *FabricResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FabricResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this fabric response based on the context it is used
func (m *FabricResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FabricResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FabricResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FabricResponse) UnmarshalBinary(b []byte) error {
	var res FabricResponse
