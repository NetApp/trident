...
var consistencyGroupConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		consistencyGroupConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum = append(consistencyGroupConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// ConsistencyGroupConsistencyGroupsItems0LunsItems0AccessModeGlobal captures enum value "global"
	ConsistencyGroupConsistencyGroupsItems0LunsItems0AccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// ConsistencyGroupConsistencyGroupsItems0LunsItems0AccessModeLocal captures enum value "local"
	ConsistencyGroupConsistencyGroupsItems0LunsItems0AccessModeLocal string = "local"
)

// prop value enum
func (m *ConsistencyGroupConsistencyGroupsItems0LunsItems0) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, consistencyGroupConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ConsistencyGroupConsistencyGroupsItems0LunsItems0) validateAccessMode(formats strfmt.Registry) error {
...
func (m *ConsistencyGroupConsistencyGroupsItems0LunsItems0Clone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {
...
var consistencyGroupInlineLunsInlineArrayItemTypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		consistencyGroupInlineLunsInlineArrayItemTypeAccessModePropEnum = append(consistencyGroupInlineLunsInlineArrayItemTypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// ConsistencyGroupInlineLunsInlineArrayItemAccessModeGlobal captures enum value "global"
	ConsistencyGroupInlineLunsInlineArrayItemAccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// ConsistencyGroupInlineLunsInlineArrayItemAccessModeLocal captures enum value "local"
	ConsistencyGroupInlineLunsInlineArrayItemAccessModeLocal string = "local"
)

// prop value enum
func (m *ConsistencyGroupInlineLunsInlineArrayItem) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, consistencyGroupInlineLunsInlineArrayItemTypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ConsistencyGroupInlineLunsInlineArrayItem) validateAccessMode(formats strfmt.Registry) error {
	if swag.IsZero(m.AccessMode) { // not required
		return nil
	}
...
func (m *ConsistencyGroupInlineLunsInlineArrayItemInlineClone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {
