...
// SwitchResponse switch response
//
// swagger:model switch_response
...
func (m *SwitchResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SwitchResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this switch response based on the context it is used
func (m *SwitchResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SwitchResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SwitchResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SwitchResponse) UnmarshalBinary(b []byte) error {
	var res SwitchResponse
