...
// UnixUserResponse unix user response
//
// swagger:model unix_user_response
...
func (m *UnixUserResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UnixUserResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this unix user response based on the context it is used
func (m *UnixUserResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UnixUserResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UnixUserResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UnixUserResponse) UnmarshalBinary(b []byte) error {
	var res UnixUserResponse
