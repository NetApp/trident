...
// Example: {"_links":{"directory":{"href":"/api/storage/volumes/02178914-5f67-11eb-b987-005056ac5da5/files/dir_1%2fdir_2"},"metadata":{"href":"/api/storage/volumes/02178914-5f67-11eb-b987-005056ac5da5/files/dir_1%2fdir_2?return_metadata=true"}},"iops":{"error":{"lower_bound":2,"upper_bound":5},"read":2,"write":3},"junction-path":"/fv","path":"/vol/fv/dir1_/dir_2","svm":{"name":"vserver_2","uuid":"42ee3002-67dd-11ea-8508-005056a7b8ac"},"throughput":{"error":{"lower_bound":3,"upper_bound":6},"read":3,"write":5},"total_ops":{"error":{"lower_bound":1400,"upper_bound":1450},"read":1400,"write":400},"total_throughput":{"error":{"lower_bound":2800,"upper_bound":2950},"read":2800,"write":600},"volume":{"name":"vol_8","uuid":"02178914-5f67-11eb-b987-005056ac5da5"}}
//
...
type TopMetricsSvmDirectory struct {
	...
	// total ops
	TotalOps *TopMetricsSvmDirectoryInlineTotalOps `json:"total_ops,omitempty"`

	// total throughput
	TotalThroughput *TopMetricsSvmDirectoryInlineTotalThroughput `json:"total_throughput,omitempty"`
...
func (m *TopMetricsSvmDirectory) validateTotalOps(formats strfmt.Registry) error {
...
func (m *TopMetricsSvmDirectory) validateTotalThroughput(formats strfmt.Registry) error {
...
func (m *TopMetricsSvmDirectory) contextValidateTotalOps(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmDirectory) contextValidateTotalThroughput(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsSvmDirectoryInlineSvm SVM, applies only to SVM-scoped objects.
//
...
// TopMetricsSvmDirectoryInlineTotalOps top metrics svm directory inline total ops
//
// swagger:model top_metrics_svm_directory_inline_total_ops
type TopMetricsSvmDirectoryInlineTotalOps struct {
...
// Validate validates this top metrics svm directory inline total ops
func (m *TopMetricsSvmDirectoryInlineTotalOps) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmDirectoryInlineTotalOps) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics svm directory inline total ops based on the context it is used
func (m *TopMetricsSvmDirectoryInlineTotalOps) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmDirectoryInlineTotalOps) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmDirectoryInlineTotalOps) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmDirectoryInlineTotalOps) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsSvmDirectoryInlineTotalOps) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsSvmDirectoryInlineTotalOps) UnmarshalBinary(b []byte) error {
	var res TopMetricsSvmDirectoryInlineTotalOps
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// TopMetricsSvmDirectoryInlineTotalThroughput top metrics svm directory inline total throughput
//
// swagger:model top_metrics_svm_directory_inline_total_throughput
type TopMetricsSvmDirectoryInlineTotalThroughput struct {
...
// Validate validates this top metrics svm directory inline total throughput
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics svm directory inline total throughput based on the context it is used
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsSvmDirectoryInlineTotalThroughput) UnmarshalBinary(b []byte) error {
	var res TopMetricsSvmDirectoryInlineTotalThroughput
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
