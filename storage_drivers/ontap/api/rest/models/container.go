...
type ContainerInlineVolumesInlineArrayItem struct {
	...
	// A comment for the container volume.
	// Max Length: 1023
	// Min Length: 0
	Comment *string `json:"comment,omitempty"`

	// encryption
	Encryption *ContainerInlineVolumesInlineArrayItemInlineEncryption `json:"encryption,omitempty"`
	...
	// guarantee
	Guarantee *ContainerInlineVolumesInlineArrayItemInlineGuarantee `json:"guarantee,omitempty"`

	// Specifies whether the volume should allow Amazon S3 multipart uploads with arbitrary part lengths. This is only supported for FlexGroup volumes with advanced granular data. The default value is `false`. When set to `true`, it cannot be reverted to `false`. Clusters with any volumes where this is `true` cannot be reverted to a release that does not support this feature.
	...
	// Specifies whether the volume should be protected by SnapMirror active sync for NAS.
	// Enum: ["protected","unprotected"]
	SmasProtection *string `json:"smas_protection,omitempty"`

	// snaplock
	Snaplock *ContainerInlineVolumesInlineArrayItemInlineSnaplock `json:"snaplock,omitempty"`

	// If set to true, this field enables the visible ".snapshot" directory from the client. The ".snapshot" directory will be available in every directory on the volume.
	...
	// Type of the volume.<br>rw &dash; read-write volume.<br>dp &dash; data-protection volume.<br>
	// Enum: ["rw","dp"]
...
func (m *ContainerInlineVolumesInlineArrayItem) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSmasProtection(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ContainerInlineVolumesInlineArrayItem) validateComment(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItem) validateEncryption(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItem) validateGuarantee(formats strfmt.Registry) error {
...
var containerInlineVolumesInlineArrayItemTypeSmasProtectionPropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["protected","unprotected"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		containerInlineVolumesInlineArrayItemTypeSmasProtectionPropEnum = append(containerInlineVolumesInlineArrayItemTypeSmasProtectionPropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// container_inline_volumes_inline_array_item
	// ContainerInlineVolumesInlineArrayItem
	// smas_protection
	// SmasProtection
	// protected
	// END DEBUGGING
	// ContainerInlineVolumesInlineArrayItemSmasProtectionProtected captures enum value "protected"
	ContainerInlineVolumesInlineArrayItemSmasProtectionProtected string = "protected"
	...
	// unprotected
	// END DEBUGGING
	// ContainerInlineVolumesInlineArrayItemSmasProtectionUnprotected captures enum value "unprotected"
	ContainerInlineVolumesInlineArrayItemSmasProtectionUnprotected string = "unprotected"
)

// prop value enum
func (m *ContainerInlineVolumesInlineArrayItem) validateSmasProtectionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerInlineVolumesInlineArrayItemTypeSmasProtectionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerInlineVolumesInlineArrayItem) validateSmasProtection(formats strfmt.Registry) error {
	if swag.IsZero(m.SmasProtection) { // not required
		return nil
	}

	// value enum
	if err := m.validateSmasProtectionEnum("smas_protection", "body", *m.SmasProtection); err != nil {
		return err
	}
...
var containerInlineVolumesInlineArrayItemTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerInlineVolumesInlineArrayItemTypeTypePropEnum = append(containerInlineVolumesInlineArrayItemTypeTypePropEnum, v)
	}
}
...
const (
	...
	// rw
	// END DEBUGGING
	// ContainerInlineVolumesInlineArrayItemTypeRw captures enum value "rw"
	ContainerInlineVolumesInlineArrayItemTypeRw string = "rw"
	...
	// dp
	// END DEBUGGING
	// ContainerInlineVolumesInlineArrayItemTypeDp captures enum value "dp"
	ContainerInlineVolumesInlineArrayItemTypeDp string = "dp"
)

// prop value enum
func (m *ContainerInlineVolumesInlineArrayItem) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerInlineVolumesInlineArrayItemTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerInlineVolumesInlineArrayItem) validateType(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItem) contextValidateEncryption(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItem) contextValidateGuarantee(ctx context.Context, formats strfmt.Registry) error {
...
// ContainerInlineVolumesInlineArrayItemInlineEncryption container inline volumes inline array item inline encryption
//
// swagger:model container_inline_volumes_inline_array_item_inline_encryption
type ContainerInlineVolumesInlineArrayItemInlineEncryption struct {

	// Creates an encrypted or unencrypted volume. For POST requests, when set to 'true', a new key is generated and used to encrypt the specified volume. The underlying SVM must be configured with the key manager. When set to 'false', the volume created will be unencrypted.
	// Example: true
	Enabled *bool `json:"enabled,omitempty"`
}

// Validate validates this container inline volumes inline array item inline encryption
func (m *ContainerInlineVolumesInlineArrayItemInlineEncryption) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container inline volumes inline array item inline encryption based on context it is used
func (m *ContainerInlineVolumesInlineArrayItemInlineEncryption) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineEncryption) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineEncryption) UnmarshalBinary(b []byte) error {
	var res ContainerInlineVolumesInlineArrayItemInlineEncryption
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerInlineVolumesInlineArrayItemInlineGuarantee container inline volumes inline array item inline guarantee
//
// swagger:model container_inline_volumes_inline_array_item_inline_guarantee
type ContainerInlineVolumesInlineArrayItemInlineGuarantee struct {

	// The type of space guarantee of this volume.
	// Example: volume
	// Enum: ["volume","none"]
	Type *string `json:"type,omitempty"`
}

// Validate validates this container inline volumes inline array item inline guarantee
func (m *ContainerInlineVolumesInlineArrayItemInlineGuarantee) Validate(formats strfmt.Registry) error {
	var res []error
...
var containerInlineVolumesInlineArrayItemInlineGuaranteeTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerInlineVolumesInlineArrayItemInlineGuaranteeTypeTypePropEnum = append(containerInlineVolumesInlineArrayItemInlineGuaranteeTypeTypePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// container_inline_volumes_inline_array_item_inline_guarantee
	// ContainerInlineVolumesInlineArrayItemInlineGuarantee
	// type
	// Type
	// volume
	// END DEBUGGING
	// ContainerInlineVolumesInlineArrayItemInlineGuaranteeTypeVolume captures enum value "volume"
	ContainerInlineVolumesInlineArrayItemInlineGuaranteeTypeVolume string = "volume"
	...
	// none
	// END DEBUGGING
	// ContainerInlineVolumesInlineArrayItemInlineGuaranteeTypeNone captures enum value "none"
	ContainerInlineVolumesInlineArrayItemInlineGuaranteeTypeNone string = "none"
)

// prop value enum
func (m *ContainerInlineVolumesInlineArrayItemInlineGuarantee) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerInlineVolumesInlineArrayItemInlineGuaranteeTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerInlineVolumesInlineArrayItemInlineGuarantee) validateType(formats strfmt.Registry) error {
	if swag.IsZero(m.Type) { // not required
		return nil
	}
...
// ContextValidate validates this container inline volumes inline array item inline guarantee based on context it is used
func (m *ContainerInlineVolumesInlineArrayItemInlineGuarantee) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineGuarantee) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineGuarantee) UnmarshalBinary(b []byte) error {
	var res ContainerInlineVolumesInlineArrayItemInlineGuarantee
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
type ContainerInlineVolumesInlineArrayItemInlineSpace struct {
	...
	// snapshot
	Snapshot *ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot `json:"snapshot,omitempty"`
}
...
func (m *ContainerInlineVolumesInlineArrayItemInlineSpace) validateSnapshot(formats strfmt.Registry) error {
...
// ContextValidate validate this container inline volumes inline array item inline space based on the context it is used
...
func (m *ContainerInlineVolumesInlineArrayItemInlineSpace) contextValidateSnapshot(ctx context.Context, formats strfmt.Registry) error {
...
// ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot container inline volumes inline array item inline space inline snapshot
//
// swagger:model container_inline_volumes_inline_array_item_inline_space_inline_snapshot
type ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot struct {
...
// Validate validates this container inline volumes inline array item inline space inline snapshot
func (m *ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container inline volumes inline array item inline space inline snapshot based on context it is used
func (m *ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot) UnmarshalBinary(b []byte) error {
	var res ContainerInlineVolumesInlineArrayItemInlineSpaceInlineSnapshot
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
