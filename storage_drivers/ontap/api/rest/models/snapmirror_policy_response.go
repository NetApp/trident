...
// SnapmirrorPolicyResponse snapmirror policy response
//
// swagger:model snapmirror_policy_response
...
func (m *SnapmirrorPolicyResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SnapmirrorPolicyResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this snapmirror policy response based on the context it is used
func (m *SnapmirrorPolicyResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SnapmirrorPolicyResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnapmirrorPolicyResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SnapmirrorPolicyResponse) UnmarshalBinary(b []byte) error {
	var res SnapmirrorPolicyResponse
