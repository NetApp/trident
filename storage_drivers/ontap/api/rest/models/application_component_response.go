...
// ApplicationComponentResponse application component response
//
// swagger:model application_component_response
...
func (m *ApplicationComponentResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationComponentResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this application component response based on the context it is used
func (m *ApplicationComponentResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationComponentResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApplicationComponentResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ApplicationComponentResponse) UnmarshalBinary(b []byte) error {
	var res ApplicationComponentResponse
