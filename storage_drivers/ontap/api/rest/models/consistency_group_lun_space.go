...
func (m *ConsistencyGroupLunSpace) validateSnapshot(formats strfmt.Registry) error {
...
func (m *ConsistencyGroupLunSpace) contextValidateSnapshot(ctx context.Context, formats strfmt.Registry) error {
