...
type SnapmirrorRelationship struct {
	...
	SnapmirrorRelationshipInlineSelectiveVolumes []*SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem `json:"selective_volumes,omitempty"`
...
func (m *SnapmirrorRelationship) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSnapmirrorRelationshipInlineSelectiveVolumes(formats); err != nil {
		res = append(res, err)
	}
...
const (
	...
	// coordination_group
	// END DEBUGGING
	// SnapmirrorRelationshipGroupTypeCoordinationGroup captures enum value "coordination_group"
	SnapmirrorRelationshipGroupTypeCoordinationGroup string = "coordination_group"
)
...
func (m *SnapmirrorRelationship) validateSnapmirrorRelationshipInlineSelectiveVolumes(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapmirrorRelationshipInlineSelectiveVolumes) { // not required
		return nil
	}

	for i := 0; i < len(m.SnapmirrorRelationshipInlineSelectiveVolumes); i++ {
		if swag.IsZero(m.SnapmirrorRelationshipInlineSelectiveVolumes[i]) { // not required
			continue
		}

		if m.SnapmirrorRelationshipInlineSelectiveVolumes[i] != nil {
			if err := m.SnapmirrorRelationshipInlineSelectiveVolumes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("selective_volumes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *SnapmirrorRelationship) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSnapmirrorRelationshipInlineSelectiveVolumes(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SnapmirrorRelationship) contextValidateSnapmirrorRelationshipInlineSelectiveVolumes(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.SnapmirrorRelationshipInlineSelectiveVolumes); i++ {

		if m.SnapmirrorRelationshipInlineSelectiveVolumes[i] != nil {
			if err := m.SnapmirrorRelationshipInlineSelectiveVolumes[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("selective_volumes" + "." + strconv.Itoa(i))
				}
				return err
...
func (m *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) Validate(formats strfmt.Registry) error {
	var res []error
...
// prop value enum
func (m *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) validateModeEnum(path, location string, value string) error {
...
func (m *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) validateMode(formats strfmt.Registry) error {
...
func (m *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) UnmarshalBinary(b []byte) error {
