...
// CoredumpResponse coredump response
//
// swagger:model coredump_response
...
func (m *CoredumpResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CoredumpResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this coredump response based on the context it is used
func (m *CoredumpResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CoredumpResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CoredumpResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CoredumpResponse) UnmarshalBinary(b []byte) error {
	var res CoredumpResponse
