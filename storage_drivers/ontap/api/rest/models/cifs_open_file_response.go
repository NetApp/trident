...
type CifsOpenFileResponse struct {
	...
	// records
	Records []*CifsOpenFile `json:"records,omitempty"`
}
...
func (m *CifsOpenFileResponse) validateRecords(formats strfmt.Registry) error {
...
func (m *CifsOpenFileResponse) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
