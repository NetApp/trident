...
// LdapSchemaReference ldap schema reference
//
// swagger:model ldap_schema_reference
...
func (m *LdapSchemaReference) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LdapSchemaReference) validateLinks(formats strfmt.Registry) error {
...
func (m *LdapSchemaReference) validateName(formats strfmt.Registry) error {
...
// ContextValidate validate this ldap schema reference based on the context it is used
func (m *LdapSchemaReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LdapSchemaReference) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LdapSchemaReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LdapSchemaReference) UnmarshalBinary(b []byte) error {
	var res LdapSchemaReference
