...
// BroadcastDomainSvmReference Broadcast domain UUID along with a readable name.
//
// swagger:model broadcast_domain_svm_reference
...
func (m *BroadcastDomainSvmReference) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BroadcastDomainSvmReference) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this broadcast domain svm reference based on the context it is used
func (m *BroadcastDomainSvmReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BroadcastDomainSvmReference) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BroadcastDomainSvmReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BroadcastDomainSvmReference) UnmarshalBinary(b []byte) error {
	var res BroadcastDomainSvmReference
