...
func (m *S3UserResponse) validateRecords(formats strfmt.Registry) error {
...
func (m *S3UserResponse) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
