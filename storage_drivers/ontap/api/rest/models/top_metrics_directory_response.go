...
type TopMetricsDirectoryResponse struct {
	...
	// observation window
	ObservationWindow *TopMetricsDirectoryResponseInlineObservationWindow `json:"observation_window,omitempty"`
...
func (m *TopMetricsDirectoryResponse) validateObservationWindow(formats strfmt.Registry) error {
...
func (m *TopMetricsDirectoryResponse) contextValidateObservationWindow(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsDirectoryResponseInlineObservationWindow The time window over which metrics are aggregated.
//
// swagger:model top_metrics_directory_response_inline_observation_window
type TopMetricsDirectoryResponseInlineObservationWindow struct {
...
// Validate validates this top metrics directory response inline observation window
func (m *TopMetricsDirectoryResponseInlineObservationWindow) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this top metrics directory response inline observation window based on the context it is used
func (m *TopMetricsDirectoryResponseInlineObservationWindow) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsDirectoryResponseInlineObservationWindow) contextValidateDuration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsDirectoryResponseInlineObservationWindow) contextValidateEnd(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsDirectoryResponseInlineObservationWindow) contextValidateStart(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsDirectoryResponseInlineObservationWindow) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsDirectoryResponseInlineObservationWindow) UnmarshalBinary(b []byte) error {
	var res TopMetricsDirectoryResponseInlineObservationWindow
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
