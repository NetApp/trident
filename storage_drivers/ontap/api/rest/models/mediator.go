...
var mediatorTypeConnectionTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		mediatorTypeConnectionTypePropEnum = append(mediatorTypeConnectionTypePropEnum, v)
	}
}
...
const (
	...
	// iscsi_mediator
	// END DEBUGGING
	// MediatorConnectionTypeIscsiMediator captures enum value "iscsi_mediator"
	MediatorConnectionTypeIscsiMediator string = "iscsi_mediator"
	...
	// https_mediator
	// END DEBUGGING
	// MediatorConnectionTypeHTTPSMediator captures enum value "https_mediator"
	MediatorConnectionTypeHTTPSMediator string = "https_mediator"
)

// prop value enum
func (m *Mediator) validateConnectionTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, mediatorTypeConnectionTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Mediator) validateConnectionType(formats strfmt.Registry) error {
