...
func (m *DNSResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this dns response based on the context it is used
func (m *DNSResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DNSResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
