...
func (m *JobLink) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JobLink) validateLinks(formats strfmt.Registry) error {
...
func (m *JobLink) validateUUID(formats strfmt.Registry) error {
...
// ContextValidate validate this job link based on the context it is used
func (m *JobLink) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *JobLink) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JobLink) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *JobLink) UnmarshalBinary(b []byte) error {
	var res JobLink
