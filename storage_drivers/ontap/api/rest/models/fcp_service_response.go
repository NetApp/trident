...
// FcpServiceResponse fcp service response
//
// swagger:model fcp_service_response
...
func (m *FcpServiceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FcpServiceResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this fcp service response based on the context it is used
func (m *FcpServiceResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FcpServiceResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FcpServiceResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FcpServiceResponse) UnmarshalBinary(b []byte) error {
	var res FcpServiceResponse
