...
type QosPolicy struct {
	...
	// burst
	Burst *QosPolicyInlineBurst `json:"burst,omitempty"`
...
func (m *QosPolicy) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateBurst(formats); err != nil {
		res = append(res, err)
	}
...
func (m *QosPolicy) validateBurst(formats strfmt.Registry) error {
	if swag.IsZero(m.Burst) { // not required
		return nil
	}

	if m.Burst != nil {
		if err := m.Burst.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("burst")
			}
			return err
		}
	}
...
func (m *QosPolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateBurst(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *QosPolicy) contextValidateBurst(ctx context.Context, formats strfmt.Registry) error {

	if m.Burst != nil {
		if err := m.Burst.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("burst")
			}
			return err
...
func (m *QosPolicyInlineBurst) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *QosPolicyInlineBurst) validateDuration(formats strfmt.Registry) error {
	if swag.IsZero(m.Duration) { // not required
		return nil
	}

	if err := validate.MinimumInt("burst"+"."+"duration", "body", *m.Duration, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("burst"+"."+"duration", "body", *m.Duration, 3600, false); err != nil {
		return err
	}
...
func (m *QosPolicyInlineBurst) validateIops(formats strfmt.Registry) error {
	if swag.IsZero(m.Iops) { // not required
		return nil
	}

	if err := validate.MinimumInt("burst"+"."+"iops", "body", *m.Iops, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("burst"+"."+"iops", "body", *m.Iops, 2.147483647e+09, false); err != nil {
		return err
	}
...
func (m *QosPolicyInlineBurst) validatePercent(formats strfmt.Registry) error {
	if swag.IsZero(m.Percent) { // not required
		return nil
	}

	if err := validate.MinimumInt("burst"+"."+"percent", "body", *m.Percent, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("burst"+"."+"percent", "body", *m.Percent, 2.147483647e+09, false); err != nil {
		return err
	}
...
func (m *QosPolicyInlineBurst) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *QosPolicyInlineBurst) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *QosPolicyInlineBurst) UnmarshalBinary(b []byte) error {
