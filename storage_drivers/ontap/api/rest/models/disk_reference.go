...
func (m *DiskReference) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DiskReference) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this disk reference based on the context it is used
func (m *DiskReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DiskReference) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DiskReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DiskReference) UnmarshalBinary(b []byte) error {
	var res DiskReference
