...
type TopMetricsUserResponse struct {
	...
	// observation window
	ObservationWindow *TopMetricsUserResponseInlineObservationWindow `json:"observation_window,omitempty"`
...
func (m *TopMetricsUserResponse) validateObservationWindow(formats strfmt.Registry) error {
...
func (m *TopMetricsUserResponse) contextValidateObservationWindow(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsUserResponseInlineObservationWindow The time window over which metrics are aggregated.
//
// swagger:model top_metrics_user_response_inline_observation_window
type TopMetricsUserResponseInlineObservationWindow struct {
...
// Validate validates this top metrics user response inline observation window
func (m *TopMetricsUserResponseInlineObservationWindow) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this top metrics user response inline observation window based on the context it is used
func (m *TopMetricsUserResponseInlineObservationWindow) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsUserResponseInlineObservationWindow) contextValidateDuration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsUserResponseInlineObservationWindow) contextValidateEnd(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsUserResponseInlineObservationWindow) contextValidateStart(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsUserResponseInlineObservationWindow) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsUserResponseInlineObservationWindow) UnmarshalBinary(b []byte) error {
	var res TopMetricsUserResponseInlineObservationWindow
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
