...
// Example: {"_links":{"metadata":{"href":"/api/storage/volumes/02178914-5f67-11eb-b987-005056ac5da5/files/dir_1%2ffile_1?return_metadata=true"}},"iops":{"error":{"lower_bound":2,"upper_bound":8},"read":2,"write":7},"path":"/dir_1/file_1","svm":{"name":"vserver_1","uuid":"42ee3002-67dd-11ea-8508-005056a7b8ac"},"throughput":{"error":{"lower_bound":24,"upper_bound":25},"read":24,"write":11},"total_ops":{"error":{"lower_bound":1400,"upper_bound":1450},"read":1400,"write":400},"total_throughput":{"error":{"lower_bound":2800,"upper_bound":2950},"read":2800,"write":600},"volume":{"name":"vol_6","uuid":"c05eb66a-685f-11ea-8508-005056a7b8ac"}}
//
...
type TopMetricsFile struct {
	...
	// total ops
	TotalOps *TopMetricsFileInlineTotalOps `json:"total_ops,omitempty"`

	// total throughput
	TotalThroughput *TopMetricsFileInlineTotalThroughput `json:"total_throughput,omitempty"`
...
func (m *TopMetricsFile) validateTotalOps(formats strfmt.Registry) error {
...
func (m *TopMetricsFile) validateTotalThroughput(formats strfmt.Registry) error {
...
func (m *TopMetricsFile) contextValidateTotalOps(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsFile) contextValidateTotalThroughput(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsFileInlineTotalOps top metrics file inline total ops
//
// swagger:model top_metrics_file_inline_total_ops
type TopMetricsFileInlineTotalOps struct {
...
// Validate validates this top metrics file inline total ops
func (m *TopMetricsFileInlineTotalOps) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsFileInlineTotalOps) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics file inline total ops based on the context it is used
func (m *TopMetricsFileInlineTotalOps) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsFileInlineTotalOps) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsFileInlineTotalOps) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsFileInlineTotalOps) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsFileInlineTotalOps) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsFileInlineTotalOps) UnmarshalBinary(b []byte) error {
	var res TopMetricsFileInlineTotalOps
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// TopMetricsFileInlineTotalThroughput top metrics file inline total throughput
//
// swagger:model top_metrics_file_inline_total_throughput
type TopMetricsFileInlineTotalThroughput struct {
...
// Validate validates this top metrics file inline total throughput
func (m *TopMetricsFileInlineTotalThroughput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsFileInlineTotalThroughput) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics file inline total throughput based on the context it is used
func (m *TopMetricsFileInlineTotalThroughput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsFileInlineTotalThroughput) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsFileInlineTotalThroughput) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsFileInlineTotalThroughput) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsFileInlineTotalThroughput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsFileInlineTotalThroughput) UnmarshalBinary(b []byte) error {
	var res TopMetricsFileInlineTotalThroughput
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
