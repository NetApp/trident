...
// CifsShareResponse cifs share response
//
// swagger:model cifs_share_response
...
func (m *CifsShareResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CifsShareResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this cifs share response based on the context it is used
func (m *CifsShareResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CifsShareResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CifsShareResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CifsShareResponse) UnmarshalBinary(b []byte) error {
	var res CifsShareResponse
