...
var consistencyGroupChildInlineLunsInlineArrayItemTypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		consistencyGroupChildInlineLunsInlineArrayItemTypeAccessModePropEnum = append(consistencyGroupChildInlineLunsInlineArrayItemTypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// ConsistencyGroupChildInlineLunsInlineArrayItemAccessModeGlobal captures enum value "global"
	ConsistencyGroupChildInlineLunsInlineArrayItemAccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// ConsistencyGroupChildInlineLunsInlineArrayItemAccessModeLocal captures enum value "local"
	ConsistencyGroupChildInlineLunsInlineArrayItemAccessModeLocal string = "local"
)

// prop value enum
func (m *ConsistencyGroupChildInlineLunsInlineArrayItem) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, consistencyGroupChildInlineLunsInlineArrayItemTypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ConsistencyGroupChildInlineLunsInlineArrayItem) validateAccessMode(formats strfmt.Registry) error {
...
func (m *ConsistencyGroupChildInlineLunsInlineArrayItemInlineClone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {
