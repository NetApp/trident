...
type TopMetricsClientResponse struct {
	...
	// observation window
	ObservationWindow *TopMetricsClientResponseInlineObservationWindow `json:"observation_window,omitempty"`
...
func (m *TopMetricsClientResponse) validateObservationWindow(formats strfmt.Registry) error {
...
func (m *TopMetricsClientResponse) contextValidateObservationWindow(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsClientResponseInlineObservationWindow The time window over which metrics are aggregated.
//
// swagger:model top_metrics_client_response_inline_observation_window
type TopMetricsClientResponseInlineObservationWindow struct {
...
// Validate validates this top metrics client response inline observation window
func (m *TopMetricsClientResponseInlineObservationWindow) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this top metrics client response inline observation window based on the context it is used
func (m *TopMetricsClientResponseInlineObservationWindow) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsClientResponseInlineObservationWindow) contextValidateDuration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsClientResponseInlineObservationWindow) contextValidateEnd(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsClientResponseInlineObservationWindow) contextValidateStart(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsClientResponseInlineObservationWindow) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsClientResponseInlineObservationWindow) UnmarshalBinary(b []byte) error {
	var res TopMetricsClientResponseInlineObservationWindow
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
