...
func (m *SnapshotPolicyInlineCopiesInlineArrayItem) validateSnapmirrorLabel(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapmirrorLabel) { // not required
		return nil
	}

	if err := validate.MinLength("snapmirror_label", "body", *m.SnapmirrorLabel, 1); err != nil {
		return err
	}
