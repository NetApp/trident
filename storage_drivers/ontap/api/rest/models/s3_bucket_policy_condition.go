...
type S3BucketPolicyCondition struct {
	...
	// Controls conditional writes via If-None-Match header, evaluated with the Null operator; indicates whether the If-None-Match header is present or not.
	//
	IfNoneMatch *bool `json:"if_none_match,omitempty"`

	// Controls object creation requests, evaluated with the Bool operator; indicates whether it is an object-creation request or not.
	//
	ObjectCreationOperation *bool `json:"object_creation_operation,omitempty"`

	// Condition operator that is applied to the specified condition key.
	// Example: ip_address
	// Enum: ["ip_address","not_ip_address","string_equals","string_not_equals","string_equals_ignore_case","string_not_equals_ignore_case","string_like","string_not_like","numeric_equals","numeric_not_equals","numeric_greater_than","numeric_greater_than_equals","numeric_less_than","numeric_less_than_equals","bool","null"]
	...
	// Controls conditional writes via If-Match header, evaluated with the Null operator; indicates whether the If-Match header is present or not.
	//
	// Example: ["true"]
	S3BucketPolicyConditionInlineIfMatch []*string `json:"if_match,omitempty"`
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ip_address","not_ip_address","string_equals","string_not_equals","string_equals_ignore_case","string_not_equals_ignore_case","string_like","string_not_like","numeric_equals","numeric_not_equals","numeric_greater_than","numeric_greater_than_equals","numeric_less_than","numeric_less_than_equals","bool","null"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// bool
	// END DEBUGGING
	// S3BucketPolicyConditionOperatorBool captures enum value "bool"
	S3BucketPolicyConditionOperatorBool string = "bool"
	...
	// null
	// END DEBUGGING
	// S3BucketPolicyConditionOperatorNull captures enum value "null"
	S3BucketPolicyConditionOperatorNull string = "null"
)
