...
var metroclusterInlineMediatorTypeConnectionTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		metroclusterInlineMediatorTypeConnectionTypePropEnum = append(metroclusterInlineMediatorTypeConnectionTypePropEnum, v)
	}
}
...
const (
	...
	// iscsi_mediator
	// END DEBUGGING
	// MetroclusterInlineMediatorConnectionTypeIscsiMediator captures enum value "iscsi_mediator"
	MetroclusterInlineMediatorConnectionTypeIscsiMediator string = "iscsi_mediator"
	...
	// https_mediator
	// END DEBUGGING
	// MetroclusterInlineMediatorConnectionTypeHTTPSMediator captures enum value "https_mediator"
	MetroclusterInlineMediatorConnectionTypeHTTPSMediator string = "https_mediator"
)

// prop value enum
func (m *MetroclusterInlineMediator) validateConnectionTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, metroclusterInlineMediatorTypeConnectionTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *MetroclusterInlineMediator) validateConnectionType(formats strfmt.Registry) error {
	if swag.IsZero(m.ConnectionType) { // not required
		return nil
	}

	// value enum
	if err := m.validateConnectionTypeEnum("mediator"+"."+"connection_type", "body", *m.ConnectionType); err != nil {
		return err
	}
