...
// AzureKeyVaultResponse azure key vault response
//
// swagger:model azure_key_vault_response
...
func (m *AzureKeyVaultResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureKeyVaultResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this azure key vault response based on the context it is used
func (m *AzureKeyVaultResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureKeyVaultResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureKeyVaultResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AzureKeyVaultResponse) UnmarshalBinary(b []byte) error {
	var res AzureKeyVaultResponse
