...
func (m *SecurityKeystore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateIsSvmKek(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SecurityKeystore) contextValidateIsSvmKek(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "is_svm_kek", "body", m.IsSvmKek); err != nil {
		return err
	}
