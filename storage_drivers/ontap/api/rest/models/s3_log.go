...
type S3Log struct {
	...
	// links
	Links *S3LogLinks `json:"_links,omitempty"`
	...
	// retention
	Retention *S3LogRetention `json:"retention,omitempty"`
...
// S3LogLinks s3 log links
//
// swagger:model S3LogLinks
type S3LogLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this s3 log links
func (m *S3LogLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *S3LogLinks) validateSelf(formats strfmt.Registry) error {
...
// ContextValidate validate this s3 log links based on the context it is used
func (m *S3LogLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *S3LogLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *S3LogLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *S3LogLinks) UnmarshalBinary(b []byte) error {
	var res S3LogLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
...
// S3LogRetention s3 log retention
//
// swagger:model S3LogRetention
type S3LogRetention struct {
...
// Validate validates this s3 log retention
func (m *S3LogRetention) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this s3 log retention based on context it is used
func (m *S3LogRetention) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *S3LogRetention) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *S3LogRetention) UnmarshalBinary(b []byte) error {
	var res S3LogRetention
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
