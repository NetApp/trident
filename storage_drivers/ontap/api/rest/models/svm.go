...
func (m *Svm) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSanMultipathing(formats); err != nil {
		res = append(res, err)
	}
...
var svmTypeSanMultipathingPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		svmTypeSanMultipathingPropEnum = append(svmTypeSanMultipathingPropEnum, v)
	}
}
...
const (
	...
	// local_active
	// END DEBUGGING
	// SvmSanMultipathingLocalActive captures enum value "local_active"
	SvmSanMultipathingLocalActive string = "local_active"
	...
	// active_active
	// END DEBUGGING
	// SvmSanMultipathingActiveActive captures enum value "active_active"
	SvmSanMultipathingActiveActive string = "active_active"
	...
	// END DEBUGGING
	// SvmSanMultipathingActiveActiveScsiOnly captures enum value "active_active_scsi_only"
	SvmSanMultipathingActiveActiveScsiOnly string = "active_active_scsi_only"
)

// prop value enum
func (m *Svm) validateSanMultipathingEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, svmTypeSanMultipathingPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Svm) validateSanMultipathing(formats strfmt.Registry) error {
	if swag.IsZero(m.SanMultipathing) { // not required
		return nil
	}

	// value enum
	if err := m.validateSanMultipathingEnum("san_multipathing", "body", *m.SanMultipathing); err != nil {
		return err
	}
...
// prop value enum
func (m *SvmInlineSnapmirror) validateProtectionTypeEnum(path, location string, value string) error {
...
func (m *SvmInlineSnapmirror) validateProtectionType(formats strfmt.Registry) error {
	if swag.IsZero(m.ProtectionType) { // not required
		return nil
	}

	// value enum
	if err := m.validateProtectionTypeEnum("snapmirror"+"."+"protection_type", "body", *m.ProtectionType); err != nil {
		return err
	}
...
func (m *SvmInlineSnapmirror) contextValidateProtectionType(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "snapmirror"+"."+"protection_type", "body", m.ProtectionType); err != nil {
		return err
	}
