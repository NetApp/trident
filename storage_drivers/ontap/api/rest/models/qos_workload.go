...
type QosWorkload struct {
	...
	// Specifies the maximum throughput in MB/s or B/s as appropriate.
	// Example: 500MB/s
	// Read Only: true
	MaxThroughput *string `json:"max_throughput,omitempty"`

	// Specifies the maximum throughput in IOPS, 0 means none.
	// Example: 10000
	// Read Only: true
	...
	// Specifies the minimum throughput in MB/s or B/s as appropriate.
	// Example: 100MB/s
	// Read Only: true
	MinThroughput *string `json:"min_throughput,omitempty"`

	// Specifies the minimum throughput in IOPS, 0 means none.
	// Example: 2000
	// Read Only: true
	// Maximum: 2.147483647e+09
	// Minimum: 0
...
func (m *QosWorkload) validateMaxThroughputIops(formats strfmt.Registry) error {
...
func (m *QosWorkload) validateMinThroughputIops(formats strfmt.Registry) error {
...
func (m *QosWorkload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateMinThroughput(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *QosWorkload) contextValidateMaxThroughput(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QosWorkload) contextValidateMaxThroughputIops(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QosWorkload) contextValidateMinThroughput(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "min_throughput", "body", m.MinThroughput); err != nil {
		return err
	}
...
func (m *QosWorkload) contextValidateMinThroughputIops(ctx context.Context, formats strfmt.Registry) error {
