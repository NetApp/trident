...
type ContainerResponseRecordsItems0VolumesItems0 struct {
	...
	// encryption
	Encryption *ContainerResponseRecordsItems0VolumesItems0Encryption `json:"encryption,omitempty"`
	...
	// guarantee
	Guarantee *ContainerResponseRecordsItems0VolumesItems0Guarantee `json:"guarantee,omitempty"`
...
func (m *ContainerResponseRecordsItems0VolumesItems0) validateComment(formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0) validateEncryption(formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0) validateGuarantee(formats strfmt.Registry) error {
...
var containerResponseRecordsItems0VolumesItems0TypeSmasProtectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerResponseRecordsItems0VolumesItems0TypeSmasProtectionPropEnum = append(containerResponseRecordsItems0VolumesItems0TypeSmasProtectionPropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0
	// ContainerResponseRecordsItems0VolumesItems0
	// smas_protection
	// SmasProtection
	// protected
	// END DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0SmasProtectionProtected captures enum value "protected"
	ContainerResponseRecordsItems0VolumesItems0SmasProtectionProtected string = "protected"
	...
	// unprotected
	// END DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0SmasProtectionUnprotected captures enum value "unprotected"
	ContainerResponseRecordsItems0VolumesItems0SmasProtectionUnprotected string = "unprotected"
)

// prop value enum
func (m *ContainerResponseRecordsItems0VolumesItems0) validateSmasProtectionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerResponseRecordsItems0VolumesItems0TypeSmasProtectionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerResponseRecordsItems0VolumesItems0) validateSmasProtection(formats strfmt.Registry) error {
...
var containerResponseRecordsItems0VolumesItems0TypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerResponseRecordsItems0VolumesItems0TypeTypePropEnum = append(containerResponseRecordsItems0VolumesItems0TypeTypePropEnum, v)
	}
}
...
const (
	...
	// rw
	// END DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0TypeRw captures enum value "rw"
	ContainerResponseRecordsItems0VolumesItems0TypeRw string = "rw"
	...
	// dp
	// END DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0TypeDp captures enum value "dp"
	ContainerResponseRecordsItems0VolumesItems0TypeDp string = "dp"
)

// prop value enum
func (m *ContainerResponseRecordsItems0VolumesItems0) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerResponseRecordsItems0VolumesItems0TypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerResponseRecordsItems0VolumesItems0) validateType(formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0) contextValidateEncryption(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0) contextValidateGuarantee(ctx context.Context, formats strfmt.Registry) error {
...
// ContainerResponseRecordsItems0VolumesItems0Encryption container response records items0 volumes items0 encryption
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0Encryption
type ContainerResponseRecordsItems0VolumesItems0Encryption struct {
...
// Validate validates this container response records items0 volumes items0 encryption
func (m *ContainerResponseRecordsItems0VolumesItems0Encryption) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container response records items0 volumes items0 encryption based on context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0Encryption) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0Encryption) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0Encryption) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0Encryption
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerResponseRecordsItems0VolumesItems0Guarantee container response records items0 volumes items0 guarantee
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0Guarantee
type ContainerResponseRecordsItems0VolumesItems0Guarantee struct {
...
// Validate validates this container response records items0 volumes items0 guarantee
func (m *ContainerResponseRecordsItems0VolumesItems0Guarantee) Validate(formats strfmt.Registry) error {
	var res []error
...
var containerResponseRecordsItems0VolumesItems0GuaranteeTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerResponseRecordsItems0VolumesItems0GuaranteeTypeTypePropEnum = append(containerResponseRecordsItems0VolumesItems0GuaranteeTypeTypePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0Guarantee
	// ContainerResponseRecordsItems0VolumesItems0Guarantee
	// type
	// Type
	// volume
	// END DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0GuaranteeTypeVolume captures enum value "volume"
	ContainerResponseRecordsItems0VolumesItems0GuaranteeTypeVolume string = "volume"
	...
	// none
	// END DEBUGGING
	// ContainerResponseRecordsItems0VolumesItems0GuaranteeTypeNone captures enum value "none"
	ContainerResponseRecordsItems0VolumesItems0GuaranteeTypeNone string = "none"
)

// prop value enum
func (m *ContainerResponseRecordsItems0VolumesItems0Guarantee) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerResponseRecordsItems0VolumesItems0GuaranteeTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerResponseRecordsItems0VolumesItems0Guarantee) validateType(formats strfmt.Registry) error {
	if swag.IsZero(m.Type) { // not required
		return nil
	}
...
// ContextValidate validates this container response records items0 volumes items0 guarantee based on context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0Guarantee) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0Guarantee) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0Guarantee) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0Guarantee
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
type ContainerResponseRecordsItems0VolumesItems0Space struct {
	...
	// snapshot
	Snapshot *ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot `json:"snapshot,omitempty"`
}
...
func (m *ContainerResponseRecordsItems0VolumesItems0Space) validateSnapshot(formats strfmt.Registry) error {
...
// ContextValidate validate this container response records items0 volumes items0 space based on the context it is used
...
func (m *ContainerResponseRecordsItems0VolumesItems0Space) contextValidateSnapshot(ctx context.Context, formats strfmt.Registry) error {
...
// ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot container response records items0 volumes items0 space snapshot
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot
type ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot struct {
...
// Validate validates this container response records items0 volumes items0 space snapshot
func (m *ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container response records items0 volumes items0 space snapshot based on context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0SpaceSnapshot
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
