...
// Example: {"_links":{"directory":{"href":"/api/storage/volumes/02178914-5f67-11eb-b987-005056ac5da5/files/dir_1%2fdir_2"},"metadata":{"href":"/api/storage/volumes/02178914-5f67-11eb-b987-005056ac5da5/files/dir_1%2fdir_2?return_metadata=true"}},"iops":{"error":{"lower_bound":2,"upper_bound":5},"read":2,"write":3},"non_recursive_bytes_used":300,"path":"/dir1_/dir_2","svm":{"name":"vserver_2","uuid":"42ee3002-67dd-11ea-8508-005056a7b8ac"},"throughput":{"error":{"lower_bound":3,"upper_bound":6},"read":3,"write":5},"total_ops":{"error":{"lower_bound":1400,"upper_bound":1450},"read":1400,"write":400},"total_throughput":{"error":{"lower_bound":2800,"upper_bound":2950},"read":2800,"write":600},"volume":{"name":"vol_8","uuid":"c05eb66a-685f-11ea-8508-005056a7b8ac"}}
//
// swagger:model top_metrics_directory
type TopMetricsDirectory struct {

	// links
	Links *TopMetricsDirectoryInlineLinks `json:"_links,omitempty"`

	// iops
	Iops *TopMetricsDirectoryInlineIops `json:"iops,omitempty"`

	// Non-recursive bytes used by the contents of a directory.
	// Example: 300
	// Read Only: true
	NonRecursiveBytesUsed *int64 `json:"non_recursive_bytes_used,omitempty"`
	...
	// svm
	Svm *TopMetricsDirectoryInlineSvm `json:"svm,omitempty"`

	// throughput
	Throughput *TopMetricsDirectoryInlineThroughput `json:"throughput,omitempty"`

	// total ops
	TotalOps *TopMetricsDirectoryInlineTotalOps `json:"total_ops,omitempty"`

	// total throughput
	TotalThroughput *TopMetricsDirectoryInlineTotalThroughput `json:"total_throughput,omitempty"`

	// volume
	Volume *TopMetricsDirectoryInlineVolume `json:"volume,omitempty"`
}
...
func (m *TopMetricsDirectory) validateTotalOps(formats strfmt.Registry) error {
...
func (m *TopMetricsDirectory) validateTotalThroughput(formats strfmt.Registry) error {
...
func (m *TopMetricsDirectory) contextValidateTotalOps(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsDirectory) contextValidateTotalThroughput(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsDirectoryInlineTotalOps top metrics directory inline total ops
//
// swagger:model top_metrics_directory_inline_total_ops
type TopMetricsDirectoryInlineTotalOps struct {
...
// Validate validates this top metrics directory inline total ops
func (m *TopMetricsDirectoryInlineTotalOps) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsDirectoryInlineTotalOps) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics directory inline total ops based on the context it is used
func (m *TopMetricsDirectoryInlineTotalOps) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsDirectoryInlineTotalOps) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsDirectoryInlineTotalOps) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsDirectoryInlineTotalOps) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsDirectoryInlineTotalOps) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsDirectoryInlineTotalOps) UnmarshalBinary(b []byte) error {
	var res TopMetricsDirectoryInlineTotalOps
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// TopMetricsDirectoryInlineTotalThroughput top metrics directory inline total throughput
//
// swagger:model top_metrics_directory_inline_total_throughput
type TopMetricsDirectoryInlineTotalThroughput struct {
...
// Validate validates this top metrics directory inline total throughput
func (m *TopMetricsDirectoryInlineTotalThroughput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsDirectoryInlineTotalThroughput) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics directory inline total throughput based on the context it is used
func (m *TopMetricsDirectoryInlineTotalThroughput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsDirectoryInlineTotalThroughput) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsDirectoryInlineTotalThroughput) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsDirectoryInlineTotalThroughput) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsDirectoryInlineTotalThroughput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsDirectoryInlineTotalThroughput) UnmarshalBinary(b []byte) error {
	var res TopMetricsDirectoryInlineTotalThroughput
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
