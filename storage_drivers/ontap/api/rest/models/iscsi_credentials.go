...
func (m *IscsiCredentialsInlineChapInlineInbound) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("chap"+"."+"inbound"+"."+"password", "body", m.Password.String(), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("chap"+"."+"inbound"+"."+"password", "body", m.Password.String(), 512); err != nil {
		return err
	}

	if err := validate.FormatOf("chap"+"."+"inbound"+"."+"password", "body", "password", m.Password.String(), formats); err != nil {
		return err
	}
...
func (m *IscsiCredentialsInlineChapInlineOutbound) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("chap"+"."+"outbound"+"."+"password", "body", m.Password.String(), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("chap"+"."+"outbound"+"."+"password", "body", m.Password.String(), 512); err != nil {
		return err
	}

	if err := validate.FormatOf("chap"+"."+"outbound"+"."+"password", "body", "password", m.Password.String(), formats); err != nil {
		return err
	}
