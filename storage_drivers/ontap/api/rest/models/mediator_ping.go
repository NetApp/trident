...
// MediatorPing NetApp Console cloud service ping API.
//
// swagger:model mediator_ping
type MediatorPing struct {

	// Indicates if the ONTAP cloud mediator is configurable. This depends on whether the ping latency is within a threshold.
	// Example: true
	// Read Only: true
	Configurable *bool `json:"configurable,omitempty"`

	// Indicates if the ping latency of the NetApp Console cloud server is greater than a threshold.
	// Example: false
	// Read Only: true
	...
	// Indicates if the HTTP proxy is configured on the cluster for the REST API calls to the NetApp Console cloud server.
	// Example: true
	// Read Only: true
	ProxyConfigured *bool `json:"proxy_configured,omitempty"`

	// Indicates if the HTTP proxy is used for the ping to the NetApp Console cloud server.
	// Example: true
	// Read Only: true
	ProxyUsed *bool `json:"proxy_used,omitempty"`

	// Ping status of the NetApp Console cloud service.
	// Example: true
	// Read Only: true
	Reachable *bool `json:"reachable,omitempty"`

	// Indicates if the ping to the NetApp Console cloud server failed due to a timeout.
	// Example: false
	// Read Only: true
