...
// AdDomainDelete ad domain delete
//
// swagger:model ad_domain_delete
type AdDomainDelete struct {
...
// Validate validates this ad domain delete
func (m *AdDomainDelete) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this ad domain delete based on context it is used
func (m *AdDomainDelete) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AdDomainDelete) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AdDomainDelete) UnmarshalBinary(b []byte) error {
	var res AdDomainDelete
