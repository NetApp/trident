...
// S3PolicyReference s3 policy reference
//
// swagger:model s3_policy_reference
...
func (m *S3PolicyReference) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *S3PolicyReference) validateLinks(formats strfmt.Registry) error {
...
func (m *S3PolicyReference) validateName(formats strfmt.Registry) error {
...
// ContextValidate validate this s3 policy reference based on the context it is used
func (m *S3PolicyReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *S3PolicyReference) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *S3PolicyReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *S3PolicyReference) UnmarshalBinary(b []byte) error {
	var res S3PolicyReference
