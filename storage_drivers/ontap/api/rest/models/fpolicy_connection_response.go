...
// FpolicyConnectionResponse fpolicy connection response
//
// swagger:model fpolicy_connection_response
...
func (m *FpolicyConnectionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FpolicyConnectionResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this fpolicy connection response based on the context it is used
func (m *FpolicyConnectionResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FpolicyConnectionResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FpolicyConnectionResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FpolicyConnectionResponse) UnmarshalBinary(b []byte) error {
	var res FpolicyConnectionResponse
