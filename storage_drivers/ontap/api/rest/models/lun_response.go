...
// LunResponse lun response
//
// swagger:model lun_response
...
func (m *LunResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LunResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this lun response based on the context it is used
func (m *LunResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LunResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LunResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LunResponse) UnmarshalBinary(b []byte) error {
	var res LunResponse
