...
// ApplicationNamespaceObject Namespace object
//
// swagger:model application_namespace_object
...
func (m *ApplicationNamespaceObject) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationNamespaceObject) validateLinks(formats strfmt.Registry) error {
...
func (m *ApplicationNamespaceObject) validateCreationTimestamp(formats strfmt.Registry) error {
...
// ContextValidate validate this application namespace object based on the context it is used
func (m *ApplicationNamespaceObject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationNamespaceObject) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApplicationNamespaceObject) contextValidateCreationTimestamp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApplicationNamespaceObject) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ApplicationNamespaceObject) UnmarshalBinary(b []byte) error {
	var res ApplicationNamespaceObject
