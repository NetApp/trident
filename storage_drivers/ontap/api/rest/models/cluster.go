...
type Cluster struct {
	...
	// ha
	Ha *ClusterInlineHa `json:"ha,omitempty"`
...
func (m *Cluster) validateHa(formats strfmt.Registry) error {
...
func (m *Cluster) contextValidateHa(ctx context.Context, formats strfmt.Registry) error {
...
// ClusterInlineHa Storage failover cluster configuration.
//
// swagger:model cluster_inline_ha
type ClusterInlineHa struct {

	// Specifies the number of concurrent node failures the cluster can tolerate with no disruptions.
	// Example: nplusone
	// Enum: ["nplusone","nplustwo"]
	FailoverProtectionLevel *string `json:"failover_protection_level,omitempty"`
}

// Validate validates this cluster inline ha
func (m *ClusterInlineHa) Validate(formats strfmt.Registry) error {
	var res []error

	if err := m.validateFailoverProtectionLevel(formats); err != nil {
		res = append(res, err)
	}
...
var clusterInlineHaTypeFailoverProtectionLevelPropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["nplusone","nplustwo"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		clusterInlineHaTypeFailoverProtectionLevelPropEnum = append(clusterInlineHaTypeFailoverProtectionLevelPropEnum, v)
	}
}
...
const (
	...
	// FailoverProtectionLevel
	// nplusone
	// END DEBUGGING
	// ClusterInlineHaFailoverProtectionLevelNplusone captures enum value "nplusone"
	ClusterInlineHaFailoverProtectionLevelNplusone string = "nplusone"
	...
	// nplustwo
	// END DEBUGGING
	// ClusterInlineHaFailoverProtectionLevelNplustwo captures enum value "nplustwo"
	ClusterInlineHaFailoverProtectionLevelNplustwo string = "nplustwo"
)

// prop value enum
func (m *ClusterInlineHa) validateFailoverProtectionLevelEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, clusterInlineHaTypeFailoverProtectionLevelPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ClusterInlineHa) validateFailoverProtectionLevel(formats strfmt.Registry) error {
	if swag.IsZero(m.FailoverProtectionLevel) { // not required
		return nil
	}

	// value enum
	if err := m.validateFailoverProtectionLevelEnum("ha"+"."+"failover_protection_level", "body", *m.FailoverProtectionLevel); err != nil {
		return err
	}
...
// ContextValidate validates this cluster inline ha based on context it is used
func (m *ClusterInlineHa) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ClusterInlineHa) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineHa) UnmarshalBinary(b []byte) error {
	var res ClusterInlineHa
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
type ClusterInlineNodesInlineArrayItemInlineHa struct {
	...
	// giveback of
	GivebackOf *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf `json:"giveback_of,omitempty"`

	// Specifies whether or not storage giveback is possible.
	// Read Only: true
	GivebackOfPossible *bool `json:"giveback_of_possible,omitempty"`
	...
	// peering
	Peering *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering `json:"peering,omitempty"`
	...
	// takeover of
	TakeoverOf *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf `json:"takeover_of,omitempty"`

	// Specifies whether or not storage takeover is possible.
	// Read Only: true
	TakeoverOfPossible *bool `json:"takeover_of_possible,omitempty"`
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGivebackOf(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateTakeoverOf(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) validateGivebackOf(formats strfmt.Registry) error {
	if swag.IsZero(m.GivebackOf) { // not required
		return nil
	}

	if m.GivebackOf != nil {
		if err := m.GivebackOf.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "giveback_of")
			}
			return err
		}
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) validatePeering(formats strfmt.Registry) error {
	...
	if m.Peering != nil {
		if err := m.Peering.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering")
			}
			return err
		}
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) validateTakeoverOf(formats strfmt.Registry) error {
	if swag.IsZero(m.TakeoverOf) { // not required
		return nil
	}

	if m.TakeoverOf != nil {
		if err := m.TakeoverOf.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "takeover_of")
			}
			return err
		}
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGivebackOf(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateGivebackOfPossible(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateTakeoverOf(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateTakeoverOfPossible(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) contextValidateGivebackOf(ctx context.Context, formats strfmt.Registry) error {

	if m.GivebackOf != nil {
		if err := m.GivebackOf.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "giveback_of")
			}
			return err
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) contextValidateGivebackOfPossible(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "ha"+"."+"giveback_of_possible", "body", m.GivebackOfPossible); err != nil {
		return err
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) contextValidatePeering(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) contextValidateTakeoverOf(ctx context.Context, formats strfmt.Registry) error {

	if m.TakeoverOf != nil {
		if err := m.TakeoverOf.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "takeover_of")
			}
			return err
...
func (m *ClusterInlineNodesInlineArrayItemInlineHa) contextValidateTakeoverOfPossible(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "ha"+"."+"takeover_of_possible", "body", m.TakeoverOfPossible); err != nil {
		return err
	}
...
// ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf Represents the state of storage being given back to the node.
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_giveback_of
type ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf struct {

	// failure
	Failure *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure `json:"failure,omitempty"`
...
// Validate validates this cluster inline nodes inline array item inline ha inline giveback of
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) validateFailure(formats strfmt.Registry) error {
	if swag.IsZero(m.Failure) { // not required
		return nil
	}
	...
	if m.Failure != nil {
		if err := m.Failure.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "giveback_of" + "." + "failure")
			}
			return err
		}
	}
...
var clusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		clusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum = append(clusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// cluster_inline_nodes_inline_array_item_inline_ha_inline_giveback_of
	// ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf
	// state
	// State
	// nothing_to_giveback
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateNothingToGiveback captures enum value "nothing_to_giveback"
	ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateNothingToGiveback string = "nothing_to_giveback"
	...
	// not_attempted
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateNotAttempted captures enum value "not_attempted"
	ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateNotAttempted string = "not_attempted"
	...
	// in_progress
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateInProgress captures enum value "in_progress"
	ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateInProgress string = "in_progress"
	...
	// failed
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateFailed captures enum value "failed"
	ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfStateFailed string = "failed"
)

// prop value enum
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, clusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) validateState(formats strfmt.Registry) error {
	if swag.IsZero(m.State) { // not required
		return nil
	}

	// value enum
	if err := m.validateStateEnum("ha"+"."+"giveback_of"+"."+"state", "body", *m.State); err != nil {
		return err
	}
...
// ContextValidate validate this cluster inline nodes inline array item inline ha inline giveback of based on the context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) contextValidateFailure(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOf
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure Indicates the failure code and message.
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_giveback_of_inline_failure
type ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure struct {
...
// Validate validates this cluster inline nodes inline array item inline ha inline giveback of inline failure
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this cluster inline nodes inline array item inline ha inline giveback of inline failure based on the context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlineGivebackOfInlineFailure
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ClusterInlineNodesInlineArrayItemInlineHaInlinePeering cluster inline nodes inline array item inline ha inline peering
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_peering
type ClusterInlineNodesInlineArrayItemInlineHaInlinePeering struct {

	// dst peer node1
	DstPeerNode1 *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1 `json:"dst_peer_node1,omitempty"`

	// dst peer node2
	DstPeerNode2 *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2 `json:"dst_peer_node2,omitempty"`

	// dst peer node3
	DstPeerNode3 *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3 `json:"dst_peer_node3,omitempty"`

	// Indicates if the node is ineligible for peering.
	// Example: true
	Ineligible *bool `json:"ineligible,omitempty"`

	// The protection level of the node.
	// Example: 1
	NodeProtectionLevel *int64 `json:"node_protection_level,omitempty"`
}

// Validate validates this cluster inline nodes inline array item inline ha inline peering
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) Validate(formats strfmt.Registry) error {
	var res []error

	if err := m.validateDstPeerNode1(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateDstPeerNode2(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateDstPeerNode3(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) validateDstPeerNode1(formats strfmt.Registry) error {
	if swag.IsZero(m.DstPeerNode1) { // not required
		return nil
	}

	if m.DstPeerNode1 != nil {
		if err := m.DstPeerNode1.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node1")
			}
			return err
		}
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) validateDstPeerNode2(formats strfmt.Registry) error {
	if swag.IsZero(m.DstPeerNode2) { // not required
		return nil
	}

	if m.DstPeerNode2 != nil {
		if err := m.DstPeerNode2.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node2")
			}
			return err
		}
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) validateDstPeerNode3(formats strfmt.Registry) error {
	if swag.IsZero(m.DstPeerNode3) { // not required
		return nil
	}

	if m.DstPeerNode3 != nil {
		if err := m.DstPeerNode3.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node3")
			}
			return err
		}
	}
...
// ContextValidate validate this cluster inline nodes inline array item inline ha inline peering based on the context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateDstPeerNode1(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateDstPeerNode2(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateDstPeerNode3(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) contextValidateDstPeerNode1(ctx context.Context, formats strfmt.Registry) error {

	if m.DstPeerNode1 != nil {
		if err := m.DstPeerNode1.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node1")
			}
			return err
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) contextValidateDstPeerNode2(ctx context.Context, formats strfmt.Registry) error {

	if m.DstPeerNode2 != nil {
		if err := m.DstPeerNode2.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node2")
			}
			return err
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) contextValidateDstPeerNode3(ctx context.Context, formats strfmt.Registry) error {

	if m.DstPeerNode3 != nil {
		if err := m.DstPeerNode3.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node3")
			}
			return err
...
// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeering) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlinePeering
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1 cluster inline nodes inline array item inline ha inline peering inline dst peer node1
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_peering_inline_dst_peer_node1
type ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1 struct {

	// The first failover destination peer node name.
	// Example: node-01
	Name *string `json:"name,omitempty"`

	// The first failover destination peer node UUID.
	// Example: 4ea7a442-86d1-11e0-ae1c-123478563411
	UUID *string `json:"uuid,omitempty"`
}

// Validate validates this cluster inline nodes inline array item inline ha inline peering inline dst peer node1
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this cluster inline nodes inline array item inline ha inline peering inline dst peer node1 based on context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2 cluster inline nodes inline array item inline ha inline peering inline dst peer node2
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_peering_inline_dst_peer_node2
type ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2 struct {

	// The second failover destination peer node name.
	// Example: node-02
	Name *string `json:"name,omitempty"`

	// The second failover destination peer node UUID.
	// Example: 4ea7a442-86d1-11e0-ae1c-123478563412
	UUID *string `json:"uuid,omitempty"`
}

// Validate validates this cluster inline nodes inline array item inline ha inline peering inline dst peer node2
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this cluster inline nodes inline array item inline ha inline peering inline dst peer node2 based on context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3 cluster inline nodes inline array item inline ha inline peering inline dst peer node3
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_peering_inline_dst_peer_node3
type ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3 struct {

	// The third failover destination peer node name.
	// Example: node-03
	Name *string `json:"name,omitempty"`

	// The third failover destination peer node UUID.
	// Example: 4ea7a442-86d1-11e0-ae1c-123478563413
	UUID *string `json:"uuid,omitempty"`
}

// Validate validates this cluster inline nodes inline array item inline ha inline peering inline dst peer node3
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this cluster inline nodes inline array item inline ha inline peering inline dst peer node3 based on context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf This represents the storage takeover state of the node.
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_takeover_of
type ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf struct {

	// failure
	Failure *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure `json:"failure,omitempty"`

	// state
	// Example: failed
	// Enum: ["not_possible","not_attempted","taken_over","in_progress","failed"]
	State *string `json:"state,omitempty"`
}

// Validate validates this cluster inline nodes inline array item inline ha inline takeover of
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) validateFailure(formats strfmt.Registry) error {
	if swag.IsZero(m.Failure) { // not required
		return nil
	}
	...
	if m.Failure != nil {
		if err := m.Failure.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "takeover_of" + "." + "failure")
			}
			return err
		}
	}
...
var clusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["not_possible","not_attempted","taken_over","in_progress","failed"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		clusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum = append(clusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// cluster_inline_nodes_inline_array_item_inline_ha_inline_takeover_of
	// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf
	// state
	// State
	// not_possible
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateNotPossible captures enum value "not_possible"
	ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateNotPossible string = "not_possible"
	...
	// not_attempted
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateNotAttempted captures enum value "not_attempted"
	ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateNotAttempted string = "not_attempted"
	...
	// taken_over
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateTakenOver captures enum value "taken_over"
	ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateTakenOver string = "taken_over"
	...
	// in_progress
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateInProgress captures enum value "in_progress"
	ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateInProgress string = "in_progress"
	...
	// failed
	// END DEBUGGING
	// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateFailed captures enum value "failed"
	ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfStateFailed string = "failed"
)

// prop value enum
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, clusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) validateState(formats strfmt.Registry) error {
	if swag.IsZero(m.State) { // not required
		return nil
	}

	// value enum
	if err := m.validateStateEnum("ha"+"."+"takeover_of"+"."+"state", "body", *m.State); err != nil {
		return err
	}
...
// ContextValidate validate this cluster inline nodes inline array item inline ha inline takeover of based on the context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) contextValidateFailure(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOf
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure Indicates the failure code and message.
//
// swagger:model cluster_inline_nodes_inline_array_item_inline_ha_inline_takeover_of_inline_failure
type ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure struct {
	...
	// Detailed message based on the state.
	// Example: Failed to initiate takeover. Run the \"storage failover show\" command for more information.
	Message *string `json:"message,omitempty"`
}

// Validate validates this cluster inline nodes inline array item inline ha inline takeover of inline failure
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this cluster inline nodes inline array item inline ha inline takeover of inline failure based on the context it is used
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
// MarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) UnmarshalBinary(b []byte) error {
	var res ClusterInlineNodesInlineArrayItemInlineHaInlineTakeoverOfInlineFailure
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
