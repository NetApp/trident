...
// HostsSettingsResponse hosts settings response
//
// swagger:model hosts_settings_response
...
func (m *HostsSettingsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HostsSettingsResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this hosts settings response based on the context it is used
func (m *HostsSettingsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HostsSettingsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HostsSettingsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HostsSettingsResponse) UnmarshalBinary(b []byte) error {
	var res HostsSettingsResponse
