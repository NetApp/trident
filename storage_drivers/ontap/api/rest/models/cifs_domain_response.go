...
// CifsDomainResponse cifs domain response
//
// swagger:model cifs_domain_response
...
func (m *CifsDomainResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CifsDomainResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this cifs domain response based on the context it is used
func (m *CifsDomainResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CifsDomainResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CifsDomainResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CifsDomainResponse) UnmarshalBinary(b []byte) error {
	var res CifsDomainResponse
