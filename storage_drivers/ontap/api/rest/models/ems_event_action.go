...
type EmsEventAction struct {
	...
	//
	// Read Only: true
	EmsEventActionInlineRequestBodyTemplate any `json:"request_body_template,omitempty"`
...
type EmsEventActionInlineParametersInlineArrayItem struct {
	...
	// Read Only: true
	EmsEventActionInlineParametersInlineArrayItemInlineItems any `json:"items,omitempty"`
	...
	// Read Only: true
	EmsEventActionInlineParametersInlineArrayItemInlineProperties any `json:"properties,omitempty"`

	// Specifies the current value(s) for the parameter encoded in the appropriate JSON type.
	// Read Only: true
	EmsEventActionInlineParametersInlineArrayItemInlineValue any `json:"value,omitempty"`
