...
// Example: {"_links":{"metadata":{"href":"/api/storage/volumes/02178914-5f67-11eb-b987-005056ac5da5/files/dir_1%2ffile_1?return_metadata=true"}},"iops":{"error":{"lower_bound":2,"upper_bound":8},"read":2,"write":7},"junction-path":"/fv","path":"/vol/fv/dir_1/file_1","svm":{"name":"vserver_1","uuid":"42ee3002-67dd-11ea-8508-005056a7b8ac"},"throughput":{"error":{"lower_bound":24,"upper_bound":25},"read":24,"write":11},"total_ops":{"error":{"lower_bound":1400,"upper_bound":1450},"read":1400,"write":400},"total_throughput":{"error":{"lower_bound":2800,"upper_bound":2950},"read":2800,"write":600},"volume":{"name":"vol_6","uuid":"02178914-5f67-11eb-b987-005056ac5da5"}}
//
...
type TopMetricsSvmFile struct {
	...
	// total ops
	TotalOps *TopMetricsSvmFileInlineTotalOps `json:"total_ops,omitempty"`

	// total throughput
	TotalThroughput *TopMetricsSvmFileInlineTotalThroughput `json:"total_throughput,omitempty"`
...
func (m *TopMetricsSvmFile) validateTotalOps(formats strfmt.Registry) error {
...
func (m *TopMetricsSvmFile) validateTotalThroughput(formats strfmt.Registry) error {
...
func (m *TopMetricsSvmFile) contextValidateTotalOps(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmFile) contextValidateTotalThroughput(ctx context.Context, formats strfmt.Registry) error {
...
// TopMetricsSvmFileInlineTotalOps top metrics svm file inline total ops
//
// swagger:model top_metrics_svm_file_inline_total_ops
type TopMetricsSvmFileInlineTotalOps struct {
...
// Validate validates this top metrics svm file inline total ops
func (m *TopMetricsSvmFileInlineTotalOps) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmFileInlineTotalOps) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics svm file inline total ops based on the context it is used
func (m *TopMetricsSvmFileInlineTotalOps) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmFileInlineTotalOps) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmFileInlineTotalOps) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmFileInlineTotalOps) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsSvmFileInlineTotalOps) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsSvmFileInlineTotalOps) UnmarshalBinary(b []byte) error {
	var res TopMetricsSvmFileInlineTotalOps
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// TopMetricsSvmFileInlineTotalThroughput top metrics svm file inline total throughput
//
// swagger:model top_metrics_svm_file_inline_total_throughput
type TopMetricsSvmFileInlineTotalThroughput struct {
...
// Validate validates this top metrics svm file inline total throughput
func (m *TopMetricsSvmFileInlineTotalThroughput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmFileInlineTotalThroughput) validateError(formats strfmt.Registry) error {
	if swag.IsZero(m.Error) { // not required
		return nil
	}
...
// ContextValidate validate this top metrics svm file inline total throughput based on the context it is used
func (m *TopMetricsSvmFileInlineTotalThroughput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopMetricsSvmFileInlineTotalThroughput) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmFileInlineTotalThroughput) contextValidateRead(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsSvmFileInlineTotalThroughput) contextValidateWrite(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *TopMetricsSvmFileInlineTotalThroughput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *TopMetricsSvmFileInlineTotalThroughput) UnmarshalBinary(b []byte) error {
	var res TopMetricsSvmFileInlineTotalThroughput
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
