...
var lunTypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		lunTypeAccessModePropEnum = append(lunTypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// LunAccessModeGlobal captures enum value "global"
	LunAccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// LunAccessModeLocal captures enum value "local"
	LunAccessModeLocal string = "local"
)

// prop value enum
func (m *Lun) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, lunTypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Lun) validateAccessMode(formats strfmt.Registry) error {
...
func (m *LunInlineClone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {
