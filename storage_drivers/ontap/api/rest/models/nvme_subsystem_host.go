...
func (m *NvmeSubsystemHostInlineDhHmacChap) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateControllerSecretKey(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateHostSecretKey(formats); err != nil {
		res = append(res, err)
	}
...
func (m *NvmeSubsystemHostInlineDhHmacChap) validateControllerSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(m.ControllerSecretKey) { // not required
		return nil
	}

	if err := validate.FormatOf("dh_hmac_chap"+"."+"controller_secret_key", "body", "password", m.ControllerSecretKey.String(), formats); err != nil {
		return err
	}
...
func (m *NvmeSubsystemHostInlineDhHmacChap) validateHostSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(m.HostSecretKey) { // not required
		return nil
	}

	if err := validate.FormatOf("dh_hmac_chap"+"."+"host_secret_key", "body", "password", m.HostSecretKey.String(), formats); err != nil {
		return err
	}
...
func (m *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineDhHmacChap) validateControllerSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(m.ControllerSecretKey) { // not required
		return nil
	}
...
func (m *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineDhHmacChap) validateHostSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(m.HostSecretKey) { // not required
		return nil
	}
...
func (m *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineTLS) validateConfiguredPsk(formats strfmt.Registry) error {
	if swag.IsZero(m.ConfiguredPsk) { // not required
		return nil
	}

	if err := validate.FormatOf("tls"+"."+"configured_psk", "body", "password", m.ConfiguredPsk.String(), formats); err != nil {
		return err
	}
...
func (m *NvmeSubsystemHostInlineTLS) validateConfiguredPsk(formats strfmt.Registry) error {
	if swag.IsZero(m.ConfiguredPsk) { // not required
		return nil
	}
