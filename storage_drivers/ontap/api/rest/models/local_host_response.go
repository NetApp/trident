...
// LocalHostResponse local host response
//
// swagger:model local_host_response
...
func (m *LocalHostResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LocalHostResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this local host response based on the context it is used
func (m *LocalHostResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LocalHostResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LocalHostResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LocalHostResponse) UnmarshalBinary(b []byte) error {
	var res LocalHostResponse
