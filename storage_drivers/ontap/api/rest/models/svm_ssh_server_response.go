...
// SvmSSHServerResponse svm ssh server response
//
// swagger:model svm_ssh_server_response
...
func (m *SvmSSHServerResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SvmSSHServerResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this svm ssh server response based on the context it is used
func (m *SvmSSHServerResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SvmSSHServerResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SvmSSHServerResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SvmSSHServerResponse) UnmarshalBinary(b []byte) error {
	var res SvmSSHServerResponse
