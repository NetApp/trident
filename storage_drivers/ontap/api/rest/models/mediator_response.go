...
type MediatorResponseInlineRecordsInlineArrayItem struct {
	...
	// NetApp Console account token. This field is only applicable to the ONTAP cloud mediator.
	AccountToken *string `json:"account_token,omitempty"`

	// BlueXP account token. This field is only applicable to the ONTAP cloud mediator. This has been replaced by account_token. Support for this field will be removed in a future release.
	BluexpAccountToken *string `json:"bluexp_account_token,omitempty"`

	// BlueXP organization ID. This field is only applicable to the ONTAP cloud mediator. This has been replaced by org_id. Support for this field will be removed in a future release.
	...
	// Connection type from ONTAP MetroCluster to mediator. Applicable only to on-prem mediator used in ONTAP MetroCluster configurations.
	...
	// NetApp Console organization ID. This field is only applicable to the ONTAP cloud mediator.
	...
	// Client ID of the NetApp Console service account. This field is only applicable to the ONTAP cloud mediator.
	ServiceAccountClientID *string `json:"service_account_client_id,omitempty"`

	// Client secret token of the NetApp Console service account. This field is only applicable to the ONTAP cloud mediator.
...
var mediatorResponseInlineRecordsInlineArrayItemTypeConnectionTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["iscsi_mediator","https_mediator"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		mediatorResponseInlineRecordsInlineArrayItemTypeConnectionTypePropEnum = append(mediatorResponseInlineRecordsInlineArrayItemTypeConnectionTypePropEnum, v)
	}
}
...
const (
	...
	// iscsi_mediator
	// END DEBUGGING
	// MediatorResponseInlineRecordsInlineArrayItemConnectionTypeIscsiMediator captures enum value "iscsi_mediator"
	MediatorResponseInlineRecordsInlineArrayItemConnectionTypeIscsiMediator string = "iscsi_mediator"
	...
	// https_mediator
	// END DEBUGGING
	// MediatorResponseInlineRecordsInlineArrayItemConnectionTypeHTTPSMediator captures enum value "https_mediator"
	MediatorResponseInlineRecordsInlineArrayItemConnectionTypeHTTPSMediator string = "https_mediator"
)

// prop value enum
func (m *MediatorResponseInlineRecordsInlineArrayItem) validateConnectionTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, mediatorResponseInlineRecordsInlineArrayItemTypeConnectionTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *MediatorResponseInlineRecordsInlineArrayItem) validateConnectionType(formats strfmt.Registry) error {
...
// prop value enum
func (m *MediatorResponseInlineRecordsInlineArrayItem) validateTypeEnum(path, location string, value string) error {
...
func (m *MediatorResponseInlineRecordsInlineArrayItem) validateType(formats strfmt.Registry) error {
...
func (m *MediatorResponseInlineRecordsInlineArrayItem) contextValidateLocalMediatorConnectivity(ctx context.Context, formats strfmt.Registry) error {
