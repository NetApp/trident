...
type S3BucketSvm struct {
	...
	// snapshot restore
	SnapshotRestore *S3BucketSvmInlineSnapshotRestore `json:"snapshot_restore,omitempty"`
...
func (m *S3BucketSvm) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSnapshotRestore(formats); err != nil {
		res = append(res, err)
	}
...
func (m *S3BucketSvm) validateSnapshotRestore(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapshotRestore) { // not required
		return nil
	}

	if m.SnapshotRestore != nil {
		if err := m.SnapshotRestore.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_restore")
			}
			return err
		}
	}
...
func (m *S3BucketSvm) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSnapshotRestore(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *S3BucketSvm) contextValidateSnapshotRestore(ctx context.Context, formats strfmt.Registry) error {

	if m.SnapshotRestore != nil {
		if err := m.SnapshotRestore.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("snapshot_restore")
			}
			return err
...
func (m *S3BucketSvmInlineSnapshotRestore) Validate(formats strfmt.Registry) error {
	var res []error
...
// prop value enum
func (m *S3BucketSvmInlineSnapshotRestore) validateStateEnum(path, location string, value string) error {
...
func (m *S3BucketSvmInlineSnapshotRestore) validateState(formats strfmt.Registry) error {
	if swag.IsZero(m.State) { // not required
		return nil
	}

	// value enum
	if err := m.validateStateEnum("snapshot_restore"+"."+"state", "body", *m.State); err != nil {
		return err
	}
...
func (m *S3BucketSvmInlineSnapshotRestore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *S3BucketSvmInlineSnapshotRestore) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *S3BucketSvmInlineSnapshotRestore) UnmarshalBinary(b []byte) error {
