...
// LdapServiceResponse ldap service response
//
// swagger:model ldap_service_response
...
func (m *LdapServiceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LdapServiceResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this ldap service response based on the context it is used
func (m *LdapServiceResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LdapServiceResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LdapServiceResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LdapServiceResponse) UnmarshalBinary(b []byte) error {
	var res LdapServiceResponse
