...
// SnaplockLogResponse snaplock log response
//
// swagger:model snaplock_log_response
...
func (m *SnaplockLogResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SnaplockLogResponse) validateLinks(formats strfmt.Registry) error {
...
// ContextValidate validate this snaplock log response based on the context it is used
func (m *SnaplockLogResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SnaplockLogResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnaplockLogResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SnaplockLogResponse) UnmarshalBinary(b []byte) error {
	var res SnaplockLogResponse
