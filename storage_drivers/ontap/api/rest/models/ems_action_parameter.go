...
type EmsActionParameter struct {
	...
	// Read Only: true
	EmsActionParameterInlineItems any `json:"items,omitempty"`
	...
	// Read Only: true
	EmsActionParameterInlineProperties any `json:"properties,omitempty"`

	// Specifies the current value(s) for the parameter encoded in the appropriate JSON type.
	// Read Only: true
	EmsActionParameterInlineValue any `json:"value,omitempty"`
