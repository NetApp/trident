...
func (o *SecurityKeystoreModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 65539857 | During the keystore switch operation, a restore operation failed. |
| 65539858 | During the key migration operation, a restore operation failed. |
| 65539859 | During the key migration operation, a restore operation failed. |
...
type SecurityKeystoreModifyCollectionBody struct {
	...
	// Indicates whether the keystore is SVM-KEK based.
	// Read Only: true
	IsSvmKek *bool `json:"is_svm_kek,omitempty"`
...
func (o *SecurityKeystoreModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateIsSvmKek(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *SecurityKeystoreModifyCollectionBody) contextValidateIsSvmKek(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"is_svm_kek", "body", o.IsSvmKek); err != nil {
		return err
	}
