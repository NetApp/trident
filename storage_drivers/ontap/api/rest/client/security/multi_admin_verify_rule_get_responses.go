...
func (o *MultiAdminVerifyRuleGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the multi admin verify rule get o k response
func (o *MultiAdminVerifyRuleGetOK) Code() int {
	return 200
}

func (o *MultiAdminVerifyRuleGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/multi-admin-verify/rules/{owner.uuid}/{operation}][%d] multiAdminVerifyRuleGetOK %s", 200, payload)
}
...
func (o *MultiAdminVerifyRuleGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/multi-admin-verify/rules/{owner.uuid}/{operation}][%d] multi_admin_verify_rule_get default %s", o._statusCode, payload)
}
