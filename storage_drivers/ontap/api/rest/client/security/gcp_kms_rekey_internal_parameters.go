...
// WithGcpKmsUUIDPathParameter adds the gcpKmsUUID to the gcp kms rekey internal params
func (o *GcpKmsRekeyInternalParams) WithGcpKmsUUIDPathParameter(gcpKmsUUID string) *GcpKmsRekeyInternalParams {
	o.SetGcpKmsUUIDPathParameter(gcpKmsUUID)
	return o
}

// SetGcpKmsUUIDPathParameter adds the gcpKmsUuid to the gcp kms rekey internal params
func (o *GcpKmsRekeyInternalParams) SetGcpKmsUUIDPathParameter(gcpKmsUUID string) {
