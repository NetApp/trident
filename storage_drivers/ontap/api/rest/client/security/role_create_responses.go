...
func (o *RoleCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 5636210 | User creation failed because LDAP is not configured for the SVM or the LDAP connection is not secure.<personalities supports=aiml,unified> |
