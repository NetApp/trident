...
func (o *SecurityKeyManagerDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 65540011 | Encrypted volumes are found for the cluster. |
| 65540013 | Encrypted volumes are found on the admin Vserver. |
