...
func (o *SecurityKeyManagerRestoreReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SecurityKeyManagerRestoreCreated) GetPayload() *models.SecurityKeyManagerJobLinkResponse {
	return o.Payload
}
...
func (o *SecurityKeyManagerRestoreAccepted) GetPayload() *models.SecurityKeyManagerJobLinkResponse {
	return o.Payload
}
