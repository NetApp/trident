...
func (o *AzureKeyVaultRekeyExternalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 65539855 | During the rekey external operation, a restore operation failed. |
