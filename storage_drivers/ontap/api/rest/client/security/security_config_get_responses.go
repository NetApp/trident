...
func (o *SecurityConfigGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the security config get o k response
func (o *SecurityConfigGetOK) Code() int {
	return 200
}

func (o *SecurityConfigGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security][%d] securityConfigGetOK %s", 200, payload)
}
...
func (o *SecurityConfigGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security][%d] security_config_get default %s", o._statusCode, payload)
}
