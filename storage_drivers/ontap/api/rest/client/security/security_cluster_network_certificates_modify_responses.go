...
func (o *SecurityClusterNetworkCertificatesModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SecurityClusterNetworkCertificatesModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /security/cluster-network/certificates/{node.uuid}][%d] securityClusterNetworkCertificatesModifyOK", 200)
}
...
func (o *SecurityClusterNetworkCertificatesModifyDefault) Error() string {
	...
	return fmt.Sprintf("[PATCH /security/cluster-network/certificates/{node.uuid}][%d] security_cluster_network_certificates_modify default %s", o._statusCode, payload)
}
