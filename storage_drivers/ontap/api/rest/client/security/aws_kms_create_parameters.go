...
// WithReturnTimeout adds the returnTimeout to the aws kms create params
func (o *AwsKmsCreateParams) WithReturnTimeout(returnTimeout *int64) *AwsKmsCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the aws kms create params
func (o *AwsKmsCreateParams) SetReturnTimeout(returnTimeout *int64) {
