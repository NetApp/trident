...
// WithReturnTimeout adds the returnTimeout to the azure key vault delete params
func (o *AzureKeyVaultDeleteParams) WithReturnTimeout(returnTimeout *int64) *AzureKeyVaultDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the azure key vault delete params
func (o *AzureKeyVaultDeleteParams) SetReturnTimeout(returnTimeout *int64) {
