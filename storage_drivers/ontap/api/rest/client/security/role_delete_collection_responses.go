...
func (o *RoleDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 5636249 | Failed to delete the role because it is part of the external-role-mapping configuration.<personalities supports=aiml,unified> |
