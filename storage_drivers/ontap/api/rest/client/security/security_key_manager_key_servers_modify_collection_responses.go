...
func (o *SecurityKeyManagerKeyServersModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 65537002 | Modifying key server port requires an effective cluster version of ONTAP 9.18.1 or later. |
...
func (o *SecurityKeyManagerKeyServersModifyCollectionBody) validatePort(formats strfmt.Registry) error {
...
func (o *KeyServerInlineRecordsInlineArrayItem) validatePort(formats strfmt.Registry) error {
	if swag.IsZero(o.Port) { // not required
		return nil
	}

	if err := validate.MinimumInt("port", "body", *o.Port, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("port", "body", *o.Port, 65535, false); err != nil {
		return err
	}
