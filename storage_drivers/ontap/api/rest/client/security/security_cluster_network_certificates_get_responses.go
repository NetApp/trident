...
func (o *SecurityClusterNetworkCertificatesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SecurityClusterNetworkCertificatesGetOK) Error() string {
	...
	return fmt.Sprintf("[GET /security/cluster-network/certificates/{node.uuid}][%d] securityClusterNetworkCertificatesGetOK %s", 200, payload)
}
...
func (o *SecurityClusterNetworkCertificatesGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/cluster-network/certificates/{node.uuid}][%d] security_cluster_network_certificates_get default %s", o._statusCode, payload)
}
