...
func (o *MultiAdminVerifyApprovalGroupGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the multi admin verify approval group get o k response
func (o *MultiAdminVerifyApprovalGroupGetOK) Code() int {
	return 200
}

func (o *MultiAdminVerifyApprovalGroupGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/multi-admin-verify/approval-groups/{owner.uuid}/{name}][%d] multiAdminVerifyApprovalGroupGetOK %s", 200, payload)
}
...
func (o *MultiAdminVerifyApprovalGroupGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/multi-admin-verify/approval-groups/{owner.uuid}/{name}][%d] multi_admin_verify_approval_group_get default %s", o._statusCode, payload)
}
