...
// WithReturnRecords adds the returnRecords to the cluster ldap modify params
func (o *ClusterLdapModifyParams) WithReturnRecords(returnRecords *bool) *ClusterLdapModifyParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cluster ldap modify params
func (o *ClusterLdapModifyParams) SetReturnRecords(returnRecords *bool) {
