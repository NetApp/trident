...
func (o *AzureKeyVaultGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the azure key vault get o k response
func (o *AzureKeyVaultGetOK) Code() int {
	return 200
}
