...
func (o *AzureKeyVaultRekeyInternalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type AzureKeyVaultRekeyInternalCreated struct {
	Payload *models.AzureKeyVaultKeyJobLinkResponse
}
...
func (o *AzureKeyVaultRekeyInternalCreated) GetPayload() *models.AzureKeyVaultKeyJobLinkResponse {
	return o.Payload
}
...
func (o *AzureKeyVaultRekeyInternalCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.AzureKeyVaultKeyJobLinkResponse)
...
func (o *AzureKeyVaultRekeyInternalAccepted) GetPayload() *models.AzureKeyVaultKeyJobLinkResponse {
	return o.Payload
}
...
| 65539856 | During the rekey internal operation, a restore operation failed. |
