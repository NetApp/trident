...
func (o *SecurityClusterNetworkCertificatesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SecurityClusterNetworkCertificatesDeleteOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /security/cluster-network/certificates/{node.uuid}][%d] securityClusterNetworkCertificatesDeleteOK %s", 200, payload)
}
...
func (o *SecurityClusterNetworkCertificatesDeleteDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /security/cluster-network/certificates/{node.uuid}][%d] security_cluster_network_certificates_delete default %s", o._statusCode, payload)
}
