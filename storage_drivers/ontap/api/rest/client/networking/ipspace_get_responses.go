...
func (o *IpspaceGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpspaceGetOK) Error() string {
	...
	return fmt.Sprintf("[GET /network/ipspaces/{uuid}][%d] ipspaceGetOK %s", 200, payload)
}
...
func (o *IpspaceGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /network/ipspaces/{uuid}][%d] ipspace_get default %s", o._statusCode, payload)
}
