...
func (o *FcPortModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type FcPortModifyCollectionBody struct {
	...
	// topology
	Topology *models.FcPortInlineTopology `json:"topology,omitempty"`
...
func (o *FcPortModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateTopology(formats); err != nil {
		res = append(res, err)
	}
...
func (o *FcPortModifyCollectionBody) validateTopology(formats strfmt.Registry) error {
	if swag.IsZero(o.Topology) { // not required
		return nil
	}

	if o.Topology != nil {
		if err := o.Topology.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "topology")
			}
			return err
		}
	}
...
func (o *FcPortModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateTopology(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *FcPortModifyCollectionBody) contextValidateTopology(ctx context.Context, formats strfmt.Registry) error {

	if o.Topology != nil {
		if err := o.Topology.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "topology")
			}
			return err
...
/*
FcPortInlineTopology Properties of the topology of the FC port.
//
swagger:model fc_port_inline_topology
*/
type FcPortInlineTopology struct {

	// The configured topology of the FC port.
	//
	// Example: fabric
	// Enum: ["direct","fabric"]
	Configured *string `json:"configured,omitempty"`

	// The supported topologies of the FC port.
	//
	// Read Only: true
	Supported []*string `json:"supported,omitempty"`
}

// Validate validates this fc port inline topology
func (o *FcPortInlineTopology) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := o.validateSupported(formats); err != nil {
		res = append(res, err)
	}
...
var fcPortInlineTopologyTypeConfiguredPropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["direct","fabric"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		fcPortInlineTopologyTypeConfiguredPropEnum = append(fcPortInlineTopologyTypeConfiguredPropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// fc_port_inline_topology
	// FcPortInlineTopology
	// configured
	// Configured
	// direct
	// END DEBUGGING
	// FcPortInlineTopologyConfiguredDirect captures enum value "direct"
	FcPortInlineTopologyConfiguredDirect string = "direct"
	...
	// fabric
	// END DEBUGGING
	// FcPortInlineTopologyConfiguredFabric captures enum value "fabric"
	FcPortInlineTopologyConfiguredFabric string = "fabric"
)

// prop value enum
func (o *FcPortInlineTopology) validateConfiguredEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, fcPortInlineTopologyTypeConfiguredPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *FcPortInlineTopology) validateConfigured(formats strfmt.Registry) error {
	if swag.IsZero(o.Configured) { // not required
		return nil
	}

	// value enum
	if err := o.validateConfiguredEnum("info"+"."+"topology"+"."+"configured", "body", *o.Configured); err != nil {
		return err
	}
...
var fcPortInlineTopologySupportedItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		fcPortInlineTopologySupportedItemsEnum = append(fcPortInlineTopologySupportedItemsEnum, v)
	}
}

func (o *FcPortInlineTopology) validateSupportedItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, fcPortInlineTopologySupportedItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *FcPortInlineTopology) validateSupported(formats strfmt.Registry) error {
	if swag.IsZero(o.Supported) { // not required
		return nil
	}

	for i := 0; i < len(o.Supported); i++ {
		if swag.IsZero(o.Supported[i]) { // not required
			continue
		}

		// value enum
		if err := o.validateSupportedItemsEnum("info"+"."+"topology"+"."+"supported"+"."+strconv.Itoa(i), "body", *o.Supported[i]); err != nil {
			return err
		}
...
// ContextValidate validate this fc port inline topology based on the context it is used
func (o *FcPortInlineTopology) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *FcPortInlineTopology) contextValidateSupported(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"topology"+"."+"supported", "body", []*string(o.Supported)); err != nil {
		return err
	}

	for i := 0; i < len(o.Supported); i++ {

		if err := validate.ReadOnly(ctx, "info"+"."+"topology"+"."+"supported"+"."+strconv.Itoa(i), "body", o.Supported[i]); err != nil {
			return err
		}
...
// MarshalBinary interface implementation
func (o *FcPortInlineTopology) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *FcPortInlineTopology) UnmarshalBinary(b []byte) error {
	var res FcPortInlineTopology
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
