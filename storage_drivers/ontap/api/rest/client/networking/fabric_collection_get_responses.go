...
func (o *FabricCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *FabricCollectionGetOK) Error() string {
	...
	return fmt.Sprintf("[GET /network/fc/fabrics][%d] fabricCollectionGetOK %s", 200, payload)
}
...
func (o *FabricCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /network/fc/fabrics][%d] fabric_collection_get default %s", o._statusCode, payload)
}
