...
// NewConsistencyGroupCreateParams creates a new ConsistencyGroupCreateParams object,
...
func NewConsistencyGroupCreateParams() *ConsistencyGroupCreateParams {
	return &ConsistencyGroupCreateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewConsistencyGroupCreateParamsWithTimeout creates a new ConsistencyGroupCreateParams object
...
// NewConsistencyGroupCreateParamsWithContext creates a new ConsistencyGroupCreateParams object
...
// NewConsistencyGroupCreateParamsWithHTTPClient creates a new ConsistencyGroupCreateParams object
...
func (o *ConsistencyGroupCreateParams) WithDefaults() *ConsistencyGroupCreateParams {
	o.SetDefaults()
	return o
}
...
func (o *ConsistencyGroupCreateParams) SetDefaults() {
	...
	val := ConsistencyGroupCreateParams{
...
func (o *ConsistencyGroupCreateParams) WithTimeout(timeout time.Duration) *ConsistencyGroupCreateParams {
...
func (o *ConsistencyGroupCreateParams) WithContext(ctx context.Context) *ConsistencyGroupCreateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ConsistencyGroupCreateParams) WithHTTPClient(client *http.Client) *ConsistencyGroupCreateParams {
...
func (o *ConsistencyGroupCreateParams) WithInfo(info *models.ConsistencyGroup) *ConsistencyGroupCreateParams {
	o.SetInfo(info)
	return o
}

// SetInfo adds the info to the consistency group create params
func (o *ConsistencyGroupCreateParams) SetInfo(info *models.ConsistencyGroup) {
	o.Info = info
}
...
func (o *ConsistencyGroupCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
