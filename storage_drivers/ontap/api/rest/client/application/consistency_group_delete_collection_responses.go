...
func (o *ConsistencyGroupDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
var consistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		consistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum = append(consistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0AccessModeGlobal captures enum value "global"
	ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0AccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0AccessModeLocal captures enum value "local"
	ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0AccessModeLocal string = "local"
)

// prop value enum
func (o *ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, consistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0TypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0) validateAccessMode(formats strfmt.Registry) error {
	if swag.IsZero(o.AccessMode) { // not required
		return nil
	}

	// value enum
	if err := o.validateAccessModeEnum("access_mode", "body", *o.AccessMode); err != nil {
		return err
	}
...
func (o *ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0LunsItems0Clone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "clone"+"."+"created_as_clone", "body", o.CreatedAsClone); err != nil {
		return err
	}
...
var consistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0TypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		consistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0TypeAccessModePropEnum = append(consistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0TypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0AccessModeGlobal captures enum value "global"
	ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0AccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0AccessModeLocal captures enum value "local"
	ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0AccessModeLocal string = "local"
)

// prop value enum
func (o *ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, consistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0TypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0) validateAccessMode(formats strfmt.Registry) error {
	if swag.IsZero(o.AccessMode) { // not required
		return nil
	}
...
func (o *ConsistencyGroupDeleteCollectionParamsBodyRecordsItems0LunsItems0Clone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {
