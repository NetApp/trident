...
func (o *ConsistencyGroupCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 53412087 | Consistency group cannot be created because the SVM is part of a SnapMirror active sync NAS relationship. |
