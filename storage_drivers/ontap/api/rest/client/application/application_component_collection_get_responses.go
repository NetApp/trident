...
func (o *ApplicationComponentCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ApplicationComponentCollectionGetOK) Code() int {
	return 200
}

func (o *ApplicationComponentCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /application/applications/{application.uuid}/components][%d] applicationComponentCollectionGetOK %s", 200, payload)
}
...
func (o *ApplicationComponentCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /application/applications/{application.uuid}/components][%d] application_component_collection_get default %s", o._statusCode, payload)
}
