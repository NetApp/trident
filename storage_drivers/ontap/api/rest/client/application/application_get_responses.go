...
func (o *ApplicationGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ApplicationGetOK) Error() string {
	...
	return fmt.Sprintf("[GET /application/applications/{uuid}][%d] applicationGetOK %s", 200, payload)
}
...
func (o *ApplicationGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /application/applications/{uuid}][%d] application_get default %s", o._statusCode, payload)
}
