...
func (o *S3BucketModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type S3BucketModifyCollectionBody struct {
	...
	// snapshot restore
	SnapshotRestore *models.S3BucketInlineSnapshotRestore `json:"snapshot_restore,omitempty"`
...
func (o *S3BucketModifyCollectionBody) validateSnapshotRestore(formats strfmt.Registry) error {
...
func (o *S3BucketModifyCollectionBody) contextValidateSnapshotRestore(ctx context.Context, formats strfmt.Registry) error {
...
/*
S3BucketInlineSnapshotRestore Specifies information regarding a snapshot restore operation on the bucket
swagger:model s3_bucket_inline_snapshot_restore
*/
type S3BucketInlineSnapshotRestore struct {
...
// Validate validates this s3 bucket inline snapshot restore
func (o *S3BucketInlineSnapshotRestore) Validate(formats strfmt.Registry) error {
	var res []error
...
var s3BucketInlineSnapshotRestoreTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		s3BucketInlineSnapshotRestoreTypeStatePropEnum = append(s3BucketInlineSnapshotRestoreTypeStatePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// s3_bucket_inline_snapshot_restore
	// S3BucketInlineSnapshotRestore
	// state
	// State
	// none
	// END DEBUGGING
	// S3BucketInlineSnapshotRestoreStateNone captures enum value "none"
	S3BucketInlineSnapshotRestoreStateNone string = "none"
	...
	// preparing
	// END DEBUGGING
	// S3BucketInlineSnapshotRestoreStatePreparing captures enum value "preparing"
	S3BucketInlineSnapshotRestoreStatePreparing string = "preparing"
	...
	// restoring
	// END DEBUGGING
	// S3BucketInlineSnapshotRestoreStateRestoring captures enum value "restoring"
	S3BucketInlineSnapshotRestoreStateRestoring string = "restoring"
	...
	// done
	// END DEBUGGING
	// S3BucketInlineSnapshotRestoreStateDone captures enum value "done"
	S3BucketInlineSnapshotRestoreStateDone string = "done"
)

// prop value enum
func (o *S3BucketInlineSnapshotRestore) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, s3BucketInlineSnapshotRestoreTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *S3BucketInlineSnapshotRestore) validateState(formats strfmt.Registry) error {
...
// ContextValidate validates this s3 bucket inline snapshot restore based on context it is used
func (o *S3BucketInlineSnapshotRestore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *S3BucketInlineSnapshotRestore) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *S3BucketInlineSnapshotRestore) UnmarshalBinary(b []byte) error {
	var res S3BucketInlineSnapshotRestore
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
