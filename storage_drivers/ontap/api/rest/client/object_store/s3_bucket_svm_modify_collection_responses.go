...
func (o *S3BucketSvmModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 92406158   | "The specified \"If-Match\" parameter is invalid. When created with a null operator, there must be only one item in the \"If-Match\" list, with a value of either \"true\" or \"false\".";
| 92406417   | "Conditions do not apply to the combination of actions and resources in the statement.";
*/
...
type S3BucketSvmModifyCollectionBody struct {
	...
	// snapshot restore
	SnapshotRestore *models.S3BucketSvmInlineSnapshotRestore `json:"snapshot_restore,omitempty"`
...
func (o *S3BucketSvmModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateSnapshotRestore(formats); err != nil {
		res = append(res, err)
	}
...
func (o *S3BucketSvmModifyCollectionBody) validateSnapshotRestore(formats strfmt.Registry) error {
	if swag.IsZero(o.SnapshotRestore) { // not required
		return nil
	}

	if o.SnapshotRestore != nil {
		if err := o.SnapshotRestore.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "snapshot_restore")
			}
			return err
		}
	}
...
func (o *S3BucketSvmModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateSnapshotRestore(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *S3BucketSvmModifyCollectionBody) contextValidateSnapshotRestore(ctx context.Context, formats strfmt.Registry) error {

	if o.SnapshotRestore != nil {
		if err := o.SnapshotRestore.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "snapshot_restore")
			}
			return err
...
/*
S3BucketSvmInlineSnapshotRestore Specifies information regarding a snapshot restore operation on the bucket
swagger:model s3_bucket_svm_inline_snapshot_restore
*/
type S3BucketSvmInlineSnapshotRestore struct {

	// Remaining objects to be restored for the bucket
	ObjectsRemaining *int64 `json:"objects_remaining,omitempty"`
	...
	// Enum: ["none","preparing","restoring","done"]
	State *string `json:"state,omitempty"`
}

// Validate validates this s3 bucket svm inline snapshot restore
func (o *S3BucketSvmInlineSnapshotRestore) Validate(formats strfmt.Registry) error {
	var res []error
...
var s3BucketSvmInlineSnapshotRestoreTypeStatePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["none","preparing","restoring","done"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		s3BucketSvmInlineSnapshotRestoreTypeStatePropEnum = append(s3BucketSvmInlineSnapshotRestoreTypeStatePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// s3_bucket_svm_inline_snapshot_restore
	// S3BucketSvmInlineSnapshotRestore
	// state
	// State
	// none
	// END DEBUGGING
	// S3BucketSvmInlineSnapshotRestoreStateNone captures enum value "none"
	S3BucketSvmInlineSnapshotRestoreStateNone string = "none"
	...
	// preparing
	// END DEBUGGING
	// S3BucketSvmInlineSnapshotRestoreStatePreparing captures enum value "preparing"
	S3BucketSvmInlineSnapshotRestoreStatePreparing string = "preparing"
	...
	// restoring
	// END DEBUGGING
	// S3BucketSvmInlineSnapshotRestoreStateRestoring captures enum value "restoring"
	S3BucketSvmInlineSnapshotRestoreStateRestoring string = "restoring"
	...
	// done
	// END DEBUGGING
	// S3BucketSvmInlineSnapshotRestoreStateDone captures enum value "done"
	S3BucketSvmInlineSnapshotRestoreStateDone string = "done"
)

// prop value enum
func (o *S3BucketSvmInlineSnapshotRestore) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, s3BucketSvmInlineSnapshotRestoreTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *S3BucketSvmInlineSnapshotRestore) validateState(formats strfmt.Registry) error {
	if swag.IsZero(o.State) { // not required
		return nil
	}

	// value enum
	if err := o.validateStateEnum("info"+"."+"snapshot_restore"+"."+"state", "body", *o.State); err != nil {
		return err
	}
...
// ContextValidate validates this s3 bucket svm inline snapshot restore based on context it is used
func (o *S3BucketSvmInlineSnapshotRestore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *S3BucketSvmInlineSnapshotRestore) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *S3BucketSvmInlineSnapshotRestore) UnmarshalBinary(b []byte) error {
	var res S3BucketSvmInlineSnapshotRestore
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
