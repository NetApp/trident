...
func (o *S3UserGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *S3UserGetOK) Error() string {
	...
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/users/{name}][%d] s3UserGetOK %s", 200, payload)
}
...
func (o *S3UserGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/users/{name}][%d] s3_user_get default %s", o._statusCode, payload)
}
