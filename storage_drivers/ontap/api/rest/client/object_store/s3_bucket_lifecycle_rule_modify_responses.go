...
func (o *S3BucketLifecycleRuleModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *S3BucketLifecycleRuleModifyAccepted) GetPayload() *models.S3BucketLifecycleRuleJobLinkResponse {
	return o.Payload
}
