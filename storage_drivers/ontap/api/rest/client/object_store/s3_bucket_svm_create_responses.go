...
func (o *S3BucketSvmCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *S3BucketSvmCreateCreated) GetPayload() *models.S3BucketSvmJobLinkResponse {
	return o.Payload
}
...
func (o *S3BucketSvmCreateAccepted) GetPayload() *models.S3BucketSvmJobLinkResponse {
	return o.Payload
}
