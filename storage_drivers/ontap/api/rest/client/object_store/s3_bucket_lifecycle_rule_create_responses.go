...
func (o *S3BucketLifecycleRuleCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *S3BucketLifecycleRuleCreateAccepted) GetPayload() *models.S3BucketLifecycleRuleJobLinkResponse {
	return o.Payload
}
