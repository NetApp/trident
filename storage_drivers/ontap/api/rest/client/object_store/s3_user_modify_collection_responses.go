...
func (o *S3UserModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 92406108   | The \"key_id\" field must be used with either the \"regenerate_keys\" or \"delete_keys\" operation.
...
type S3UserModifyCollectionBody struct {
	...
	// Read Only: true
	S3UserInlineKeys []*models.S3UserInlineKeysInlineArrayItem `json:"keys,omitempty"`
...
func (o *S3UserModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateS3UserInlineKeys(formats); err != nil {
		res = append(res, err)
	}
...
func (o *S3UserModifyCollectionBody) validateKeyID(formats strfmt.Registry) error {
	if swag.IsZero(o.KeyID) { // not required
		return nil
	}

	if err := validate.MinimumInt("info"+"."+"key_id", "body", *o.KeyID, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("info"+"."+"key_id", "body", *o.KeyID, 2, false); err != nil {
		return err
	}
...
func (o *S3UserModifyCollectionBody) validateS3UserInlineKeys(formats strfmt.Registry) error {
	if swag.IsZero(o.S3UserInlineKeys) { // not required
		return nil
	}

	for i := 0; i < len(o.S3UserInlineKeys); i++ {
		if swag.IsZero(o.S3UserInlineKeys[i]) { // not required
			continue
		}

		if o.S3UserInlineKeys[i] != nil {
			if err := o.S3UserInlineKeys[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("info" + "." + "keys" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *S3UserModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateS3UserInlineKeys(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *S3UserModifyCollectionBody) contextValidateS3UserInlineKeys(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"keys", "body", []*models.S3UserInlineKeysInlineArrayItem(o.S3UserInlineKeys)); err != nil {
		return err
	}
	...
	for i := 0; i < len(o.S3UserInlineKeys); i++ {
		...
		if o.S3UserInlineKeys[i] != nil {
			if err := o.S3UserInlineKeys[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("info" + "." + "keys" + "." + strconv.Itoa(i))
				}
				return err
...
func (o *S3UserInlineKeysInlineArrayItem) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *S3UserInlineKeysInlineArrayItem) validateExpiryTime(formats strfmt.Registry) error {
...
func (o *S3UserInlineKeysInlineArrayItem) validateID(formats strfmt.Registry) error {
	if swag.IsZero(o.ID) { // not required
		return nil
	}

	if err := validate.MinimumInt("id", "body", *o.ID, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("id", "body", *o.ID, 2, false); err != nil {
		return err
	}
...
func (o *S3UserInlineKeysInlineArrayItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *S3UserInlineKeysInlineArrayItem) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *S3UserInlineKeysInlineArrayItem) UnmarshalBinary(b []byte) error {
