...
func (o *FlexcacheModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 66847145   | Failed to modify the relative-size-percentage property of FlexCache volume because the relative-size-percentage property is not valid |
| 66847146   | Failed to modify the relative-size-percentage property of FlexCache volume because the relative-size-enabled property is false |
...
| 66847143   | Failed to modify the atime-scrub-period property of FlexCache volume because the atime-scrub-period property is not valid |
...
| 66846720   | Write Absorption mode modify requires an effective cluster version of ONTAP 9.19.1 or later. |
| 66846720   | Mtime Scrubber enabled modify requires an effective cluster version of ONTAP 9.19.1 or later. |
| 66846720   | Mtime Scrubber threshold modify requires an effective cluster version of ONTAP 9.19.1 or later. |
| 66847149   | Failed to modify the mtime-scrubber-threshold property because the value is outside the valid range. Range is 5 to 2592000 seconds (5 seconds to 30 days).|
| 66847150   | Failed to modify the -mtime-scrubber-enabled property because -is-writeback-enabled property is false. |
| 66847151   | Failed to modify the -mtime-scrubber-threshold property because -is-writeback-enabled property is false. |
| 66847155   | Failed to modify the -is-write-absorption-enabled property because -is-writeback-enabled is not enabled. |
*/
...
type FlexcacheModifyCollectionBody struct {
	...
	// mtime scrubber
	MtimeScrubber *models.FlexcacheInlineMtimeScrubber `json:"mtime_scrubber,omitempty"`
	...
	// write absorption
	WriteAbsorption *models.FlexcacheInlineWriteAbsorption `json:"write_absorption,omitempty"`
...
func (o *FlexcacheModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateMtimeScrubber(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateWriteAbsorption(formats); err != nil {
		res = append(res, err)
	}
...
func (o *FlexcacheModifyCollectionBody) validateMtimeScrubber(formats strfmt.Registry) error {
	if swag.IsZero(o.MtimeScrubber) { // not required
		return nil
	}

	if o.MtimeScrubber != nil {
		if err := o.MtimeScrubber.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "mtime_scrubber")
			}
			return err
		}
	}
...
func (o *FlexcacheModifyCollectionBody) validateWriteAbsorption(formats strfmt.Registry) error {
	if swag.IsZero(o.WriteAbsorption) { // not required
		return nil
	}

	if o.WriteAbsorption != nil {
		if err := o.WriteAbsorption.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "write_absorption")
			}
			return err
		}
	}
...
func (o *FlexcacheModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateMtimeScrubber(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.contextValidateWriteAbsorption(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *FlexcacheModifyCollectionBody) contextValidateMtimeScrubber(ctx context.Context, formats strfmt.Registry) error {

	if o.MtimeScrubber != nil {
		if err := o.MtimeScrubber.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "mtime_scrubber")
			}
			return err
...
func (o *FlexcacheModifyCollectionBody) contextValidateWriteAbsorption(ctx context.Context, formats strfmt.Registry) error {

	if o.WriteAbsorption != nil {
		if err := o.WriteAbsorption.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "write_absorption")
			}
			return err
...
/*
FlexcacheInlineMtimeScrubber Flexcache Mtime Scrubber
swagger:model flexcache_inline_mtime_scrubber
*/
type FlexcacheInlineMtimeScrubber struct {
...
// Validate validates this flexcache inline mtime scrubber
func (o *FlexcacheInlineMtimeScrubber) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *FlexcacheInlineMtimeScrubber) validateThreshold(formats strfmt.Registry) error {
	if swag.IsZero(o.Threshold) { // not required
		return nil
	}

	if err := validate.MinimumInt("info"+"."+"mtime_scrubber"+"."+"threshold", "body", *o.Threshold, 5, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("info"+"."+"mtime_scrubber"+"."+"threshold", "body", *o.Threshold, 2.592e+06, false); err != nil {
		return err
	}
...
// ContextValidate validates this flexcache inline mtime scrubber based on context it is used
func (o *FlexcacheInlineMtimeScrubber) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *FlexcacheInlineMtimeScrubber) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *FlexcacheInlineMtimeScrubber) UnmarshalBinary(b []byte) error {
	var res FlexcacheInlineMtimeScrubber
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
FlexcacheInlineWriteAbsorption Flexcache Write Absorption
swagger:model flexcache_inline_write_absorption
*/
type FlexcacheInlineWriteAbsorption struct {
...
// Validate validates this flexcache inline write absorption
func (o *FlexcacheInlineWriteAbsorption) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this flexcache inline write absorption based on context it is used
func (o *FlexcacheInlineWriteAbsorption) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *FlexcacheInlineWriteAbsorption) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *FlexcacheInlineWriteAbsorption) UnmarshalBinary(b []byte) error {
	var res FlexcacheInlineWriteAbsorption
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
