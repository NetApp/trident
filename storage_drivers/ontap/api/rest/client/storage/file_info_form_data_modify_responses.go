...
func (o *FileInfoFormDataModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 6488121 | Hole punch is not supported on FlexGroup volumes. |
| 6488122 | Hole punch is only supported on .md and .dt files. |
| 6488123 | Both 'start' and 'size' must be specified for each hole range. |
| 6488124 | Hole punch requires delete privileges on the file endpoint. |
