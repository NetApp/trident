...
func (o *SnapshotPolicyModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SnapshotPolicyInlineCopiesInlineArrayItem) validateSnapmirrorLabel(formats strfmt.Registry) error {
	if swag.IsZero(o.SnapmirrorLabel) { // not required
		return nil
	}

	if err := validate.MinLength("snapmirror_label", "body", *o.SnapmirrorLabel, 1); err != nil {
		return err
	}

	if err := validate.MaxLength("snapmirror_label", "body", *o.SnapmirrorLabel, 31); err != nil {
		return err
	}
