...
func (o *SnapshotPolicyScheduleModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SnapshotPolicyScheduleModifyCollectionBody) validateSnapmirrorLabel(formats strfmt.Registry) error {
	if swag.IsZero(o.SnapmirrorLabel) { // not required
		return nil
	}

	if err := validate.MinLength("info"+"."+"snapmirror_label", "body", *o.SnapmirrorLabel, 1); err != nil {
		return err
	}
