...
func (o *PlexGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the plex get o k response
func (o *PlexGetOK) Code() int {
	return 200
}

func (o *PlexGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /storage/aggregates/{aggregate.uuid}/plexes/{name}][%d] plexGetOK %s", 200, payload)
}
...
func (o *PlexGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /storage/aggregates/{aggregate.uuid}/plexes/{name}][%d] plex_get default %s", o._statusCode, payload)
}
