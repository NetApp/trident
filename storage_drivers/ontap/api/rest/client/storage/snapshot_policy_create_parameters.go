...
// WithReturnRecordsQueryParameter adds the returnRecords to the snapshot policy create params
func (o *SnapshotPolicyCreateParams) WithReturnRecordsQueryParameter(returnRecords *bool) *SnapshotPolicyCreateParams {
	o.SetReturnRecordsQueryParameter(returnRecords)
	return o
}

// SetReturnRecordsQueryParameter adds the returnRecords to the snapshot policy create params
func (o *SnapshotPolicyCreateParams) SetReturnRecordsQueryParameter(returnRecords *bool) {
