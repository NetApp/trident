...
// WithReturnTimeoutQueryParameter adds the returnTimeout to the file move create params
func (o *FileMoveCreateParams) WithReturnTimeoutQueryParameter(returnTimeout *int64) *FileMoveCreateParams {
	o.SetReturnTimeoutQueryParameter(returnTimeout)
	return o
}

// SetReturnTimeoutQueryParameter adds the returnTimeout to the file move create params
func (o *FileMoveCreateParams) SetReturnTimeoutQueryParameter(returnTimeout *int64) {
