...
func (o *SnapshotPolicyGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the snapshot policy get o k response
func (o *SnapshotPolicyGetOK) Code() int {
	return 200
}
