...
func (o *QosPolicyModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type QosPolicyModifyCollectionBody struct {
	...
	// burst
	Burst *models.QosPolicyInlineBurst `json:"burst,omitempty"`
...
func (o *QosPolicyModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateBurst(formats); err != nil {
		res = append(res, err)
	}
...
func (o *QosPolicyModifyCollectionBody) validateBurst(formats strfmt.Registry) error {
	if swag.IsZero(o.Burst) { // not required
		return nil
	}

	if o.Burst != nil {
		if err := o.Burst.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "burst")
			}
			return err
		}
	}
...
func (o *QosPolicyModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateBurst(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *QosPolicyModifyCollectionBody) contextValidateBurst(ctx context.Context, formats strfmt.Registry) error {

	if o.Burst != nil {
		if err := o.Burst.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "burst")
			}
			return err
...
/*
QosPolicyInlineBurst Burst settings for the QoS policy.
swagger:model qos_policy_inline_burst
*/
type QosPolicyInlineBurst struct {
...
// Validate validates this qos policy inline burst
func (o *QosPolicyInlineBurst) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := o.validatePercent(formats); err != nil {
		res = append(res, err)
	}
...
func (o *QosPolicyInlineBurst) validateDuration(formats strfmt.Registry) error {
	if swag.IsZero(o.Duration) { // not required
		return nil
	}

	if err := validate.MinimumInt("info"+"."+"burst"+"."+"duration", "body", *o.Duration, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("info"+"."+"burst"+"."+"duration", "body", *o.Duration, 3600, false); err != nil {
		return err
	}
...
func (o *QosPolicyInlineBurst) validateIops(formats strfmt.Registry) error {
	if swag.IsZero(o.Iops) { // not required
		return nil
	}

	if err := validate.MinimumInt("info"+"."+"burst"+"."+"iops", "body", *o.Iops, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("info"+"."+"burst"+"."+"iops", "body", *o.Iops, 2.147483647e+09, false); err != nil {
		return err
	}
...
func (o *QosPolicyInlineBurst) validatePercent(formats strfmt.Registry) error {
	if swag.IsZero(o.Percent) { // not required
		return nil
	}

	if err := validate.MinimumInt("info"+"."+"burst"+"."+"percent", "body", *o.Percent, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("info"+"."+"burst"+"."+"percent", "body", *o.Percent, 2.147483647e+09, false); err != nil {
		return err
	}
...
// ContextValidate validates this qos policy inline burst based on context it is used
func (o *QosPolicyInlineBurst) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *QosPolicyInlineBurst) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *QosPolicyInlineBurst) UnmarshalBinary(b []byte) error {
	var res QosPolicyInlineBurst
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
