...
func (o *CloudStoreCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the cloud store collection get o k response
func (o *CloudStoreCollectionGetOK) Code() int {
	return 200
}

func (o *CloudStoreCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloudStoreCollectionGetOK %s", 200, payload)
}
...
func (o *CloudStoreCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloud_store_collection_get default %s", o._statusCode, payload)
}
