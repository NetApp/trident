...
// WithBurstDuration adds the burstDuration to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithBurstDuration(burstDuration *int64) *QosPolicyModifyCollectionParams {
	o.SetBurstDuration(burstDuration)
	return o
}

// SetBurstDuration adds the burstDuration to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetBurstDuration(burstDuration *int64) {
	o.BurstDuration = burstDuration
}

// WithBurstIops adds the burstIops to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithBurstIops(burstIops *int64) *QosPolicyModifyCollectionParams {
	o.SetBurstIops(burstIops)
	return o
}

// SetBurstIops adds the burstIops to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetBurstIops(burstIops *int64) {
	o.BurstIops = burstIops
}

// WithBurstPercent adds the burstPercent to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithBurstPercent(burstPercent *int64) *QosPolicyModifyCollectionParams {
	o.SetBurstPercent(burstPercent)
	return o
}

// SetBurstPercent adds the burstPercent to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetBurstPercent(burstPercent *int64) {
...
// WithFixedMaxThroughput adds the fixedMaxThroughput to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithFixedMaxThroughput(fixedMaxThroughput *string) *QosPolicyModifyCollectionParams {
	o.SetFixedMaxThroughput(fixedMaxThroughput)
	return o
}

// SetFixedMaxThroughput adds the fixedMaxThroughput to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetFixedMaxThroughput(fixedMaxThroughput *string) {
...
// WithFixedMinThroughput adds the fixedMinThroughput to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithFixedMinThroughput(fixedMinThroughput *string) *QosPolicyModifyCollectionParams {
	o.SetFixedMinThroughput(fixedMinThroughput)
	return o
}

// SetFixedMinThroughput adds the fixedMinThroughput to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetFixedMinThroughput(fixedMinThroughput *string) {
