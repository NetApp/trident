...
func (o *FlexcacheCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 66847105   | Creating a FlexCache volume with Write Absorption mode requires an effective cluster version of 9.19.1 or later on all nodes in the origin and cache clusters. |
| 66847153   | Failing to modify the -mtime-scrubber-enabled or -mtime-scrubber-threshold property requires an effective cluster version of 9.19.1 or later on all nodes in the origin and cache clusters. |
...
| 66847151   | Failed to modify the mtime-scrubber-threshold property because mtime-scrubber is not enabled |
