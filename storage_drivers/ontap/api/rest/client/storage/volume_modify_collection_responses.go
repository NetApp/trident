...
func (o *VolumeModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type VolumeModifyCollectionBody struct {
	...
	// Specifies the volume should be protected by SnapMirror Active Sync NAS or not
	...
	// Specifies the volume should be protected by Vserver level SnapMirror or not
	// Enum: ["protected","unprotected"]
	SvmDrProtection *string `json:"svm_dr_protection,omitempty"`
...
func (o *VolumeModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateSmasProtection(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateSvmDrProtection(formats); err != nil {
		res = append(res, err)
	}
...
var volumeModifyCollectionBodyTypeSmasProtectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		volumeModifyCollectionBodyTypeSmasProtectionPropEnum = append(volumeModifyCollectionBodyTypeSmasProtectionPropEnum, v)
	}
}
...
const (
	...
	// protected
	// END DEBUGGING
	// VolumeModifyCollectionBodySmasProtectionProtected captures enum value "protected"
	VolumeModifyCollectionBodySmasProtectionProtected string = "protected"
	...
	// unprotected
	// END DEBUGGING
	// VolumeModifyCollectionBodySmasProtectionUnprotected captures enum value "unprotected"
	VolumeModifyCollectionBodySmasProtectionUnprotected string = "unprotected"
)

// prop value enum
func (o *VolumeModifyCollectionBody) validateSmasProtectionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, volumeModifyCollectionBodyTypeSmasProtectionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *VolumeModifyCollectionBody) validateSmasProtection(formats strfmt.Registry) error {
	if swag.IsZero(o.SmasProtection) { // not required
		return nil
	}

	// value enum
	if err := o.validateSmasProtectionEnum("info"+"."+"smas_protection", "body", *o.SmasProtection); err != nil {
		return err
	}
...
var volumeModifyCollectionBodyTypeSvmDrProtectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		volumeModifyCollectionBodyTypeSvmDrProtectionPropEnum = append(volumeModifyCollectionBodyTypeSvmDrProtectionPropEnum, v)
	}
}
...
const (
	...
	// protected
	// END DEBUGGING
	// VolumeModifyCollectionBodySvmDrProtectionProtected captures enum value "protected"
	VolumeModifyCollectionBodySvmDrProtectionProtected string = "protected"
	...
	// unprotected
	// END DEBUGGING
	// VolumeModifyCollectionBodySvmDrProtectionUnprotected captures enum value "unprotected"
	VolumeModifyCollectionBodySvmDrProtectionUnprotected string = "unprotected"
)

// prop value enum
func (o *VolumeModifyCollectionBody) validateSvmDrProtectionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, volumeModifyCollectionBodyTypeSvmDrProtectionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *VolumeModifyCollectionBody) validateSvmDrProtection(formats strfmt.Registry) error {
	if swag.IsZero(o.SvmDrProtection) { // not required
		return nil
	}

	// value enum
	if err := o.validateSvmDrProtectionEnum("info"+"."+"svm_dr_protection", "body", *o.SvmDrProtection); err != nil {
		return err
	}
...
type VolumeInlineAntiRansomware struct {
	...
	// Time when anti-ransomware monitoring `state` is set to dry-run value for starting evaluation mode.This field will no longer be supported in a future release.
	// Read Only: true
	// Format: date-time
