...
// WithReturnTimeoutQueryParameter adds the returnTimeout to the flexcache modify params
func (o *FlexcacheModifyParams) WithReturnTimeoutQueryParameter(returnTimeout *int64) *FlexcacheModifyParams {
	o.SetReturnTimeoutQueryParameter(returnTimeout)
	return o
}

// SetReturnTimeoutQueryParameter adds the returnTimeout to the flexcache modify params
func (o *FlexcacheModifyParams) SetReturnTimeoutQueryParameter(returnTimeout *int64) {
	o.ReturnTimeoutQueryParameter = returnTimeout
}

// WithUUIDPathParameter adds the uuid to the flexcache modify params
func (o *FlexcacheModifyParams) WithUUIDPathParameter(uuid string) *FlexcacheModifyParams {
	o.SetUUIDPathParameter(uuid)
	return o
}

// SetUUIDPathParameter adds the uuid to the flexcache modify params
func (o *FlexcacheModifyParams) SetUUIDPathParameter(uuid string) {
