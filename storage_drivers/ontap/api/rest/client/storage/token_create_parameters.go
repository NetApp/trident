...
// WithReturnRecordsQueryParameter adds the returnRecords to the token create params
func (o *TokenCreateParams) WithReturnRecordsQueryParameter(returnRecords *bool) *TokenCreateParams {
	o.SetReturnRecordsQueryParameter(returnRecords)
	return o
}

// SetReturnRecordsQueryParameter adds the returnRecords to the token create params
func (o *TokenCreateParams) SetReturnRecordsQueryParameter(returnRecords *bool) {
