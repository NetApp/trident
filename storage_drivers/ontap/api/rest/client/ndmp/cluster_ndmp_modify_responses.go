...
func (o *ClusterNdmpModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 68812807    | NDMP node-scope mode is not supported on this platform.|
*/
