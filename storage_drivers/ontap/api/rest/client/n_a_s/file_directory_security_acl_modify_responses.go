...
func (o *FileDirectorySecurityACLModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *FileDirectorySecurityACLModifyOK) GetPayload() *models.FileDirectorySecurityACLJobLinkResponse {
	return o.Payload
}
...
func (o *FileDirectorySecurityACLModifyAccepted) GetPayload() *models.FileDirectorySecurityACLJobLinkResponse {
	return o.Payload
}
