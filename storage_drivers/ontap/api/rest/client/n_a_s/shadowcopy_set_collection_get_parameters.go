...
// NewShadowcopySetCollectionGetParamsWithTimeout creates a new ShadowcopySetCollectionGetParams object
...
// NewShadowcopySetCollectionGetParamsWithContext creates a new ShadowcopySetCollectionGetParams object
...
// NewShadowcopySetCollectionGetParamsWithHTTPClient creates a new ShadowcopySetCollectionGetParams object
...
func (o *ShadowcopySetCollectionGetParams) WithDefaults() *ShadowcopySetCollectionGetParams {
	o.SetDefaults()
	return o
}
...
func (o *ShadowcopySetCollectionGetParams) WithTimeout(timeout time.Duration) *ShadowcopySetCollectionGetParams {
...
func (o *ShadowcopySetCollectionGetParams) WithContext(ctx context.Context) *ShadowcopySetCollectionGetParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the shadowcopy set collection get params
func (o *ShadowcopySetCollectionGetParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the shadowcopy set collection get params
func (o *ShadowcopySetCollectionGetParams) WithHTTPClient(client *http.Client) *ShadowcopySetCollectionGetParams {
...
func (o *ShadowcopySetCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
