...
// WithScopeExcludeBuckets adds the scopeExcludeBuckets to the fpolicy policy delete collection params
func (o *FpolicyPolicyDeleteCollectionParams) WithScopeExcludeBuckets(scopeExcludeBuckets *string) *FpolicyPolicyDeleteCollectionParams {
	o.SetScopeExcludeBuckets(scopeExcludeBuckets)
	return o
}

// SetScopeExcludeBuckets adds the scopeExcludeBuckets to the fpolicy policy delete collection params
func (o *FpolicyPolicyDeleteCollectionParams) SetScopeExcludeBuckets(scopeExcludeBuckets *string) {
...
// WithScopeIncludeBuckets adds the scopeIncludeBuckets to the fpolicy policy delete collection params
func (o *FpolicyPolicyDeleteCollectionParams) WithScopeIncludeBuckets(scopeIncludeBuckets *string) *FpolicyPolicyDeleteCollectionParams {
	o.SetScopeIncludeBuckets(scopeIncludeBuckets)
	return o
}

// SetScopeIncludeBuckets adds the scopeIncludeBuckets to the fpolicy policy delete collection params
func (o *FpolicyPolicyDeleteCollectionParams) SetScopeIncludeBuckets(scopeIncludeBuckets *string) {
