...
func (o *VscanGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the vscan get o k response
func (o *VscanGetOK) Code() int {
	return 200
}

func (o *VscanGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/vscan/{svm.uuid}][%d] vscanGetOK %s", 200, payload)
}
...
func (o *VscanGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/vscan/{svm.uuid}][%d] vscan_get default %s", o._statusCode, payload)
}
