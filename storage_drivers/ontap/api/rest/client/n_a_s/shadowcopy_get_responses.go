...
func (o *ShadowcopyGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewShadowcopyGetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewShadowcopyGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// Code gets the status code for the shadowcopy get o k response
func (o *ShadowcopyGetOK) Code() int {
	return 200
}

func (o *ShadowcopyGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/shadow-copies/{client_uuid}][%d] shadowcopyGetOK %s", 200, payload)
}
...
func (o *ShadowcopyGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Shadowcopy)
...
func (o *ShadowcopyGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/shadow-copies/{client_uuid}][%d] shadowcopy_get default %s", o._statusCode, payload)
}
...
func (o *ShadowcopyGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
