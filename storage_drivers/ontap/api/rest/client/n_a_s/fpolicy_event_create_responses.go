...
func (o *FpolicyEventCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 9765085    | The Failed operation notification is not supported with S3 protocol |
*/
