...
func (o *FpolicyEngineCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the fpolicy engine collection get o k response
func (o *FpolicyEngineCollectionGetOK) Code() int {
	return 200
}

func (o *FpolicyEngineCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/fpolicy/{svm.uuid}/engines][%d] fpolicyEngineCollectionGetOK %s", 200, payload)
}
...
func (o *FpolicyEngineCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/fpolicy/{svm.uuid}/engines][%d] fpolicy_engine_collection_get default %s", o._statusCode, payload)
}
