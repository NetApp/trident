...
func (o *GroupPolicyObjectRestrictedGroupGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/cifs/group-policies/{svm.uuid}/restricted-groups/{policy_index}/{group_name}][%d] groupPolicyObjectRestrictedGroupGetOK  %+v", 200, o.Payload)
}
...
func (o *GroupPolicyObjectRestrictedGroupGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/cifs/group-policies/{svm.uuid}/restricted-groups/{policy_index}/{group_name}][%d] group_policy_object_restricted_group_get default  %+v", o._statusCode, o.Payload)
}
