...
func (o *CifsShareACLGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the cifs share Acl get o k response
func (o *CifsShareACLGetOK) Code() int {
	return 200
}

func (o *CifsShareACLGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/shares/{svm.uuid}/{share}/acls/{user_or_group}/{type}][%d] cifsShareAclGetOK %s", 200, payload)
}
...
func (o *CifsShareACLGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/shares/{svm.uuid}/{share}/acls/{user_or_group}/{type}][%d] cifs_share_acl_get default %s", o._statusCode, payload)
}
