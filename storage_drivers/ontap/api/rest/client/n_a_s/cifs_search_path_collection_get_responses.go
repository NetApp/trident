...
func (o *CifsSearchPathCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the cifs search path collection get o k response
func (o *CifsSearchPathCollectionGetOK) Code() int {
	return 200
}

func (o *CifsSearchPathCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/home-directory/search-paths][%d] cifsSearchPathCollectionGetOK %s", 200, payload)
}

func (o *CifsSearchPathCollectionGetOK) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/home-directory/search-paths][%d] cifsSearchPathCollectionGetOK %s", 200, payload)
}
...
func (o *CifsSearchPathCollectionGetDefault) IsSuccess() bool {
...
func (o *CifsSearchPathCollectionGetDefault) IsCode(code int) bool {
...
func (o *CifsSearchPathCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/home-directory/search-paths][%d] cifs_search_path_collection_get default %s", o._statusCode, payload)
}

func (o *CifsSearchPathCollectionGetDefault) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/home-directory/search-paths][%d] cifs_search_path_collection_get default %s", o._statusCode, payload)
}
