...
func (o *FpolicyEngineModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 9765080    | Policy associated with the S3 protocol does not support "synchronous" engine |
| 9765084    | Resiliency feature is not supported with the S3 protocol |
