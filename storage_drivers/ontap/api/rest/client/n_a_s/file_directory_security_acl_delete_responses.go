...
func (o *FileDirectorySecurityACLDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *FileDirectorySecurityACLDeleteOK) GetPayload() *models.FileDirectorySecurityACLJobLinkResponse {
	return o.Payload
}
...
func (o *FileDirectorySecurityACLDeleteAccepted) GetPayload() *models.FileDirectorySecurityACLJobLinkResponse {
	return o.Payload
}
