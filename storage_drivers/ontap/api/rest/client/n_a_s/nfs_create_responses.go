...
func (o *NfsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 3277094    | The \"-v4.2\" parameter requires an effective cluster version of Data ONTAP 9.19.1 or later.|
*/
