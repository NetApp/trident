...
func (o *ShadowcopyCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the shadowcopy collection get o k response
func (o *ShadowcopyCollectionGetOK) Code() int {
	return 200
}

func (o *ShadowcopyCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/shadow-copies][%d] shadowcopyCollectionGetOK %s", 200, payload)
}
...
func (o *ShadowcopyCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/shadow-copies][%d] shadowcopy_collection_get default %s", o._statusCode, payload)
}
