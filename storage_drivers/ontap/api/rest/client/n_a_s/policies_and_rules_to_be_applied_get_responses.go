...
func (o *PoliciesAndRulesToBeAppliedGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the policies and rules to be applied get o k response
func (o *PoliciesAndRulesToBeAppliedGetOK) Code() int {
	return 200
}

func (o *PoliciesAndRulesToBeAppliedGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/group-policies/{svm.uuid}][%d] policiesAndRulesToBeAppliedGetOK %s", 200, payload)
}
...
func (o *PoliciesAndRulesToBeAppliedGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/group-policies/{svm.uuid}][%d] policies_and_rules_to_be_applied_get default %s", o._statusCode, payload)
}
