...
func (o *CifsSymlinkMappingCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the cifs symlink mapping collection get o k response
func (o *CifsSymlinkMappingCollectionGetOK) Code() int {
	return 200
}

func (o *CifsSymlinkMappingCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/unix-symlink-mapping][%d] cifsSymlinkMappingCollectionGetOK %s", 200, payload)
}
...
func (o *CifsSymlinkMappingCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /protocols/cifs/unix-symlink-mapping][%d] cifs_symlink_mapping_collection_get default %s", o._statusCode, payload)
}
