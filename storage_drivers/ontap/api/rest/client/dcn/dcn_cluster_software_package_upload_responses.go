...
func (o *DcnClusterSoftwarePackageUploadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 203882513 | DCN cluster must be created before uploading DCN software packages. Retry the upload after creating a DCN cluster. |
| 203882514 | DCN software package cannot be uploaded while a package install is in progress. Retry the upload after the package install has completed. |
