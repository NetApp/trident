...
func (o *DcnClusterSoftwarePackageModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 203882508 | ONTAP update is in progress. Retry the AIDE cluster update after the ONTAP update has completed. |
| 203882509 | Package cannot be staged for an upgrade because the AIDE cluster is already running a newer version. |
| 203882515 | Management gateway daemon is still booting. Retry the stage operation after management gateway daemon has fully booted. |
| 288358450 | Internal error. Retry the request and contact technical support if the issue persists. |
