...
func (o *DcnClusterModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 288358415 | Cannot modify the network pool. Ensure the operation is expanding the IP range. |
| 288358416 | The AIDE cluster does not exist. |
| 288358440 | The network pool's IP range is invalid. |
| 288358458 | The AIDE cluster is currently unhealthy. Wait a few minutes, then retry the operation. |
