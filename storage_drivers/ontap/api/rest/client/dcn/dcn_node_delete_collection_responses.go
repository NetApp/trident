...
func (o *DcnNodeDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| ---------- | ----------- |
| 288358403 | The AIDE cluster must have between 3 and 10 nodes, inclusive. |
| 288358408 | Internal error. Failed to release the IP address of the compute node. |
| 288358412 | Internal error. Failed to delete a certificate for the compute node. |
| 288358438 | Internal error. Failed to determine if the compute node exists. |
| 288358453 | Cannot delete a compute node while an upgrade is in progress. |
