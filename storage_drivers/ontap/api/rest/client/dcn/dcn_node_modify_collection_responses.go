...
func (o *DcnNodeModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| ---------- | ----------- |
| 288358427 | Cannot modify a compute node that is not part of the AIDE cluster. |
