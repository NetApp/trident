...
func (o *DcnClusterDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| ---------- | ----------- |
| 288358414 | Unable to delete the AIDE cluster certificate. |
