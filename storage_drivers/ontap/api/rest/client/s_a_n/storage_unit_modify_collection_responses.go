...
func (o *StorageUnitModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
var storageUnitModifyCollectionBodyTypeAccessModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		storageUnitModifyCollectionBodyTypeAccessModePropEnum = append(storageUnitModifyCollectionBodyTypeAccessModePropEnum, v)
	}
}
...
const (
	...
	// global
	// END DEBUGGING
	// StorageUnitModifyCollectionBodyAccessModeGlobal captures enum value "global"
	StorageUnitModifyCollectionBodyAccessModeGlobal string = "global"
	...
	// local
	// END DEBUGGING
	// StorageUnitModifyCollectionBodyAccessModeLocal captures enum value "local"
	StorageUnitModifyCollectionBodyAccessModeLocal string = "local"
)

// prop value enum
func (o *StorageUnitModifyCollectionBody) validateAccessModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, storageUnitModifyCollectionBodyTypeAccessModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *StorageUnitModifyCollectionBody) validateAccessMode(formats strfmt.Registry) error {
...
func (o *StorageUnitModifyCollectionBody) contextValidateAccessMode(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"access_mode", "body", o.AccessMode); err != nil {
		return err
	}
