...
func (o *IscsiCredentialsModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IscsiCredentialsInlineChapInlineInbound) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("info"+"."+"chap"+"."+"inbound"+"."+"password", "body", o.Password.String(), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("info"+"."+"chap"+"."+"inbound"+"."+"password", "body", o.Password.String(), 512); err != nil {
		return err
	}

	if err := validate.FormatOf("info"+"."+"chap"+"."+"inbound"+"."+"password", "body", "password", o.Password.String(), formats); err != nil {
		return err
	}
...
func (o *IscsiCredentialsInlineChapInlineOutbound) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("info"+"."+"chap"+"."+"outbound"+"."+"password", "body", o.Password.String(), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("info"+"."+"chap"+"."+"outbound"+"."+"password", "body", o.Password.String(), 512); err != nil {
		return err
	}

	if err := validate.FormatOf("info"+"."+"chap"+"."+"outbound"+"."+"password", "body", "password", o.Password.String(), formats); err != nil {
		return err
	}
