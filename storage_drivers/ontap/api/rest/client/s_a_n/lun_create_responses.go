...
func (o *LunCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 5374184 | A LUN cannot be created because the SVM is part of a SnapMirror active sync NAS relationship. |
...
| 5375266 | Setting `access_mode` is not supported on LUNs with the given operating system type. |
| 5375267 | Setting `access_mode` requires an effective cluster version of 9.19.1 or later. |
| 5375269 | The access mode was modified, but the LUN could not be brought back online. |
| 5375270 | The LUN was offlined, but the access mode could not be modified. |
| 5375274 | Setting `access_mode` requires that the peer cluster's effective cluster version be 9.19.1 or later. |
| 5375275 | Setting `access_mode` is not supported with MetroCluster configured. |
