...
func (o *LunAttributeCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the lun attribute collection get o k response
func (o *LunAttributeCollectionGetOK) Code() int {
	return 200
}

func (o *LunAttributeCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /storage/luns/{lun.uuid}/attributes][%d] lunAttributeCollectionGetOK %s", 200, payload)
}
...
func (o *LunAttributeCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /storage/luns/{lun.uuid}/attributes][%d] lun_attribute_collection_get default %s", o._statusCode, payload)
}
