...
// NewSnaplockLogCreateParams creates a new SnaplockLogCreateParams object,
...
func NewSnaplockLogCreateParams() *SnaplockLogCreateParams {
	return &SnaplockLogCreateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewSnaplockLogCreateParamsWithTimeout creates a new SnaplockLogCreateParams object
...
// NewSnaplockLogCreateParamsWithContext creates a new SnaplockLogCreateParams object
...
// NewSnaplockLogCreateParamsWithHTTPClient creates a new SnaplockLogCreateParams object
...
func (o *SnaplockLogCreateParams) WithDefaults() *SnaplockLogCreateParams {
	o.SetDefaults()
	return o
}
...
func (o *SnaplockLogCreateParams) WithTimeout(timeout time.Duration) *SnaplockLogCreateParams {
...
func (o *SnaplockLogCreateParams) WithContext(ctx context.Context) *SnaplockLogCreateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *SnaplockLogCreateParams) WithInfo(info *models.SnaplockLog) *SnaplockLogCreateParams {
	o.SetInfo(info)
	return o
}
...
// WithReturnRecordsQueryParameter adds the returnRecords to the snaplock log create params
func (o *SnaplockLogCreateParams) WithReturnRecordsQueryParameter(returnRecords *bool) *SnaplockLogCreateParams {
	o.SetReturnRecordsQueryParameter(returnRecords)
	return o
}

// SetReturnRecordsQueryParameter adds the returnRecords to the snaplock log create params
func (o *SnaplockLogCreateParams) SetReturnRecordsQueryParameter(returnRecords *bool) {
	o.ReturnRecordsQueryParameter = returnRecords
}

// WithReturnTimeoutQueryParameter adds the returnTimeout to the snaplock log create params
func (o *SnaplockLogCreateParams) WithReturnTimeoutQueryParameter(returnTimeout *int64) *SnaplockLogCreateParams {
	o.SetReturnTimeoutQueryParameter(returnTimeout)
	return o
}

// SetReturnTimeoutQueryParameter adds the returnTimeout to the snaplock log create params
func (o *SnaplockLogCreateParams) SetReturnTimeoutQueryParameter(returnTimeout *int64) {
	o.ReturnTimeoutQueryParameter = returnTimeout
}

// WriteToRequest writes these params to a swagger request
func (o *SnaplockLogCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
