...
func (o *SnaplockLogDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SnaplockLogDeleteOK) GetPayload() *models.SnaplockLogJobLinkResponse {
	return o.Payload
}
...
func (o *SnaplockLogDeleteAccepted) GetPayload() *models.SnaplockLogJobLinkResponse {
	return o.Payload
}
