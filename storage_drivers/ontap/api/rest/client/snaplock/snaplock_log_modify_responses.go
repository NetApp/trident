...
func (o *SnaplockLogModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SnaplockLogModifyOK) GetPayload() *models.SnaplockLogJobLinkResponse {
	return o.Payload
}
...
func (o *SnaplockLogModifyAccepted) GetPayload() *models.SnaplockLogJobLinkResponse {
	return o.Payload
}
