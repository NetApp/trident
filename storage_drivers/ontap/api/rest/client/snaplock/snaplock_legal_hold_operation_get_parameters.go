...
// WithFields adds the fields to the snaplock legal hold operation get params
func (o *SnaplockLegalHoldOperationGetParams) WithFields(fields []string) *SnaplockLegalHoldOperationGetParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the snaplock legal hold operation get params
func (o *SnaplockLegalHoldOperationGetParams) SetFields(fields []string) {
	o.Fields = fields
}
