...
func (o *NisCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the nis collection get o k response
func (o *NisCollectionGetOK) Code() int {
	return 200
}

func (o *NisCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /name-services/nis][%d] nisCollectionGetOK %s", 200, payload)
}
...
func (o *NisCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /name-services/nis][%d] nis_collection_get default %s", o._statusCode, payload)
}
