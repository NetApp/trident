...
func (o *NetgroupsSettingsCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the netgroups settings collection get o k response
func (o *NetgroupsSettingsCollectionGetOK) Code() int {
	return 200
}

func (o *NetgroupsSettingsCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /name-services/cache/netgroup/settings][%d] netgroupsSettingsCollectionGetOK %s", 200, payload)
}
...
func (o *NetgroupsSettingsCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /name-services/cache/netgroup/settings][%d] netgroups_settings_collection_get default %s", o._statusCode, payload)
}
