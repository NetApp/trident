...
func (o *UnixUserSettingsModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the unix user settings modify o k response
func (o *UnixUserSettingsModifyOK) Code() int {
	return 200
}
...
func (o *UnixUserSettingsModifyDefault) Error() string {
	...
	return fmt.Sprintf("[PATCH /name-services/cache/unix-user/settings/{svm.uuid}][%d] unix_user_settings_modify default %s", o._statusCode, payload)
}
