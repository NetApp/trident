...
func (o *DNSCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DNSCreateAccepted) GetPayload() *models.DNSJobLinkResponse {
	return o.Payload
}
