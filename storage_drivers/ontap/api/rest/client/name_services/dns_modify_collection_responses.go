...
func (o *DNSModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	case 202:
		result := NewDNSModifyCollectionAccepted()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewDNSModifyCollectionAccepted creates a DNSModifyCollectionAccepted with default headers values
func NewDNSModifyCollectionAccepted() *DNSModifyCollectionAccepted {
	return &DNSModifyCollectionAccepted{}
}

/*
DNSModifyCollectionAccepted describes a response with status code 202, with default header values.

Accepted
*/
type DNSModifyCollectionAccepted struct {
	Payload *models.DNSJobLinkResponse
}

// IsSuccess returns true when this dns modify collection accepted response has a 2xx status code
func (o *DNSModifyCollectionAccepted) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this dns modify collection accepted response has a 3xx status code
func (o *DNSModifyCollectionAccepted) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dns modify collection accepted response has a 4xx status code
func (o *DNSModifyCollectionAccepted) IsClientError() bool {
	return false
}

// IsServerError returns true when this dns modify collection accepted response has a 5xx status code
func (o *DNSModifyCollectionAccepted) IsServerError() bool {
	return false
}

// IsCode returns true when this dns modify collection accepted response a status code equal to that given
func (o *DNSModifyCollectionAccepted) IsCode(code int) bool {
	return code == 202
}

// Code gets the status code for the dns modify collection accepted response
func (o *DNSModifyCollectionAccepted) Code() int {
	return 202
}

func (o *DNSModifyCollectionAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /name-services/dns][%d] dnsModifyCollectionAccepted %s", 202, payload)
}

func (o *DNSModifyCollectionAccepted) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /name-services/dns][%d] dnsModifyCollectionAccepted %s", 202, payload)
}

func (o *DNSModifyCollectionAccepted) GetPayload() *models.DNSJobLinkResponse {
	return o.Payload
}

func (o *DNSModifyCollectionAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DNSJobLinkResponse)
