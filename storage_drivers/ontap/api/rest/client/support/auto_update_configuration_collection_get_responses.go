...
func (o *AutoUpdateConfigurationCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AutoUpdateConfigurationCollectionGetOK) Code() int {
	return 200
}

func (o *AutoUpdateConfigurationCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /support/auto-update/configurations][%d] autoUpdateConfigurationCollectionGetOK %s", 200, payload)
}
...
func (o *AutoUpdateConfigurationCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /support/auto-update/configurations][%d] auto_update_configuration_collection_get default %s", o._statusCode, payload)
}
