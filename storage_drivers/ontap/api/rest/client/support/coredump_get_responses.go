...
func (o *CoredumpGetOK) Error() string {
	return fmt.Sprintf("[GET /support/coredump/coredumps/{node.uuid}/{name}][%d] coredumpGetOK  %+v", 200, o.Payload)
}
...
func (o *CoredumpGetDefault) Error() string {
	return fmt.Sprintf("[GET /support/coredump/coredumps/{node.uuid}/{name}][%d] coredump_get default  %+v", o._statusCode, o.Payload)
}
