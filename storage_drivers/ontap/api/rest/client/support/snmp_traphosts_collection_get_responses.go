...
func (o *SnmpTraphostsCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SnmpTraphostsCollectionGetOK) Code() int {
	return 200
}

func (o *SnmpTraphostsCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /support/snmp/traphosts][%d] snmpTraphostsCollectionGetOK %s", 200, payload)
}

func (o *SnmpTraphostsCollectionGetOK) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /support/snmp/traphosts][%d] snmpTraphostsCollectionGetOK %s", 200, payload)
}
...
func (o *SnmpTraphostsCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /support/snmp/traphosts][%d] snmp_traphosts_collection_get default %s", o._statusCode, payload)
}

func (o *SnmpTraphostsCollectionGetDefault) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /support/snmp/traphosts][%d] snmp_traphosts_collection_get default %s", o._statusCode, payload)
}
