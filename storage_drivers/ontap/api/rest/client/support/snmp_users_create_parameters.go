...
// NewSnmpUsersCreateParams creates a new SnmpUsersCreateParams object,
...
func NewSnmpUsersCreateParams() *SnmpUsersCreateParams {
	return &SnmpUsersCreateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewSnmpUsersCreateParamsWithTimeout creates a new SnmpUsersCreateParams object
...
// NewSnmpUsersCreateParamsWithContext creates a new SnmpUsersCreateParams object
...
// NewSnmpUsersCreateParamsWithHTTPClient creates a new SnmpUsersCreateParams object
...
func (o *SnmpUsersCreateParams) WithContext(ctx context.Context) *SnmpUsersCreateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *SnmpUsersCreateParams) WithInfo(info *models.SnmpUser) *SnmpUsersCreateParams {
	o.SetInfo(info)
	return o
}
...
// WithReturnRecordsQueryParameter adds the returnRecords to the snmp users create params
func (o *SnmpUsersCreateParams) WithReturnRecordsQueryParameter(returnRecords *bool) *SnmpUsersCreateParams {
	o.SetReturnRecordsQueryParameter(returnRecords)
	return o
}

// SetReturnRecordsQueryParameter adds the returnRecords to the snmp users create params
func (o *SnmpUsersCreateParams) SetReturnRecordsQueryParameter(returnRecords *bool) {
	o.ReturnRecordsQueryParameter = returnRecords
}

// WithReturnTimeoutQueryParameter adds the returnTimeout to the snmp users create params
func (o *SnmpUsersCreateParams) WithReturnTimeoutQueryParameter(returnTimeout *int64) *SnmpUsersCreateParams {
	o.SetReturnTimeoutQueryParameter(returnTimeout)
	return o
}

// SetReturnTimeoutQueryParameter adds the returnTimeout to the snmp users create params
func (o *SnmpUsersCreateParams) SetReturnTimeoutQueryParameter(returnTimeout *int64) {
