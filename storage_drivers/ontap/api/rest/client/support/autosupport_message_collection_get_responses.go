...
func (o *AutosupportMessageCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AutosupportMessageCollectionGetDefault) IsRedirect() bool {
...
func (o *AutosupportMessageCollectionGetDefault) IsCode(code int) bool {
