...
// WithReturnRecordsQueryParameter adds the returnRecords to the ems application logs create params
func (o *EmsApplicationLogsCreateParams) WithReturnRecordsQueryParameter(returnRecords *bool) *EmsApplicationLogsCreateParams {
	o.SetReturnRecordsQueryParameter(returnRecords)
	return o
}

// SetReturnRecordsQueryParameter adds the returnRecords to the ems application logs create params
func (o *EmsApplicationLogsCreateParams) SetReturnRecordsQueryParameter(returnRecords *bool) {
