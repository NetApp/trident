...
// WithReturnRecords adds the returnRecords to the configuration backup modify params
func (o *ConfigurationBackupModifyParams) WithReturnRecords(returnRecords *bool) *ConfigurationBackupModifyParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the configuration backup modify params
func (o *ConfigurationBackupModifyParams) SetReturnRecords(returnRecords *bool) {
