...
// WithTotalOpsErrorLowerBound adds the totalOpsErrorLowerBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalOpsErrorLowerBound(totalOpsErrorLowerBound *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalOpsErrorLowerBound(totalOpsErrorLowerBound)
	return o
}

// SetTotalOpsErrorLowerBound adds the totalOpsErrorLowerBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalOpsErrorLowerBound(totalOpsErrorLowerBound *int64) {
	o.TotalOpsErrorLowerBound = totalOpsErrorLowerBound
}

// WithTotalOpsErrorUpperBound adds the totalOpsErrorUpperBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalOpsErrorUpperBound(totalOpsErrorUpperBound *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalOpsErrorUpperBound(totalOpsErrorUpperBound)
	return o
}

// SetTotalOpsErrorUpperBound adds the totalOpsErrorUpperBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalOpsErrorUpperBound(totalOpsErrorUpperBound *int64) {
	o.TotalOpsErrorUpperBound = totalOpsErrorUpperBound
}

// WithTotalOpsRead adds the totalOpsRead to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalOpsRead(totalOpsRead *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalOpsRead(totalOpsRead)
	return o
}

// SetTotalOpsRead adds the totalOpsRead to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalOpsRead(totalOpsRead *int64) {
	o.TotalOpsRead = totalOpsRead
}

// WithTotalOpsWrite adds the totalOpsWrite to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalOpsWrite(totalOpsWrite *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalOpsWrite(totalOpsWrite)
	return o
}

// SetTotalOpsWrite adds the totalOpsWrite to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalOpsWrite(totalOpsWrite *int64) {
	o.TotalOpsWrite = totalOpsWrite
}

// WithTotalThroughputErrorLowerBound adds the totalThroughputErrorLowerBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalThroughputErrorLowerBound(totalThroughputErrorLowerBound *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalThroughputErrorLowerBound(totalThroughputErrorLowerBound)
	return o
}

// SetTotalThroughputErrorLowerBound adds the totalThroughputErrorLowerBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalThroughputErrorLowerBound(totalThroughputErrorLowerBound *int64) {
	o.TotalThroughputErrorLowerBound = totalThroughputErrorLowerBound
}

// WithTotalThroughputErrorUpperBound adds the totalThroughputErrorUpperBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalThroughputErrorUpperBound(totalThroughputErrorUpperBound *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalThroughputErrorUpperBound(totalThroughputErrorUpperBound)
	return o
}

// SetTotalThroughputErrorUpperBound adds the totalThroughputErrorUpperBound to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalThroughputErrorUpperBound(totalThroughputErrorUpperBound *int64) {
	o.TotalThroughputErrorUpperBound = totalThroughputErrorUpperBound
}

// WithTotalThroughputRead adds the totalThroughputRead to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalThroughputRead(totalThroughputRead *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalThroughputRead(totalThroughputRead)
	return o
}

// SetTotalThroughputRead adds the totalThroughputRead to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalThroughputRead(totalThroughputRead *int64) {
	o.TotalThroughputRead = totalThroughputRead
}

// WithTotalThroughputWrite adds the totalThroughputWrite to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) WithTotalThroughputWrite(totalThroughputWrite *int64) *TopMetricsSvmDirectoryCollectionGetParams {
	o.SetTotalThroughputWrite(totalThroughputWrite)
	return o
}

// SetTotalThroughputWrite adds the totalThroughputWrite to the top metrics svm directory collection get params
func (o *TopMetricsSvmDirectoryCollectionGetParams) SetTotalThroughputWrite(totalThroughputWrite *int64) {
