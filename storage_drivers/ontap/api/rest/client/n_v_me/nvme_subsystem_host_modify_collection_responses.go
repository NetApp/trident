...
func (o *NvmeSubsystemHostModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type NvmeSubsystemHostInlineDhHmacChap struct {
	...
	// Format: password
	ControllerSecretKey *strfmt.Password `json:"controller_secret_key,omitempty"`
	...
	// Example: DHHC-1:00:ia6zGodOr4SEG0Zzaw398rpY0wqipUWj4jWjUh4HWUz6aQ2n:
	// Format: password
	HostSecretKey *strfmt.Password `json:"host_secret_key,omitempty"`
...
func (o *NvmeSubsystemHostInlineDhHmacChap) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateControllerSecretKey(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateHostSecretKey(formats); err != nil {
		res = append(res, err)
	}
...
func (o *NvmeSubsystemHostInlineDhHmacChap) validateControllerSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(o.ControllerSecretKey) { // not required
		return nil
	}

	if err := validate.FormatOf("info"+"."+"dh_hmac_chap"+"."+"controller_secret_key", "body", "password", o.ControllerSecretKey.String(), formats); err != nil {
		return err
	}
...
func (o *NvmeSubsystemHostInlineDhHmacChap) validateHostSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(o.HostSecretKey) { // not required
		return nil
	}

	if err := validate.FormatOf("info"+"."+"dh_hmac_chap"+"."+"host_secret_key", "body", "password", o.HostSecretKey.String(), formats); err != nil {
		return err
	}
...
func (o *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineDhHmacChap) validateControllerSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(o.ControllerSecretKey) { // not required
		return nil
	}

	if err := validate.FormatOf("dh_hmac_chap"+"."+"controller_secret_key", "body", "password", o.ControllerSecretKey.String(), formats); err != nil {
		return err
	}
...
func (o *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineDhHmacChap) validateHostSecretKey(formats strfmt.Registry) error {
	if swag.IsZero(o.HostSecretKey) { // not required
		return nil
	}

	if err := validate.FormatOf("dh_hmac_chap"+"."+"host_secret_key", "body", "password", o.HostSecretKey.String(), formats); err != nil {
		return err
	}
...
func (o *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineTLS) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateConfiguredPsk(formats); err != nil {
		res = append(res, err)
	}
...
func (o *NvmeSubsystemHostInlineRecordsInlineArrayItemInlineTLS) validateConfiguredPsk(formats strfmt.Registry) error {
	if swag.IsZero(o.ConfiguredPsk) { // not required
		return nil
	}

	if err := validate.FormatOf("tls"+"."+"configured_psk", "body", "password", o.ConfiguredPsk.String(), formats); err != nil {
		return err
	}
...
const (
	...
	// generated
	// END DEBUGGING
	// NvmeSubsystemHostInlineRecordsInlineArrayItemInlineTLSKeyTypeGenerated captures enum value "generated"
	NvmeSubsystemHostInlineRecordsInlineArrayItemInlineTLSKeyTypeGenerated string = "generated"
)
...
func (o *NvmeSubsystemHostInlineTLS) validateConfiguredPsk(formats strfmt.Registry) error {
	if swag.IsZero(o.ConfiguredPsk) { // not required
		return nil
	}

	if err := validate.FormatOf("info"+"."+"tls"+"."+"configured_psk", "body", "password", o.ConfiguredPsk.String(), formats); err != nil {
		return err
	}
...
const (
	...
	// generated
	// END DEBUGGING
	// NvmeSubsystemHostInlineTLSKeyTypeGenerated captures enum value "generated"
	NvmeSubsystemHostInlineTLSKeyTypeGenerated string = "generated"
)
