...
// NewNvmeSubsystemMapCreateParams creates a new NvmeSubsystemMapCreateParams object,
...
func NewNvmeSubsystemMapCreateParams() *NvmeSubsystemMapCreateParams {
	return &NvmeSubsystemMapCreateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewNvmeSubsystemMapCreateParamsWithTimeout creates a new NvmeSubsystemMapCreateParams object
...
// NewNvmeSubsystemMapCreateParamsWithContext creates a new NvmeSubsystemMapCreateParams object
...
// NewNvmeSubsystemMapCreateParamsWithHTTPClient creates a new NvmeSubsystemMapCreateParams object
...
func (o *NvmeSubsystemMapCreateParams) WithDefaults() *NvmeSubsystemMapCreateParams {
	o.SetDefaults()
	return o
}
...
func (o *NvmeSubsystemMapCreateParams) SetDefaults() {
	...
	val := NvmeSubsystemMapCreateParams{
...
func (o *NvmeSubsystemMapCreateParams) WithTimeout(timeout time.Duration) *NvmeSubsystemMapCreateParams {
...
func (o *NvmeSubsystemMapCreateParams) WithContext(ctx context.Context) *NvmeSubsystemMapCreateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *NvmeSubsystemMapCreateParams) WithHTTPClient(client *http.Client) *NvmeSubsystemMapCreateParams {
...
func (o *NvmeSubsystemMapCreateParams) WithInfo(info *models.NvmeSubsystemMap) *NvmeSubsystemMapCreateParams {
	o.SetInfo(info)
	return o
}

// SetInfo adds the info to the nvme subsystem map create params
func (o *NvmeSubsystemMapCreateParams) SetInfo(info *models.NvmeSubsystemMap) {
	o.Info = info
}
...
func (o *NvmeSubsystemMapCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
