...
func (o *NvmeNamespaceCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 5374184 | A namespace cannot be created because the SVM is part of a SnapMirror active sync NAS relationship. |
...
| 5376756 | A vvol LUN cannot be transitioned to an NVMe namespace. |
