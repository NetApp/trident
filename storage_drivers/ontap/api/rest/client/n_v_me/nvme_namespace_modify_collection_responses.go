...
func (o *NvmeNamespaceModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *NvmeNamespaceModifyCollectionParamsBodySubsystemMapSubsystemHostsItems0TLS) validateConfiguredPsk(formats strfmt.Registry) error {
...
const (
	...
	// generated
	// END DEBUGGING
	// NvmeNamespaceModifyCollectionParamsBodySubsystemMapSubsystemHostsItems0TLSKeyTypeGenerated captures enum value "generated"
	NvmeNamespaceModifyCollectionParamsBodySubsystemMapSubsystemHostsItems0TLSKeyTypeGenerated string = "generated"
)
...
type NvmeNamespaceInlineClone struct {
	...
	// This property is _true_ when the NVMe namespace was created as a clone of another namespace. Note that this property only indicates how the namespace was created and does not imply space savings by itself. If the clone and its source have diverged significantly since the clone was created, the original space saving behavior of a clone will have been lost.
...
func (o *NvmeNamespaceInlineClone) contextValidateCreatedAsClone(ctx context.Context, formats strfmt.Registry) error {
