...
func (o *SnapmirrorRelationshipDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
| 13304161    | Delete of restore relationship took longer than expected. Check the SnapMirror relationship to determine whether the relationship was deleted successfully. |
