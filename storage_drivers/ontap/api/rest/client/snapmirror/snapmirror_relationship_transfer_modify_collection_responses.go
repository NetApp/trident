...
func (o *SnapmirrorRelationshipTransferModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type SnapmirrorRelationshipTransferModifyCollectionBody struct {
	...
	SnapmirrorTransferInlineOptions []any `json:"options,omitempty"`
