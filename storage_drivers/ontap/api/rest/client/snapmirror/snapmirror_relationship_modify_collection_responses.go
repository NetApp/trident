...
func (o *SnapmirrorRelationshipModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type SnapmirrorRelationshipModifyCollectionBody struct {
	...
	// Specifies the group type of the top level SnapMirror relationship. The volume relationships are shown as _none_, the SVMDR relationships are shown as _svm_dr_, the Consistency Group relationships are shown as _consistency_group_, FlexGroup volume relationships are shown as _flexgroup_ and in Snapmirror Active Sync NAS relationships the group type is _coordination_group_.
	// Example: consistency_group
	// Read Only: true
	// Enum: ["none","svm_dr","consistency_group","flexgroup","coordination_group"]
	...
	// This field specifies the list of volumes to be protected under a vserver.
	SnapmirrorRelationshipInlineSelectiveVolumes []*models.SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem `json:"selective_volumes,omitempty"`
...
func (o *SnapmirrorRelationshipModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateSnapmirrorRelationshipInlineSelectiveVolumes(formats); err != nil {
		res = append(res, err)
	}
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["none","svm_dr","consistency_group","flexgroup","coordination_group"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// coordination_group
	// END DEBUGGING
	// SnapmirrorRelationshipModifyCollectionBodyGroupTypeCoordinationGroup captures enum value "coordination_group"
	SnapmirrorRelationshipModifyCollectionBodyGroupTypeCoordinationGroup string = "coordination_group"
)
...
func (o *SnapmirrorRelationshipModifyCollectionBody) validateSnapmirrorRelationshipInlineSelectiveVolumes(formats strfmt.Registry) error {
	if swag.IsZero(o.SnapmirrorRelationshipInlineSelectiveVolumes) { // not required
		return nil
	}

	for i := 0; i < len(o.SnapmirrorRelationshipInlineSelectiveVolumes); i++ {
		if swag.IsZero(o.SnapmirrorRelationshipInlineSelectiveVolumes[i]) { // not required
			continue
		}

		if o.SnapmirrorRelationshipInlineSelectiveVolumes[i] != nil {
			if err := o.SnapmirrorRelationshipInlineSelectiveVolumes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("info" + "." + "selective_volumes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *SnapmirrorRelationshipModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateSnapmirrorRelationshipInlineSelectiveVolumes(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *SnapmirrorRelationshipModifyCollectionBody) contextValidateSnapmirrorRelationshipInlineSelectiveVolumes(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(o.SnapmirrorRelationshipInlineSelectiveVolumes); i++ {

		if o.SnapmirrorRelationshipInlineSelectiveVolumes[i] != nil {
			if err := o.SnapmirrorRelationshipInlineSelectiveVolumes[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("info" + "." + "selective_volumes" + "." + strconv.Itoa(i))
				}
				return err
...
/*
SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem snapmirror relationship inline selective volumes inline array item
swagger:model snapmirror_relationship_inline_selective_volumes_inline_array_item
*/
type SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem struct {

	// Indicates whether volumes need to be included or excluded for SnapMirror Active Sync NAS relationship. Default behavior is to protect all volumes under a vserver.
...
// Validate validates this snapmirror relationship inline selective volumes inline array item
func (o *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) Validate(formats strfmt.Registry) error {
	var res []error
...
var snapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemTypeModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		snapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemTypeModePropEnum = append(snapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemTypeModePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// snapmirror_relationship_inline_selective_volumes_inline_array_item
	// SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem
	// mode
	// Mode
	// include
	// END DEBUGGING
	// SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemModeInclude captures enum value "include"
	SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemModeInclude string = "include"
	...
	// exclude
	// END DEBUGGING
	// SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemModeExclude captures enum value "exclude"
	SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemModeExclude string = "exclude"
)

// prop value enum
func (o *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) validateModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, snapmirrorRelationshipInlineSelectiveVolumesInlineArrayItemTypeModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) validateMode(formats strfmt.Registry) error {
...
// ContextValidate validates this snapmirror relationship inline selective volumes inline array item based on context it is used
func (o *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem) UnmarshalBinary(b []byte) error {
	var res SnapmirrorRelationshipInlineSelectiveVolumesInlineArrayItem
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
