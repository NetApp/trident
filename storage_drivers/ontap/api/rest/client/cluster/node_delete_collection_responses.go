...
func (o *NodeDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type NodeResponseInlineRecordsInlineArrayItemInlineHa struct {
	...
	// giveback of
	GivebackOf *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf `json:"giveback_of,omitempty"`
	...
	// peering
	Peering *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering `json:"peering,omitempty"`
	...
	// takeover of
	TakeoverOf *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf `json:"takeover_of,omitempty"`
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateGivebackOf(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateTakeoverOf(formats); err != nil {
		res = append(res, err)
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) validateGivebackOf(formats strfmt.Registry) error {
	if swag.IsZero(o.GivebackOf) { // not required
		return nil
	}

	if o.GivebackOf != nil {
		if err := o.GivebackOf.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) validatePeering(formats strfmt.Registry) error {
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) validateTakeoverOf(formats strfmt.Registry) error {
	if swag.IsZero(o.TakeoverOf) { // not required
		return nil
	}

	if o.TakeoverOf != nil {
		if err := o.TakeoverOf.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateGivebackOf(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateGivebackOfPossible(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.contextValidateTakeoverOf(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateTakeoverOfPossible(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) contextValidateGivebackOf(ctx context.Context, formats strfmt.Registry) error {

	if o.GivebackOf != nil {
		if err := o.GivebackOf.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "giveback_of")
			}
			return err
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) contextValidateGivebackOfPossible(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "ha"+"."+"giveback_of_possible", "body", o.GivebackOfPossible); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) contextValidatePeering(ctx context.Context, formats strfmt.Registry) error {
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) contextValidateTakeoverOf(ctx context.Context, formats strfmt.Registry) error {

	if o.TakeoverOf != nil {
		if err := o.TakeoverOf.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "takeover_of")
			}
			return err
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHa) contextValidateTakeoverOfPossible(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "ha"+"."+"takeover_of_possible", "body", o.TakeoverOfPossible); err != nil {
		return err
	}
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf Represents the state of storage being given back to the node.
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_giveback_of
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf struct {

	// failure
	Failure *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure `json:"failure,omitempty"`
...
// Validate validates this node response inline records inline array item inline ha inline giveback of
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) validateFailure(formats strfmt.Registry) error {
	if swag.IsZero(o.Failure) { // not required
		return nil
	}
...
var nodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		nodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum = append(nodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// node_response_inline_records_inline_array_item_inline_ha_inline_giveback_of
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf
	// state
	// State
	// nothing_to_giveback
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateNothingToGiveback captures enum value "nothing_to_giveback"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateNothingToGiveback string = "nothing_to_giveback"
	...
	// not_attempted
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateNotAttempted captures enum value "not_attempted"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateNotAttempted string = "not_attempted"
	...
	// in_progress
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateInProgress captures enum value "in_progress"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateInProgress string = "in_progress"
	...
	// failed
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateFailed captures enum value "failed"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfStateFailed string = "failed"
)

// prop value enum
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) validateState(formats strfmt.Registry) error {
	if swag.IsZero(o.State) { // not required
		return nil
	}

	// value enum
	if err := o.validateStateEnum("ha"+"."+"giveback_of"+"."+"state", "body", *o.State); err != nil {
		return err
	}
...
// ContextValidate validate this node response inline records inline array item inline ha inline giveback of based on the context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) contextValidateFailure(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOf
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure Indicates the failure code and message.
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_giveback_of_inline_failure
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure struct {
...
// Validate validates this node response inline records inline array item inline ha inline giveback of inline failure
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this node response inline records inline array item inline ha inline giveback of inline failure based on the context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlineGivebackOfInlineFailure
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering node response inline records inline array item inline ha inline peering
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_peering
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering struct {

	// dst peer node1
	DstPeerNode1 *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1 `json:"dst_peer_node1,omitempty"`

	// dst peer node2
	DstPeerNode2 *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2 `json:"dst_peer_node2,omitempty"`

	// dst peer node3
	DstPeerNode3 *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3 `json:"dst_peer_node3,omitempty"`
...
// Validate validates this node response inline records inline array item inline ha inline peering
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) Validate(formats strfmt.Registry) error {
	var res []error

	if err := o.validateDstPeerNode1(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateDstPeerNode2(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateDstPeerNode3(formats); err != nil {
		res = append(res, err)
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) validateDstPeerNode1(formats strfmt.Registry) error {
	if swag.IsZero(o.DstPeerNode1) { // not required
		return nil
	}

	if o.DstPeerNode1 != nil {
		if err := o.DstPeerNode1.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) validateDstPeerNode2(formats strfmt.Registry) error {
	if swag.IsZero(o.DstPeerNode2) { // not required
		return nil
	}

	if o.DstPeerNode2 != nil {
		if err := o.DstPeerNode2.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) validateDstPeerNode3(formats strfmt.Registry) error {
	if swag.IsZero(o.DstPeerNode3) { // not required
		return nil
	}

	if o.DstPeerNode3 != nil {
		if err := o.DstPeerNode3.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
...
// ContextValidate validate this node response inline records inline array item inline ha inline peering based on the context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := o.contextValidateDstPeerNode1(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateDstPeerNode2(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateDstPeerNode3(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) contextValidateDstPeerNode1(ctx context.Context, formats strfmt.Registry) error {

	if o.DstPeerNode1 != nil {
		if err := o.DstPeerNode1.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node1")
			}
			return err
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) contextValidateDstPeerNode2(ctx context.Context, formats strfmt.Registry) error {

	if o.DstPeerNode2 != nil {
		if err := o.DstPeerNode2.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node2")
			}
			return err
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) contextValidateDstPeerNode3(ctx context.Context, formats strfmt.Registry) error {

	if o.DstPeerNode3 != nil {
		if err := o.DstPeerNode3.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ha" + "." + "peering" + "." + "dst_peer_node3")
			}
			return err
...
// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeering
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1 node response inline records inline array item inline ha inline peering inline dst peer node1
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_peering_inline_dst_peer_node1
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1 struct {
...
// Validate validates this node response inline records inline array item inline ha inline peering inline dst peer node1
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this node response inline records inline array item inline ha inline peering inline dst peer node1 based on context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode1
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2 node response inline records inline array item inline ha inline peering inline dst peer node2
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_peering_inline_dst_peer_node2
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2 struct {
...
// Validate validates this node response inline records inline array item inline ha inline peering inline dst peer node2
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this node response inline records inline array item inline ha inline peering inline dst peer node2 based on context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode2
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3 node response inline records inline array item inline ha inline peering inline dst peer node3
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_peering_inline_dst_peer_node3
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3 struct {
...
// Validate validates this node response inline records inline array item inline ha inline peering inline dst peer node3
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this node response inline records inline array item inline ha inline peering inline dst peer node3 based on context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlinePeeringInlineDstPeerNode3
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf This represents the storage takeover state of the node.
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_takeover_of
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf struct {

	// failure
	Failure *models.NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure `json:"failure,omitempty"`
...
// Validate validates this node response inline records inline array item inline ha inline takeover of
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) validateFailure(formats strfmt.Registry) error {
	if swag.IsZero(o.Failure) { // not required
		return nil
	}
...
var nodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		nodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum = append(nodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum, v)
	}
}
...
const (
	...
	// BEGIN DEBUGGING
	// node_response_inline_records_inline_array_item_inline_ha_inline_takeover_of
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf
	// state
	// State
	// not_possible
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateNotPossible captures enum value "not_possible"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateNotPossible string = "not_possible"
	...
	// not_attempted
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateNotAttempted captures enum value "not_attempted"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateNotAttempted string = "not_attempted"
	...
	// taken_over
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateTakenOver captures enum value "taken_over"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateTakenOver string = "taken_over"
	...
	// in_progress
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateInProgress captures enum value "in_progress"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateInProgress string = "in_progress"
	...
	// failed
	// END DEBUGGING
	// NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateFailed captures enum value "failed"
	NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfStateFailed string = "failed"
)

// prop value enum
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) validateState(formats strfmt.Registry) error {
	if swag.IsZero(o.State) { // not required
		return nil
	}

	// value enum
	if err := o.validateStateEnum("ha"+"."+"takeover_of"+"."+"state", "body", *o.State); err != nil {
		return err
	}
...
// ContextValidate validate this node response inline records inline array item inline ha inline takeover of based on the context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) contextValidateFailure(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOf
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure Indicates the failure code and message.
swagger:model node_response_inline_records_inline_array_item_inline_ha_inline_takeover_of_inline_failure
*/
type NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure struct {
...
// Validate validates this node response inline records inline array item inline ha inline takeover of inline failure
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validate this node response inline records inline array item inline ha inline takeover of inline failure based on the context it is used
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
// MarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure) UnmarshalBinary(b []byte) error {
	var res NodeResponseInlineRecordsInlineArrayItemInlineHaInlineTakeoverOfInlineFailure
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
