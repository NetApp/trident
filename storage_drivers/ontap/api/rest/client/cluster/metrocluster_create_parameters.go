...
// WithReturnRecordsQueryParameter adds the returnRecords to the metrocluster create params
func (o *MetroclusterCreateParams) WithReturnRecordsQueryParameter(returnRecords *bool) *MetroclusterCreateParams {
	o.SetReturnRecordsQueryParameter(returnRecords)
	return o
}

// SetReturnRecordsQueryParameter adds the returnRecords to the metrocluster create params
func (o *MetroclusterCreateParams) SetReturnRecordsQueryParameter(returnRecords *bool) {
