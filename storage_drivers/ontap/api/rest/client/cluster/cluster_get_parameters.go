...
// WithMaxRecords adds the maxRecords to the cluster get params
func (o *ClusterGetParams) WithMaxRecords(maxRecords *int64) *ClusterGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the cluster get params
func (o *ClusterGetParams) SetMaxRecords(maxRecords *int64) {
	o.MaxRecords = maxRecords
}

// WithOrderBy adds the orderBy to the cluster get params
func (o *ClusterGetParams) WithOrderBy(orderBy []string) *ClusterGetParams {
	o.SetOrderBy(orderBy)
	return o
}

// SetOrderBy adds the orderBy to the cluster get params
func (o *ClusterGetParams) SetOrderBy(orderBy []string) {
	o.OrderBy = orderBy
}

// WithReturnRecords adds the returnRecords to the cluster get params
func (o *ClusterGetParams) WithReturnRecords(returnRecords *bool) *ClusterGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cluster get params
func (o *ClusterGetParams) SetReturnRecords(returnRecords *bool) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the cluster get params
func (o *ClusterGetParams) WithReturnTimeout(returnTimeout *int64) *ClusterGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cluster get params
func (o *ClusterGetParams) SetReturnTimeout(returnTimeout *int64) {
