...
func (o *MetroclusterModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *MetroclusterModifyOK) GetPayload() *models.MetroclusterJobLinkResponse {
	return o.Payload
}
...
func (o *MetroclusterModifyAccepted) GetPayload() *models.MetroclusterJobLinkResponse {
	return o.Payload
}
