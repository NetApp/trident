...
func (o *MediatorModifyCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
var mediatorModifyCollectionBodyTypeConnectionTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		mediatorModifyCollectionBodyTypeConnectionTypePropEnum = append(mediatorModifyCollectionBodyTypeConnectionTypePropEnum, v)
	}
}
...
const (
	...
	// iscsi_mediator
	// END DEBUGGING
	// MediatorModifyCollectionBodyConnectionTypeIscsiMediator captures enum value "iscsi_mediator"
	MediatorModifyCollectionBodyConnectionTypeIscsiMediator string = "iscsi_mediator"
	...
	// https_mediator
	// END DEBUGGING
	// MediatorModifyCollectionBodyConnectionTypeHTTPSMediator captures enum value "https_mediator"
	MediatorModifyCollectionBodyConnectionTypeHTTPSMediator string = "https_mediator"
)

// prop value enum
func (o *MediatorModifyCollectionBody) validateConnectionTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, mediatorModifyCollectionBodyTypeConnectionTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *MediatorModifyCollectionBody) validateConnectionType(formats strfmt.Registry) error {
