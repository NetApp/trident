...
func (o *CapacityPoolCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the capacity pool collection get o k response
func (o *CapacityPoolCollectionGetOK) Code() int {
	return 200
}

func (o *CapacityPoolCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/licensing/capacity-pools][%d] capacityPoolCollectionGetOK %s", 200, payload)
}
...
func (o *CapacityPoolCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/licensing/capacity-pools][%d] capacity_pool_collection_get default %s", o._statusCode, payload)
}

func (o *CapacityPoolCollectionGetDefault) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/licensing/capacity-pools][%d] capacity_pool_collection_get default %s", o._statusCode, payload)
}
