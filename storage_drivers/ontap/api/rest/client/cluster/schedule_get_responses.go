...
func (o *ScheduleGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the schedule get o k response
func (o *ScheduleGetOK) Code() int {
	return 200
}

func (o *ScheduleGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/schedules/{uuid}][%d] scheduleGetOK %s", 200, payload)
}
...
func (o *ScheduleGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/schedules/{uuid}][%d] schedule_get default %s", o._statusCode, payload)
}
