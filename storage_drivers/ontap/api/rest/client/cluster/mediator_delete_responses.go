...
func (o *MediatorDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *MediatorDeleteOK) GetPayload() *models.MediatorJobLinkResponse {
	return o.Payload
}
...
func (o *MediatorDeleteAccepted) GetPayload() *models.MediatorJobLinkResponse {
	return o.Payload
}
