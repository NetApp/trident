...
func (o *MediatorPingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
|-------------|--------------|
| 13369414    | Failed to talk to the NetApp Console cloud service. Check the need for an HTTP proxy and network settings, such as firewalls.|
