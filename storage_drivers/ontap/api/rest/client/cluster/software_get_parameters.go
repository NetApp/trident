...
// WithMaxRecords adds the maxRecords to the software get params
func (o *SoftwareGetParams) WithMaxRecords(maxRecords *int64) *SoftwareGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the software get params
func (o *SoftwareGetParams) SetMaxRecords(maxRecords *int64) {
	o.MaxRecords = maxRecords
}

// WithOrderBy adds the orderBy to the software get params
func (o *SoftwareGetParams) WithOrderBy(orderBy []string) *SoftwareGetParams {
	o.SetOrderBy(orderBy)
	return o
}

// SetOrderBy adds the orderBy to the software get params
func (o *SoftwareGetParams) SetOrderBy(orderBy []string) {
	o.OrderBy = orderBy
}

// WithReturnRecords adds the returnRecords to the software get params
func (o *SoftwareGetParams) WithReturnRecords(returnRecords *bool) *SoftwareGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the software get params
func (o *SoftwareGetParams) SetReturnRecords(returnRecords *bool) {
