...
func (o *MediatorDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// prop value enum
func (o *MediatorResponseInlineRecordsInlineArrayItem) validateConnectionTypeEnum(path, location string, value string) error {
...
func (o *MediatorResponseInlineRecordsInlineArrayItem) validateConnectionType(formats strfmt.Registry) error {
	if swag.IsZero(o.ConnectionType) { // not required
		return nil
	}

	// value enum
	if err := o.validateConnectionTypeEnum("connection_type", "body", *o.ConnectionType); err != nil {
		return err
	}
