...
func (o *SoftwarePackageGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the software package get o k response
func (o *SoftwarePackageGetOK) Code() int {
	return 200
}

func (o *SoftwarePackageGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/software/packages/{version}][%d] softwarePackageGetOK %s", 200, payload)
}
...
func (o *SoftwarePackageGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/software/packages/{version}][%d] software_package_get default %s", o._statusCode, payload)
}
