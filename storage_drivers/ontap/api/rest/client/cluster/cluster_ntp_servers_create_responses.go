...
func (o *ClusterNtpServersCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ClusterNtpServersCreateCreated) GetPayload() *models.NtpServerJobLinkResponse {
	return o.Payload
}
...
func (o *ClusterNtpServersCreateAccepted) GetPayload() *models.NtpServerJobLinkResponse {
	return o.Payload
}
