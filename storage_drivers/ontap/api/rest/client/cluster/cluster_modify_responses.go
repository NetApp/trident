...
func (o *ClusterModifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ClusterModifyOK) GetPayload() *models.ClusterJobLinkResponse {
	return o.Payload
}
...
func (o *ClusterModifyAccepted) GetPayload() *models.ClusterJobLinkResponse {
	return o.Payload
}
