...
func (o *MetroclusterOperationCollectionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the metrocluster operation collection get o k response
func (o *MetroclusterOperationCollectionGetOK) Code() int {
	return 200
}

func (o *MetroclusterOperationCollectionGetOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/metrocluster/operations][%d] metroclusterOperationCollectionGetOK %s", 200, payload)
}
...
func (o *MetroclusterOperationCollectionGetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cluster/metrocluster/operations][%d] metrocluster_operation_collection_get default %s", o._statusCode, payload)
}
