...
func (d *NASStorageDriver) Destroy(ctx context.Context, volConfig *storage.VolumeConfig) error {
	...
	if !volumeExists {
		...
		_, err = d.API.WaitForVolumeState(
			ctx, extantVolume, gcnvapi.VolumeStateDeleted, []string{gcnvapi.VolumeStateError}, d.volumeCreateTimeout)
		return err
	}
	...
	// Wait for deletion to complete
	_, err = d.API.WaitForVolumeState(ctx, extantVolume, gcnvapi.VolumeStateDeleted, []string{gcnvapi.VolumeStateError}, d.defaultTimeout())
	return err
}
