...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/netapp/armnetapp/v5 v5.1.0
	...
	golang.org/x/crypto v0.18.0 // github.com/golang/crypto
	golang.org/x/net v0.20.0 // github.com/golang/net
	golang.org/x/oauth2 v0.16.0 // github.com/golang/oauth2
	golang.org/x/sys v0.16.0 // github.com/golang/sys
	golang.org/x/text v0.14.0 // github.com/golang/text
	golang.org/x/time v0.5.0 // github.com/golang/time
	google.golang.org/grpc v1.60.1 // github.com/grpc/grpc-go
	k8s.io/api v0.28.6 // github.com/kubernetes/api
	k8s.io/apiextensions-apiserver v0.28.6 // github.com/kubernetes/apiextensions-apiserver
	k8s.io/apimachinery v0.28.6 // github.com/kubernetes/apimachinery
	k8s.io/client-go v0.28.6 // github.com/kubernetes/client-go
	k8s.io/mount-utils v0.28.6 // github.com/kubernetes/mount-utils
	sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.0.0-20240117003154-2bb675d3e089 // github.com/kubernetes-sigs/cloud-provider-azure
)
