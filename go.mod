...
require (
	...
	golang.org/x/crypto v0.44.0 // github.com/golang/crypto
	golang.org/x/net v0.47.0 // github.com/golang/net
	golang.org/x/oauth2 v0.33.0 // github.com/golang/oauth2
	golang.org/x/sync v0.18.0
	golang.org/x/sys v0.38.0 // github.com/golang/sys
	golang.org/x/text v0.31.0 // github.com/golang/text
	...
	k8s.io/api v0.34.2 // github.com/kubernetes/api
	k8s.io/apiextensions-apiserver v0.34.2 // github.com/kubernetes/apiextensions-apiserver
	k8s.io/apimachinery v0.34.2 // github.com/kubernetes/apimachinery
	k8s.io/client-go v0.34.2 // github.com/kubernetes/client-go
	k8s.io/mount-utils v0.34.2 // github.com/kubernetes/mount-utils
	k8s.io/utils v0.0.0-20251002143259-bc988d571ff4 // github.com/kubernetes/utils
	sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.10.0 // github.com/kubernetes-sigs/cloud-provider-azure
)
