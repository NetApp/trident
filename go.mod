...
require (
	...
	google.golang.org/grpc v1.80.0 // github.com/grpc/grpc-go
	google.golang.org/protobuf v1.36.11 // github.com/protocolbuffers/protobuf-go
	gopkg.in/yaml.v3 v3.0.1
	k8s.io/api v0.35.4 // github.com/kubernetes/api
	k8s.io/apiextensions-apiserver v0.35.4 // github.com/kubernetes/apiextensions-apiserver
	k8s.io/apimachinery v0.35.4 // github.com/kubernetes/apimachinery
	k8s.io/client-go v0.35.4 // github.com/kubernetes/client-go
	k8s.io/mount-utils v0.35.4 // github.com/kubernetes/mount-utils
	k8s.io/utils v0.0.0-20260319190234-28399d86e0b5 // github.com/kubernetes/utils
	sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.18.0 // github.com/kubernetes-sigs/cloud-provider-azure
)
