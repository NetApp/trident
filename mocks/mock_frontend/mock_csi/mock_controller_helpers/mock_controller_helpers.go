...
// RecordStorageClassEvent mocks base method.
func (m *MockControllerHelper) RecordStorageClassEvent(ctx context.Context, name, eventType, reason, message string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RecordStorageClassEvent", ctx, name, eventType, reason, message)
}

// RecordStorageClassEvent indicates an expected call of RecordStorageClassEvent.
func (mr *MockControllerHelperMockRecorder) RecordStorageClassEvent(ctx, name, eventType, reason, message any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecordStorageClassEvent", reflect.TypeOf((*MockControllerHelper)(nil).RecordStorageClassEvent), ctx, name, eventType, reason, message)
}
