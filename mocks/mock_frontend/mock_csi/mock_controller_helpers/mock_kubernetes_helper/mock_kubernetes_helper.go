...
func (m *MockK8SControllerHelperPlugin) GetPVC(ctx context.Context, namespace, name string) (*v1.PersistentVolumeClaim, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8SControllerHelperPlugin) GetPVCForPV(ctx context.Context, pvName string) (*v1.PersistentVolumeClaim, error) {
	m.ctrl.T.Helper()
