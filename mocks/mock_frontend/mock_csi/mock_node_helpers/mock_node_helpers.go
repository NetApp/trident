...
// Source: github.com/netapp/trident/frontend/csi/node_helpers (interfaces: NodeHelper,VolumePublishManager,VolumeStatsManager,LockProvider)
//
// Generated by this command:
//
//	mockgen -destination=../../../mocks/mock_frontend/mock_csi/mock_node_helpers/mock_node_helpers.go github.com/netapp/trident/frontend/csi/node_helpers NodeHelper,VolumePublishManager,VolumeStatsManager,LockProvider
//
...
import (
	...
	distlock "github.com/netapp/trident/pkg/locks/distlock"
...
// LockFor mocks base method.
func (m *MockNodeHelper) LockFor(ctx context.Context, resourceID, hostID string, publishInfo *models.VolumePublishInfo) (distlock.Locker, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LockFor", ctx, resourceID, hostID, publishInfo)
	ret0, _ := ret[0].(distlock.Locker)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// LockFor indicates an expected call of LockFor.
func (mr *MockNodeHelperMockRecorder) LockFor(ctx, resourceID, hostID, publishInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LockFor", reflect.TypeOf((*MockNodeHelper)(nil).LockFor), ctx, resourceID, hostID, publishInfo)
}
...
// LockFor mocks base method.
func (m *MockLockProvider) LockFor(ctx context.Context, resourceID, hostID string, publishInfo *models.VolumePublishInfo) (distlock.Locker, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LockFor", ctx, resourceID, hostID, publishInfo)
	ret0, _ := ret[0].(distlock.Locker)
	ret1, _ := ret[1].(error)
...
// LockFor indicates an expected call of LockFor.
func (mr *MockLockProviderMockRecorder) LockFor(ctx, resourceID, hostID, publishInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LockFor", reflect.TypeOf((*MockLockProvider)(nil).LockFor), ctx, resourceID, hostID, publishInfo)
}
