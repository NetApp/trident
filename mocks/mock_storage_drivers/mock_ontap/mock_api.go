...
// Source: storage_drivers/ontap/api/abstraction.go
...
func (m *MockOntapAPI) ExportRuleCreate(ctx context.Context, policyName, desiredPolicyRule string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExportRuleCreate", ctx, policyName, desiredPolicyRule)
	ret0, _ := ret[0].(error)
	return ret0
}

// ExportRuleCreate indicates an expected call of ExportRuleCreate.
func (mr *MockOntapAPIMockRecorder) ExportRuleCreate(ctx, policyName, desiredPolicyRule interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExportRuleCreate", reflect.TypeOf((*MockOntapAPI)(nil).ExportRuleCreate), ctx, policyName, desiredPolicyRule)
}
...
func (m *MockOntapAPI) QtreeExists(ctx context.Context, name, volumePrefix string) (bool, string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOntapAPIMockRecorder) QtreeExists(ctx, name, volumePrefix interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QtreeExists", reflect.TypeOf((*MockOntapAPI)(nil).QtreeExists), ctx, name, volumePrefix)
}
...
func (m *MockOntapAPI) SnapmirrorRelease(localFlexvolName, localSVMName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SnapmirrorRelease", localFlexvolName, localSVMName)
	ret0, _ := ret[0].(error)
	return ret0
}

// SnapmirrorRelease indicates an expected call of SnapmirrorRelease.
func (mr *MockOntapAPIMockRecorder) SnapmirrorRelease(localFlexvolName, localSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SnapmirrorRelease", reflect.TypeOf((*MockOntapAPI)(nil).SnapmirrorRelease), localFlexvolName, localSVMName)
}
