...
func (m *MockOntapAPI) NVMeSubsystemCreate(ctx context.Context, subsystemName string) (*api.NVMeSubsystem, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOntapAPIMockRecorder) NVMeSubsystemCreate(ctx, subsystemName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NVMeSubsystemCreate", reflect.TypeOf((*MockOntapAPI)(nil).NVMeSubsystemCreate), ctx, subsystemName)
}
