...
func (m *MockZapiClientInterface) NetInterfaceGetDataLIFsNode(ctx context.Context, ip string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NetInterfaceGetDataLIFsNode", ctx, ip)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockZapiClientInterfaceMockRecorder) NetInterfaceGetDataLIFsNode(ctx, ip interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NetInterfaceGetDataLIFsNode", reflect.TypeOf((*MockZapiClientInterface)(nil).NetInterfaceGetDataLIFsNode), ctx, ip)
}
...
func (m *MockZapiClientInterface) QtreeExists(ctx context.Context, name, volumePrefix string) (bool, string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockZapiClientInterfaceMockRecorder) QtreeExists(ctx, name, volumePrefix interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QtreeExists", reflect.TypeOf((*MockZapiClientInterface)(nil).QtreeExists), ctx, name, volumePrefix)
}
