...
func (m *MockRestClientInterface) FlexGroupVolumeDisableSnapshotDirectoryAccess(ctx context.Context, flexGroupVolumeName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FlexGroupVolumeDisableSnapshotDirectoryAccess", ctx, flexGroupVolumeName)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockRestClientInterfaceMockRecorder) FlexGroupVolumeDisableSnapshotDirectoryAccess(ctx, flexGroupVolumeName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FlexGroupVolumeDisableSnapshotDirectoryAccess", reflect.TypeOf((*MockRestClientInterface)(nil).FlexGroupVolumeDisableSnapshotDirectoryAccess), ctx, flexGroupVolumeName)
}
...
func (mr *MockRestClientInterfaceMockRecorder) GetPeeredVservers(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) IsVserverDRCapable(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) IsVserverDRDestination(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) IsVserverDRSource(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) JobScheduleExists(ctx, jobName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) QtreeExists(ctx, name, volumePattern interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorAbort(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorBreak(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName, snapshotName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorCreate(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName, repPolicy, repSchedule interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorDelete(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorDeleteViaDestination(ctx, localFlexvolName, localSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRestClientInterface) SnapmirrorGet(ctx context.Context, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName string) (*models.SnapmirrorRelationship, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorGet(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SnapmirrorGet", reflect.TypeOf((*MockRestClientInterface)(nil).SnapmirrorGet), ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName)
}
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorInitialize(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorPolicyExists(ctx, policyName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorPolicyGet(ctx, policyName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorQuiesce(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorRelationshipsList(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorRelease(ctx, sourceFlexvolName, sourceSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestClientInterfaceMockRecorder) SnapmirrorResync(ctx, localFlexvolName, localSVMName, remoteFlexvolName, remoteSVMName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRestClientInterface) VolumeCreate(ctx context.Context, name, aggregateName, size, spaceReserve,
	snapshotPolicy, unixPermissions, exportPolicy, securityStyle, tieringPolicy, comment string,
	qosPolicyGroup api.QosPolicyGroup, encrypt *bool, snapshotReserve int, dpVolume bool) error {
	m.ctrl.T.Helper()
