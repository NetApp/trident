...
func (m *MockRestClientInterface) CliPassthroughEventGeneratePost(ctx context.Context, appVersion string, autoSupport bool, category, computerName, eventDescription string, eventID int, eventSource string, logLevel int) (*api.CliPassthroughResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CliPassthroughEventGeneratePost", ctx, appVersion, autoSupport, category, computerName, eventDescription, eventID, eventSource, logLevel)
...
func (mr *MockRestClientInterfaceMockRecorder) CliPassthroughEventGeneratePost(ctx, appVersion, autoSupport, category, computerName, eventDescription, eventID, eventSource, logLevel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CliPassthroughEventGeneratePost", reflect.TypeOf((*MockRestClientInterface)(nil).CliPassthroughEventGeneratePost), ctx, appVersion, autoSupport, category, computerName, eventDescription, eventID, eventSource, logLevel)
}

// CliPassthroughLunMappingGet mocks base method.
func (m *MockRestClientInterface) CliPassthroughLunMappingGet(ctx context.Context, initiatorGroupName, lunPath string) (*api.CliPassthroughResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CliPassthroughLunMappingGet", ctx, initiatorGroupName, lunPath)
	ret0, _ := ret[0].(*api.CliPassthroughResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRestClientInterfaceMockRecorder) CliPassthroughLunMappingGet(ctx, initiatorGroupName, lunPath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CliPassthroughLunMappingGet", reflect.TypeOf((*MockRestClientInterface)(nil).CliPassthroughLunMappingGet), ctx, initiatorGroupName, lunPath)
}

// CliPassthroughVolumeGet mocks base method.
func (m *MockRestClientInterface) CliPassthroughVolumeGet(ctx context.Context, volume *api.Volume) (*api.CliPassthroughResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CliPassthroughVolumeGet", ctx, volume)
	ret0, _ := ret[0].(*api.CliPassthroughResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRestClientInterfaceMockRecorder) CliPassthroughVolumeGet(ctx, volume interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CliPassthroughVolumeGet", reflect.TypeOf((*MockRestClientInterface)(nil).CliPassthroughVolumeGet), ctx, volume)
}

// CliPassthroughVolumePatch mocks base method.
func (m *MockRestClientInterface) CliPassthroughVolumePatch(ctx context.Context, volumeName, jsonString string) (*api.CliPassthroughResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CliPassthroughVolumePatch", ctx, volumeName, jsonString)
	ret0, _ := ret[0].(*api.CliPassthroughResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRestClientInterfaceMockRecorder) CliPassthroughVolumePatch(ctx, volumeName, jsonString interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRestClientInterface) LunCreate(ctx context.Context, lunPath string, sizeInBytes int64, osType string, qosPolicyGroup api.QosPolicyGroup) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LunCreate", ctx, lunPath, sizeInBytes, osType, qosPolicyGroup)
	ret0, _ := ret[0].(error)
	return ret0
}

// LunCreate indicates an expected call of LunCreate.
func (mr *MockRestClientInterfaceMockRecorder) LunCreate(ctx, lunPath, sizeInBytes, osType, qosPolicyGroup interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LunCreate", reflect.TypeOf((*MockRestClientInterface)(nil).LunCreate), ctx, lunPath, sizeInBytes, osType, qosPolicyGroup)
}
