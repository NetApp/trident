...
func (m *MockStoreClient) GetAutogrowPolicies(ctx context.Context) ([]*storage.AutogrowPolicyPersistent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAutogrowPolicies", ctx)
...
func (mr *MockStoreClientMockRecorder) GetAutogrowPolicies(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAutogrowPolicies", reflect.TypeOf((*MockStoreClient)(nil).GetAutogrowPolicies), ctx)
}

// GetAutogrowPolicy mocks base method.
func (m *MockStoreClient) GetAutogrowPolicy(ctx context.Context, agPolicyName string) (*storage.AutogrowPolicyPersistent, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreClientMockRecorder) GetAutogrowPolicy(ctx, agPolicyName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAutogrowPolicy", reflect.TypeOf((*MockStoreClient)(nil).GetAutogrowPolicy), ctx, agPolicyName)
}
