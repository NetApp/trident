...
func (m *MockDevices) GetLUKSDevicePathForDevicePath(ctx context.Context, devicePath string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLUKSDevicePathForDevicePath", ctx, devicePath)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDevicesMockRecorder) GetLUKSDevicePathForDevicePath(ctx, devicePath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLUKSDevicePathForDevicePath", reflect.TypeOf((*MockDevices)(nil).GetLUKSDevicePathForDevicePath), ctx, devicePath)
}
