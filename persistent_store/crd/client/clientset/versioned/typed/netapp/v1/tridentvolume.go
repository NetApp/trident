...
func (c *tridentVolumes) Get(name string, options metav1.GetOptions) (result *v1.TridentVolume, err error) {
...
func (c *tridentVolumes) List(opts metav1.ListOptions) (result *v1.TridentVolumeList, err error) {
...
func (c *tridentVolumes) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tridentVolumes) Create(tridentVolume *v1.TridentVolume) (result *v1.TridentVolume, err error) {
	result = &v1.TridentVolume{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tridentvolumes").
...
func (c *tridentVolumes) Update(tridentVolume *v1.TridentVolume) (result *v1.TridentVolume, err error) {
	result = &v1.TridentVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tridentvolumes").
...
func (c *tridentVolumes) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *tridentVolumes) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *tridentVolumes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.TridentVolume, err error) {
	result = &v1.TridentVolume{}
