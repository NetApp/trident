...
func (c *FakeTridentSnapshots) List(opts v1.ListOptions) (result *netappv1.TridentSnapshotList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTridentSnapshots) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeTridentSnapshots) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tridentsnapshotsResource, c.ns, listOptions)
