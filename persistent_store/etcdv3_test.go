...
//func TestEtcdv3GetAddSnapshot(t *testing.T) {
//	p, _ := NewEtcdClientV3(*etcdV3)
//
//	// Adding a snapshot
...
//}
//
//func TestEtcdv3AddGetSnapshots(t *testing.T) {
//	p, _ := NewEtcdClientV3(*etcdV3)
//
//	// Adding a snapshot
//	snap1config := &storage.SnapshotConfig{
...
func TestEtcdv3AddGetSnapshot(t *testing.T) {
	p, _ := NewEtcdClientV3(*etcdV3)
