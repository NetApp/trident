...
func (c *FakeVolumes) UpdateStatus(volume *netappv1.Volume) (*netappv1.Volume, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(volumesResource, "status", volume), &netappv1.Volume{})
	if obj == nil {
		return nil, err
	}
	return obj.(*netappv1.Volume), err
