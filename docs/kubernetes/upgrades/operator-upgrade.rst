...
.. important::
   ...
   `storage-class-basic.yaml.templ <https://github.com/NetApp/trident/blob/stable/v20.10/trident-installer/sample-input/storage-class-basic.yaml.templ>`_,
   and `storage-class-bronze-default.yaml <https://github.com/NetApp/trident/blob/stable/v20.10/trident-installer/sample-input/storage-class-bronze-default.yaml>`_.
