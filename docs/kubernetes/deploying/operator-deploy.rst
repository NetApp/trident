...
autosupportImage          The container image for Autosupport Telemetry                          "netapp/trident-autosupport:20.10.1"
...
tridentImage              Trident image to install                                               "netapp/trident:20.10.1"
...
.. code-block:: console
   ...
   spec:
     debug: true
     tridentImage: netapp/trident:20.10.1
     imagePullSecrets:
     - thisisasecret
