...
.. code-block:: console
  ...
  $ helm install <name> trident-operator-21.01.1.tgz --set tridentDebug=true
...
tridentImage              Trident image to install                                                       "netapp/trident:21.01.1"
...
.. code-block:: console
   ...
   spec:
     debug: true
     namespace: trident
     tridentImage: netapp/trident:21.01.1
     imagePullSecrets:
     - thisisasecret
