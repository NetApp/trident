...
#. Launch the first instance specifying an alias and configuration file
   ...
   .. code-block:: bash
      ...
      docker plugin install --grant-all-permissions --alias silver netapp/trident-plugin:18.01 config=silver.json
   
#. Launch the second instance, specifying a different alias and configuration file
   
   .. code-block:: bash
   
      docker plugin install --grant-all-permissions --alias gold netapp/trident-plugin:18.01 config=gold.json
