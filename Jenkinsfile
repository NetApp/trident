node {
  ...
  // Define k8s version vars
  def k8s_version = "1.15.7"
  def kubeadm_version = k8s_version + "*"
  k8s_version = "v" + k8s_version
  def k8s_cni_version = "0.7.5*"
  def k8s_api_version = "kubeadm.k8s.io/v1beta1"

  // Pin golang at 1.12
  def go_download_url = "https://dl.google.com/go/go1.12.14.linux-amd64.tar.gz"
  ...
  def plan = [
    ...
    [
      ...
      [
        ...
        'security_group': 'sg-0e814bf9a82c02eff',
        'stage': '_whelk_test',
...
def _gather_triage_information(Map spec, String ssh_options, String ip_address, String name, String vm_path) {
  ...
  if (_whelk_test_match(spec, 'docker_ee|kubeadm|openshift')) {
